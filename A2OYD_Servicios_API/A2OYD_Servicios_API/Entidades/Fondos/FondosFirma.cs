...
namespace A2OYD_Servicios_API.Entidades.Fondos
{
    public class FondosFirma
    {
        ...
        /// <summary>
        /// propiedad utilizada para mapear la composicion del fondo
        /// </summary>
        private string _composicionfondo;
        public string composicionfondo
        {
            get
            {
                return this._composicionfondo;
            }
            set
            {
                this._composicionfondo = value;
                if (composicionfondo != null)
                {
                    composicionfondolista = Newtonsoft.Json.JsonConvert.DeserializeObject<List<ComposicionFondo>>(_composicionfondo);
                }
        ...
        /// <summary>
        /// metodo que se ejecuta si en el set de la propiedad composicionfondo no se asigno valor a la lista
        /// </summary>
        public void Asociar_Lista_Composicion()
        {
            if (composicionfondo != null)
            {
                composicionfondolista = Newtonsoft.Json.JsonConvert.DeserializeObject<List<ComposicionFondo>>(composicionfondo);
            }
