...
'''
'''</history>
Public Class FinalidadOperacionViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblFinalidadOperaciones
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblFinalidadOperaciones
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblFinalidadOperaciones)
    Public Property ListaEncabezado() As List(Of tblFinalidadOperaciones)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblFinalidadOperaciones))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblFinalidadOperaciones
    Public Property EncabezadoSeleccionado() As tblFinalidadOperaciones
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblFinalidadOperaciones)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblFinalidadOperaciones
    Public Property EncabezadoEdicionSeleccionado() As tblFinalidadOperaciones
        Get
        ...
        Set(ByVal value As tblFinalidadOperaciones)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdFinalidadOperacion > 0 And _EncabezadoEdicionSeleccionado.bitPermiteComplemento Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaFinalidadOperaciones
    Public Property cb() As CamposBusquedaFinalidadOperaciones
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaFinalidadOperaciones)
            _cb = value
    ...
    Private _ListaDetalle As List(Of tblTipoFinalidad)
    Public Property ListaDetalle() As List(Of tblTipoFinalidad)
        Get
            Return _ListaDetalle
        End Get
        Set(ByVal value As List(Of tblTipoFinalidad))
            _ListaDetalle = value
    ...
    Private _HabilitarUbicacionPosicionCubrir As Boolean = False
    Public Property HabilitarUbicacionPosicionCubrir() As Boolean
        Get
            Return _HabilitarUbicacionPosicionCubrir
        End Get
        Set(ByVal value As Boolean)
            _HabilitarUbicacionPosicionCubrir = value
            MyBase.CambioItem("HabilitarUbicacionPosicionCubrir")
        End Set
    End Property
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblFinalidadOperaciones
            ...
            Editando = True
            'Habilitar_Inhabilitar_UbicacionPosicionCubrir()
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strDescripcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.strDescripcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.FinalidadOperaciones_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdFinalidadOperacion,
                                                                                                                                             _EncabezadoEdicionSeleccionado.strDescripcion,
                                                                                                                                             _EncabezadoEdicionSeleccionado.bitPorDefecto,
                                                                                                                                             _EncabezadoEdicionSeleccionado.bitPermiteComplemento,
                                                                                                                                             _EncabezadoEdicionSeleccionado.intIdTipoLista,
                                                                                                                                            False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.strDescripcion)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.FinalidadOperaciones_EliminarAsync(_EncabezadoSeleccionado.intIdFinalidadOperacion, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaFinalidadOperaciones
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblFinalidadOperaciones, ByRef pobjRegistroSalvar As tblFinalidadOperaciones)
        Dim objEncabezado As tblFinalidadOperaciones = New tblFinalidadOperaciones

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdFinalidadOperacion = pobjRegistro.intIdFinalidadOperacion
                objEncabezado.strDescripcion = pobjRegistro.strDescripcion
                objEncabezado.bitPorDefecto = pobjRegistro.bitPorDefecto
                objEncabezado.bitPermiteComplemento = pobjRegistro.bitPermiteComplemento
                objEncabezado.dtmActualizacion = pobjRegistro.dtmActualizacion
                objEncabezado.strUsuario = pobjRegistro.strUsuario
                objEncabezado.intIdTipoLista = pobjRegistro.intIdTipoLista
    ...
    Private Sub _EncabezadoEdicionSeleccionado_PropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs) Handles _EncabezadoEdicionSeleccionado.PropertyChanged
        Try
            If Editando Then
                If e.PropertyName = "bitPermiteComplemento" Then
    ...
    Public Sub Habilitar_Inhabilitar_UbicacionPosicionCubrir()
        Try

            If Not IsNothing(EncabezadoEdicionSeleccionado) Then
                If EncabezadoEdicionSeleccionado.bitPermiteComplemento Then

                    If EncabezadoEdicionSeleccionado.intIdFinalidadOperacion > 0 And EncabezadoEdicionSeleccionado.bitPermiteComplemento Then
                        HabilitarEdicionDetalle = True
                    Else
                        HabilitarEdicionDetalle = False
                    End If
                    ...
                    If Editando Then
                        HabilitarUbicacionPosicionCubrir = True
                    Else
                        HabilitarUbicacionPosicionCubrir = False
                        EncabezadoEdicionSeleccionado.intIdTipoLista = -1
                    End If
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblFinalidadOperaciones)

            objRespuesta = Await mdcProxy.FinalidadOperaciones_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblFinalidadOperaciones)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.FinalidadOperaciones_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                pstrDescripcion = System.Web.HttpUtility.UrlEncode(Program.validarValorString(pstrDescripcion, String.Empty))

                objRespuesta = Await mdcProxy.FinalidadOperaciones_ConsultarAsync(pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdFinalidadOperacion = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdFinalidadOperacion = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdFinalidadOperacion > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdFinalidadOperacion)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblFinalidadOperaciones) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.FinalidadOperaciones_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaFinalidadOperaciones
