...
'''
'''</history>
Public Class TipoOpcionProductoViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblTipoOpcionProducto
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblTipoOpcionProducto
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblTipoOpcionProducto)
    Public Property ListaEncabezado() As List(Of tblTipoOpcionProducto)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblTipoOpcionProducto))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblTipoOpcionProducto
    Public Property EncabezadoSeleccionado() As tblTipoOpcionProducto
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblTipoOpcionProducto)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblTipoOpcionProducto
    Public Property EncabezadoEdicionSeleccionado() As tblTipoOpcionProducto
        Get
        ...
        Set(ByVal value As tblTipoOpcionProducto)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdTipoOpcionProducto > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaTipoOpcionProducto
    Public Property cb() As CamposBusquedaTipoOpcionProducto
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaTipoOpcionProducto)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblTipoOpcionProducto
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strCodigoTipoOpcion) Or Not String.IsNullOrEmpty(cb.strNombreTipoOpcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.strNombreTipoOpcion, cb.strCodigoTipoOpcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOpcionProducto_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdTipoOpcionProducto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strCodigoTipoOpcion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strNombreTipoOpcion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdTipoProducto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitProductosEspeciales,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitPrima,
                                                                                                                                             False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.strNombreTipoOpcion, cb.strCodigoTipoOpcion)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOpcionProducto_EliminarAsync(_EncabezadoSeleccionado.intIdTipoOpcionProducto, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaTipoOpcionProducto
            objCB.strCodigoTipoOpcion = String.Empty
            objCB.strNombreTipoOpcion = String.Empty
            cb = objCB
        Catch ex As Exception
            IsBusy = False
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblTipoOpcionProducto, ByRef pobjRegistroSalvar As tblTipoOpcionProducto)
        Dim objEncabezado As tblTipoOpcionProducto = New tblTipoOpcionProducto

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdTipoOpcionProducto = pobjRegistro.intIdTipoOpcionProducto
                objEncabezado.strCodigoTipoOpcion = pobjRegistro.strCodigoTipoOpcion
                objEncabezado.strNombreTipoOpcion = pobjRegistro.strNombreTipoOpcion
                objEncabezado.intIdTipoProducto = pobjRegistro.intIdTipoProducto
                objEncabezado.bitProductosEspeciales = pobjRegistro.bitProductosEspeciales
                objEncabezado.bitPrima = pobjRegistro.bitPrima
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblTipoOpcionProducto)

            objRespuesta = Await mdcProxy.TipoOpcionProducto_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pstrNombreTipoOpcion As String = "",
                                               Optional ByVal pstrCodigoTipoOpcion As String = "") As Task(Of Boolean)

        Dim logResultado As Boolean = False

        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblTipoOpcionProducto)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.TipoOpcionProducto_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.TipoOpcionProducto_ConsultarAsync(pstrNombreTipoOpcion, pstrCodigoTipoOpcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdTipoOpcionProducto = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdTipoOpcionProducto = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdTipoOpcionProducto > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdTipoOpcionProducto)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblTipoOpcionProducto) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.TipoOpcionProducto_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaTipoOpcionProducto
    Implements INotifyPropertyChanged


    Private _strNombreTipoOpcion As String
    Public Property strNombreTipoOpcion() As String
        Get
            Return _strNombreTipoOpcion
        End Get
        Set(ByVal value As String)
            _strNombreTipoOpcion = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strNombreTipoOpcion"))
        End Set
    End Property

    Private _strCodigoTipoOpcion As String
    Public Property strCodigoTipoOpcion() As String
        Get
            Return _strCodigoTipoOpcion
        End Get
        Set(ByVal value As String)
            _strCodigoTipoOpcion = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoTipoOpcion"))
        End Set
    End Property
