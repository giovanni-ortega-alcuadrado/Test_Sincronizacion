...
'''
'''</history>
Public Class FinalidadOperacionDetalleViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblTipoFinalidad
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblTipoFinalidad
    Private mobjEncabezadoGuardadoAnterior As tblTipoFinalidad
    Public viewListaPrincipal As FinalidadOperacionDetalleView
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblTipoFinalidad)
    Public Property ListaEncabezado() As List(Of tblTipoFinalidad)
        Get
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblTipoFinalidad
    Public Property EncabezadoSeleccionado() As tblTipoFinalidad
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblTipoFinalidad)
    ...
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblTipoFinalidad
    Public Property EncabezadoEdicionSeleccionado() As tblTipoFinalidad
        Get
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Sub CrearNuevoDetalle(Optional ByVal plogCopiarValorRegistroAnterior As Boolean = False)
        Try
            Dim objNvoEncabezado As New tblTipoFinalidad
            ...
            objNvoEncabezado.intIdFinalidadOperacion = _IDRegistroEncabezado
    ...
    Public Async Function ActualizarRegistroDetalle() As Task(Of Boolean)
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoFinalidad_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdTipoFinalidad,
                                                                                                                                    _EncabezadoEdicionSeleccionado.strDescripcion,
                                                                                                                                    _EncabezadoEdicionSeleccionado.bitPorDefecto,
                                                                                                                                    _EncabezadoEdicionSeleccionado.intIdFinalidadOperacion,
                                                                                                                                    _EncabezadoEdicionSeleccionado.intIdTipoLista,
                                                                                                                                        _EncabezadoEdicionSeleccionado.bitSolicitarMonto,
                                                                                                                                        False,
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoFinalidad_EliminarAsync(_EncabezadoSeleccionado.intIdTipoFinalidad, Program.Usuario, Program.HashConexion)
    ...
    Public Sub AbrirDetalle()
        Try
            If logVentanaDetalleActiva = False Then
                Dim objViewDetalle As New FinalidadOperacionDetalleFormView(Me)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblTipoFinalidad, ByRef pobjRegistroSalvar As tblTipoFinalidad)
        Dim objEncabezado As tblTipoFinalidad = New tblTipoFinalidad

        Try
            If Not IsNothing(pobjRegistro) Then
                objEncabezado.intIdTipoFinalidad = pobjRegistro.intIdTipoFinalidad
                ...
                objEncabezado.bitSolicitarMonto = pobjRegistro.bitSolicitarMonto
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblTipoFinalidad)

            objRespuesta = Await mdcProxy.TipoFinalidad_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ByVal pintIdFinalidadOperacion As Integer,
                                               Optional ByVal pintIdTipoFinalidad As Integer = -1,
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblTipoFinalidad)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.TipoFinalidad_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.TipoFinalidad_ConsultarAsync(pintIdFinalidadOperacion, pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIdTipoFinalidad > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdTipoFinalidad = pintIdTipoFinalidad).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdTipoFinalidad = pintIdTipoFinalidad).First
                        End If
                    Else
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If logCambiarEncabezadoSeleccionado Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    If _EncabezadoSeleccionado.intIdTipoFinalidad > 0 Then
                        Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdTipoFinalidad)
                    End If
                End If
            End If
        Catch ex As Exception
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblTipoFinalidad) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.TipoFinalidad_IDAsync(pintID, Program.Usuario, Program.HashConexion)
