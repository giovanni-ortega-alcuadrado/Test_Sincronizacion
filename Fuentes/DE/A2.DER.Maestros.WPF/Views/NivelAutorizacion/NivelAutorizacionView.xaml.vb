...
Partial Public Class NivelAutorizacionView
...
#Region "Variables"
    ...
    Private mobjVM As NivelAutorizacionViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New NivelAutorizacionViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, NivelAutorizacionViewModel)
