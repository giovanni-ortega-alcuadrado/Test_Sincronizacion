...
Partial Public Class TipoOrdenNaturalezaView
...
#Region "Variables"
    ...
    Private mobjVM As TipoOrdenNaturalezaViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New TipoOrdenNaturalezaViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, TipoOrdenNaturalezaViewModel)
...
#End Region
    ...
    Private Sub NavegarAForma(sender As Object, e As RoutedEventArgs)
        If Not IsNothing(mobjVM.EncabezadoSeleccionado) Then
            If mobjVM.EncabezadoSeleccionado.intIdTipoOrdenNaturaleza.ToString <> CType(sender, Button).Tag Then
                mobjVM.EncabezadoSeleccionado = mobjVM.ListaEncabezado.Where(Function(i) i.intIdTipoOrdenNaturaleza.ToString = CType(sender, Button).Tag).First
            End If
        Else
            mobjVM.EncabezadoSeleccionado = mobjVM.ListaEncabezado.Where(Function(i) i.intIdTipoOrdenNaturaleza.ToString = CType(sender, Button).Tag).First
        End If
