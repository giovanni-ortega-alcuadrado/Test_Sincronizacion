...
'''
'''</history>
Public Class TipoOrdenNaturalezaViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblTipoOrdenNaturaleza
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblTipoOrdenNaturaleza
...
#Region "Inicialización - REQUERIDO"
    ...
    ''' Fecha            : Marzo 26/2018
    ''' Pruebas CB       :  Jhon Alexis Echavarria (Alcuadrado S.A.) -Marzo 26/2018 - Resultado Ok 
    ''' </history>
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblTipoOrdenNaturaleza)
    Public Property ListaEncabezado() As List(Of tblTipoOrdenNaturaleza)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblTipoOrdenNaturaleza))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblTipoOrdenNaturaleza
    Public Property EncabezadoSeleccionado() As tblTipoOrdenNaturaleza
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblTipoOrdenNaturaleza)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblTipoOrdenNaturaleza
    Public Property EncabezadoEdicionSeleccionado() As tblTipoOrdenNaturaleza
        Get
        ...
        Set(ByVal value As tblTipoOrdenNaturaleza)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdTipoOrdenNaturaleza > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaTipoOrdenNaturaleza
    Public Property cb() As CamposBusquedaTipoOrdenNaturaleza
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaTipoOrdenNaturaleza)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblTipoOrdenNaturaleza
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strCodigoTipoOrdenNaturaleza) Or Not String.IsNullOrEmpty(cb.strNombreTipoOrdenNaturaleza) Or Not String.IsNullOrEmpty(cb.strDescripcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.strCodigoTipoOrdenNaturaleza, cb.strNombreTipoOrdenNaturaleza, cb.strDescripcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOrdenNaturaleza_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdTipoOrdenNaturaleza,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strCodigoTipoOrdenNaturaleza,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strNombreTipoOrdenNaturaleza,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitPorDefecto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitRequierePrecio,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitPrecioStop,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitCantidadOculta,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitSeguirInstrumento,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdTipoListaPrecio,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strDescripcion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitRequiereCantidad,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitRequierePrecioActivar,
                                                                                                                                             False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.strCodigoTipoOrdenNaturaleza, cb.strNombreTipoOrdenNaturaleza, cb.strDescripcion)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOrdenNaturaleza_EliminarAsync(_EncabezadoSeleccionado.intIdTipoOrdenNaturaleza, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaTipoOrdenNaturaleza
            objCB.strCodigoTipoOrdenNaturaleza = String.Empty
            objCB.strNombreTipoOrdenNaturaleza = String.Empty
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblTipoOrdenNaturaleza, ByRef pobjRegistroSalvar As tblTipoOrdenNaturaleza)
        Dim objEncabezado As tblTipoOrdenNaturaleza = New tblTipoOrdenNaturaleza

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdTipoOrdenNaturaleza = pobjRegistro.intIdTipoOrdenNaturaleza
                objEncabezado.strCodigoTipoOrdenNaturaleza = pobjRegistro.strCodigoTipoOrdenNaturaleza
                objEncabezado.strNombreTipoOrdenNaturaleza = pobjRegistro.strNombreTipoOrdenNaturaleza
                objEncabezado.bitPorDefecto = pobjRegistro.bitPorDefecto
                objEncabezado.bitRequierePrecio = pobjRegistro.bitRequierePrecio
                objEncabezado.bitPrecioStop = pobjRegistro.bitPrecioStop
                objEncabezado.bitCantidadOculta = pobjRegistro.bitCantidadOculta
                objEncabezado.bitSeguirInstrumento = pobjRegistro.bitSeguirInstrumento
                objEncabezado.intIdTipoListaPrecio = pobjRegistro.intIdTipoListaPrecio
                objEncabezado.strDescripcion = pobjRegistro.strDescripcion
                objEncabezado.bitRequiereCantidad = pobjRegistro.bitRequiereCantidad
                objEncabezado.bitRequierePrecioActivar = pobjRegistro.bitRequierePrecioActivar
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblTipoOrdenNaturaleza)

            objRespuesta = Await mdcProxy.TipoOrdenNaturaleza_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pstrCodigoTipoOrdenNaturaleza As String = "",
                                               Optional ByVal pstrNombreTipoOrdenNaturaleza As String = "",
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblTipoOrdenNaturaleza)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.TipoOrdenNaturaleza_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.TipoOrdenNaturaleza_ConsultarAsync(pstrCodigoTipoOrdenNaturaleza, pstrNombreTipoOrdenNaturaleza, pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdTipoOrdenNaturaleza = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdTipoOrdenNaturaleza = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdTipoOrdenNaturaleza > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdTipoOrdenNaturaleza)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblTipoOrdenNaturaleza) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.TipoOrdenNaturaleza_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaTipoOrdenNaturaleza
    Implements INotifyPropertyChanged


    Private _strCodigoTipoOrdenNaturaleza As String
    Public Property strCodigoTipoOrdenNaturaleza() As String
        Get
            Return _strCodigoTipoOrdenNaturaleza
        End Get
        Set(ByVal value As String)
            _strCodigoTipoOrdenNaturaleza = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoTipoOrdenNaturaleza"))
        End Set
    End Property

    Private _strNombreTipoOrdenNaturaleza As String
    Public Property strNombreTipoOrdenNaturaleza() As String
        Get
            Return _strNombreTipoOrdenNaturaleza
        End Get
        Set(ByVal value As String)
            _strNombreTipoOrdenNaturaleza = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strNombreTipoOrdenNaturaleza"))
        End Set
    End Property
