...
'''
'''</history>
Public Class TipoOrdenEjecucionViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblTipoOrdenEjecucion
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblTipoOrdenEjecucion
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblTipoOrdenEjecucion)
    Public Property ListaEncabezado() As List(Of tblTipoOrdenEjecucion)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblTipoOrdenEjecucion))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblTipoOrdenEjecucion
    Public Property EncabezadoSeleccionado() As tblTipoOrdenEjecucion
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblTipoOrdenEjecucion)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblTipoOrdenEjecucion
    Public Property EncabezadoEdicionSeleccionado() As tblTipoOrdenEjecucion
        Get
        ...
        Set(ByVal value As tblTipoOrdenEjecucion)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdTipoOrdenEjecucion > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaTipoOrdenEjecucion
    Public Property cb() As CamposBusquedaTipoOrdenEjecucion
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaTipoOrdenEjecucion)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblTipoOrdenEjecucion
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strCodigoTipoOrdenEjecucion) Or Not String.IsNullOrEmpty(cb.strNombreTipoOrdenEjecucion) Or Not String.IsNullOrEmpty(cb.strDescripcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.strCodigoTipoOrdenEjecucion, cb.strNombreTipoOrdenEjecucion, cb.strDescripcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOrdenEjecucion_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdTipoOrdenEjecucion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strCodigoTipoOrdenEjecucion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strNombreTipoOrdenEjecucion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitPorDefecto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitCantidadMinima,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strDescripcion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitRequiereInstrumento,
                                                                                                                                             False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.strCodigoTipoOrdenEjecucion, cb.strNombreTipoOrdenEjecucion, cb.strDescripcion)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOrdenEjecucion_EliminarAsync(_EncabezadoSeleccionado.intIdTipoOrdenEjecucion, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaTipoOrdenEjecucion
            objCB.strCodigoTipoOrdenEjecucion = String.Empty
            objCB.strNombreTipoOrdenEjecucion = String.Empty
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblTipoOrdenEjecucion, ByRef pobjRegistroSalvar As tblTipoOrdenEjecucion)
        Dim objEncabezado As tblTipoOrdenEjecucion = New tblTipoOrdenEjecucion

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdTipoOrdenEjecucion = pobjRegistro.intIdTipoOrdenEjecucion
                objEncabezado.strCodigoTipoOrdenEjecucion = pobjRegistro.strCodigoTipoOrdenEjecucion
                objEncabezado.strNombreTipoOrdenEjecucion = pobjRegistro.strNombreTipoOrdenEjecucion
                objEncabezado.bitPorDefecto = pobjRegistro.bitPorDefecto
                objEncabezado.bitCantidadMinima = pobjRegistro.bitCantidadMinima
                objEncabezado.strDescripcion = pobjRegistro.strDescripcion
                objEncabezado.bitRequiereInstrumento = pobjRegistro.bitRequiereInstrumento
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblTipoOrdenEjecucion)

            objRespuesta = Await mdcProxy.TipoOrdenEjecucion_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pstrCodigoTipoOrdenEjecucion As String = "",
                                               Optional ByVal pstrNombreTipoOrdenEjecucion As String = "",
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblTipoOrdenEjecucion)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.TipoOrdenEjecucion_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.TipoOrdenEjecucion_ConsultarAsync(pstrCodigoTipoOrdenEjecucion, pstrNombreTipoOrdenEjecucion, pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdTipoOrdenEjecucion = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdTipoOrdenEjecucion = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdTipoOrdenEjecucion > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdTipoOrdenEjecucion)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblTipoOrdenEjecucion) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.TipoOrdenEjecucion_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaTipoOrdenEjecucion
    Implements INotifyPropertyChanged


    Private _strCodigoTipoOrdenEjecucion As String
    Public Property strCodigoTipoOrdenEjecucion() As String
        Get
            Return _strCodigoTipoOrdenEjecucion
        End Get
        Set(ByVal value As String)
            _strCodigoTipoOrdenEjecucion = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoTipoOrdenEjecucion"))
        End Set
    End Property

    Private _strNombreTipoOrdenEjecucion As String
    Public Property strNombreTipoOrdenEjecucion() As String
        Get
            Return _strNombreTipoOrdenEjecucion
        End Get
        Set(ByVal value As String)
            _strNombreTipoOrdenEjecucion = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strNombreTipoOrdenEjecucion"))
        End Set
    End Property
