...
Partial Public Class CodCompaniasEncuentaView
...
#Region "Variables"
    ...
    Private mobjVM As CodCompaniasEncuentaViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New CodCompaniasEncuentaViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, CodCompaniasEncuentaViewModel)
