...
Partial Public Class CuentasInstrumentosCRCCView
...
#Region "Variables"
    ...
    Private mobjVM As CuentasInstrumentosCRCCViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New CuentasInstrumentosCRCCViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, CuentasInstrumentosCRCCViewModel)
