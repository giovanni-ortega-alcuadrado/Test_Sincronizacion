...
'''
'''</history>
Public Class CuentasInstrumentosCRCCViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblCuentasInstrumentos
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblCuentasInstrumentos
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of CPX_tblCuentasInstrumentos)
    Public Property ListaEncabezado() As List(Of CPX_tblCuentasInstrumentos)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of CPX_tblCuentasInstrumentos))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_tblCuentasInstrumentos
    Public Property EncabezadoSeleccionado() As CPX_tblCuentasInstrumentos
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_tblCuentasInstrumentos)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblCuentasInstrumentos
    Public Property EncabezadoEdicionSeleccionado() As tblCuentasInstrumentos
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As tblCuentasInstrumentos)
            _EncabezadoEdicionSeleccionado = value
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdCuentasInstrumentos > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaCuentasInstrumentosCRCCView
    Public Property cb() As CamposBusquedaCuentasInstrumentosCRCCView
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaCuentasInstrumentosCRCCView)
            _cb = value
    ...
    'Lista para SubCuenta CRCC Reem
    Private _ListaSubCuentaCRCCReem As List(Of ProductoCombos)
    Public Property ListaSubCuentaCRCCReem() As List(Of ProductoCombos)
        Get
            Return _ListaSubCuentaCRCCReem
        End Get
        Set(ByVal value As List(Of ProductoCombos))
            _ListaSubCuentaCRCCReem = value
            MyBase.CambioItem("ListaSubCuentaCRCCReem")
        End Set
    End Property
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblCuentasInstrumentos
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If cb.intIdCuentaCRCC > 0 Or cb.intIdProducto > 0 Or cb.intIdCuentaCRCCReem > 0 Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.intIdCuentaCRCC, cb.intIdProducto, cb.intIdCuentaCRCCReem)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.CuentasInstrumentos_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdCuentasInstrumentos,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdCuentaCRCC,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdSubcuentaCRCC,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdProducto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdCuentaCRCCReem,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdSubcuentaCRCCReem,
                                                                                                                                             False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.intIdCuentaCRCC, cb.intIdProducto, cb.intIdCuentaCRCCReem)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.CuentasInstrumentos_EliminarAsync(_EncabezadoSeleccionado.intID, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaCuentasInstrumentosCRCCView
            objCB.intIdCuentaCRCC = -1
            objCB.intIdProducto = -1
            objCB.intIdCuentaCRCCReem = -1
            cb = objCB
        Catch ex As Exception
            IsBusy = False
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblCuentasInstrumentos, ByRef pobjRegistroSalvar As tblCuentasInstrumentos)
        Dim objEncabezado As tblCuentasInstrumentos = New tblCuentasInstrumentos

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdCuentasInstrumentos = pobjRegistro.intIdCuentasInstrumentos
                ...
                objEncabezado.intIdCuentaCRCCReem = pobjRegistro.intIdCuentaCRCCReem
                objEncabezado.intIdSubcuentaCRCCReem = pobjRegistro.intIdSubcuentaCRCCReem
    ...
    Private Sub _EncabezadoEdicionSeleccionado_PropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs) Handles _EncabezadoEdicionSeleccionado.PropertyChanged
        Try
            If Editando Then
                ...
                ElseIf e.PropertyName = "intIdCuentaCRCCReem" Then

                    ListaSubCuentaCRCCReem = DiccionarioCombosPantalla("CLIENTESSUBCUENTASCRCC").Where(Function(i) i.IDDependencia1 = EncabezadoEdicionSeleccionado.intIdCuentaCRCCReem).ToList
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblCuentasInstrumentos)

            objRespuesta = Await mdcProxy.CuentasInstrumentos_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pintIdCuentaCRCC As Integer = -1,
                                               Optional ByVal pintIdProducto As Integer = -1,
                                               Optional ByVal pintIdCuentaCRCCReem As Integer = -1) As Task(Of Boolean)

        Dim logResultado As Boolean = False

        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblCuentasInstrumentos)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.CuentasInstrumentos_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.CuentasInstrumentos_ConsultarAsync(pintIdCuentaCRCC, pintIdProducto, pintIdCuentaCRCCReem, Program.Usuario, Program.HashConexion)
            End If
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblCuentasInstrumentos) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.CuentasInstrumentos_IDAsync(pintID, Program.Usuario, Program.HashConexion)

            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    EncabezadoEdicionSeleccionado = objRespuesta.Value

                    'Se cargan las listas dependiendo de la cuenta para el registro seleccionado
...
''' 
''' </history>
Public Class CamposBusquedaCuentasInstrumentosCRCCView
    Implements INotifyPropertyChanged

    Private _intIdCuentaCRCC As Integer
    Public Property intIdCuentaCRCC() As Integer
        Get
            Return _intIdCuentaCRCC
        End Get
        Set(ByVal value As Integer)
            _intIdCuentaCRCC = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("intIdCuentaCRCC"))
        End Set
    End Property

    Private _intIdProducto As Integer
    Public Property intIdProducto() As Integer
        ...
        Set(ByVal value As Integer)
            ...
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("intIdProducto"))
        End Set
    End Property

    Private _intIdCuentaCRCCReem As Integer
    Public Property intIdCuentaCRCCReem() As Integer
        Get
            Return _intIdCuentaCRCCReem
        End Get
        Set(ByVal value As Integer)
            _intIdCuentaCRCCReem = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("intIdCuentaCRCCReem"))
        End Set
    End Property
