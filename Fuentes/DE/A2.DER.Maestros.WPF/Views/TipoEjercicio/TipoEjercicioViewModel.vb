...
'''
'''</history>
Public Class TipoEjercicioViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblTipoEjercicio
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblTipoEjercicio
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblTipoEjercicio)
    Public Property ListaEncabezado() As List(Of tblTipoEjercicio)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblTipoEjercicio))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblTipoEjercicio
    Public Property EncabezadoSeleccionado() As tblTipoEjercicio
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblTipoEjercicio)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblTipoEjercicio
    Public Property EncabezadoEdicionSeleccionado() As tblTipoEjercicio
        Get
        ...
        Set(ByVal value As tblTipoEjercicio)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdTipoEjercicio > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaCuentasTipoEjercicio
    Public Property cb() As CamposBusquedaCuentasTipoEjercicio
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaCuentasTipoEjercicio)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblTipoEjercicio
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If cb.intIdTipoProducto > 0 Or Not String.IsNullOrEmpty(cb.strNombre) Or Not String.IsNullOrEmpty(cb.strCodigo) Or Not String.IsNullOrEmpty(cb.strDescripcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.intIdTipoProducto, cb.strNombre, cb.strCodigo, cb.strDescripcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoEjercicio_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdTipoEjercicio,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdTipoProducto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strCodigoTipoEjercicio,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strNombreTipoEjercicio,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.intIdTipoProducto, cb.strNombre, cb.strCodigo, cb.strDescripcion)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoEjercicio_EliminarAsync(_EncabezadoSeleccionado.intIdTipoEjercicio, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaCuentasTipoEjercicio
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblTipoEjercicio, ByRef pobjRegistroSalvar As tblTipoEjercicio)
        Dim objEncabezado As tblTipoEjercicio = New tblTipoEjercicio
        ...
        Try
            If Not IsNothing(pobjRegistro) Then
                ...
                objEncabezado.strCodigoTipoEjercicio = pobjRegistro.strCodigoTipoEjercicio
                objEncabezado.strNombreTipoEjercicio = pobjRegistro.strNombreTipoEjercicio
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblTipoEjercicio)

            objRespuesta = Await mdcProxy.TipoEjercicio_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pintIdTipoProducto As Integer = -1,
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblTipoEjercicio)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.TipoEjercicio_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.TipoEjercicio_ConsultarAsync(pintIdTipoProducto, pstrNombre, pstrCodigo, pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdTipoEjercicio = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdTipoEjercicio = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdTipoEjercicio > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdTipoEjercicio)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblTipoEjercicio) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.TipoEjercicio_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaCuentasTipoEjercicio
