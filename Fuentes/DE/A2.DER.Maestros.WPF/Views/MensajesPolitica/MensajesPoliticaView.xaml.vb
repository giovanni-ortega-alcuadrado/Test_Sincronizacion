...
Partial Public Class MensajesPoliticaView
...
#Region "Variables"
    ...
    Private mobjVM As MensajesPoliticaViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New MensajesPoliticaViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, MensajesPoliticaViewModel)
