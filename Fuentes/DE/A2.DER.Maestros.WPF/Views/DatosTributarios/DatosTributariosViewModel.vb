...
'''
'''</history>
Public Class DatosTributariosViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblDatosTributarios
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblDatosTributarios
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblDatosTributarios)
    Public Property ListaEncabezado() As List(Of tblDatosTributarios)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblDatosTributarios))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblDatosTributarios
    Public Property EncabezadoSeleccionado() As tblDatosTributarios
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblDatosTributarios)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblDatosTributarios
    Public Property EncabezadoEdicionSeleccionado() As tblDatosTributarios
        Get
        ...
        Set(ByVal value As tblDatosTributarios)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdDatosTributarios > 0 Then
    ...
    Private _ListaDetalle As List(Of tblDetalleDatosTributarios)
    Public Property ListaDetalle() As List(Of tblDetalleDatosTributarios)
        Get
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblDatosTributarios
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strNombre) Or Not String.IsNullOrEmpty(cb.strDescripcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.strNombre, cb.strDescripcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.DatosTributarios_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdDatosTributarios,
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.DatosTributarios_EliminarAsync(_EncabezadoSeleccionado.intIdDatosTributarios, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblDatosTributarios, ByRef pobjRegistroSalvar As tblDatosTributarios)
        Dim objEncabezado As tblDatosTributarios = New tblDatosTributarios
    ...
    Private Sub _EncabezadoEdicionSeleccionado_PropertyChanged(ByVal sender As Object, ByVal e As System.ComponentModel.PropertyChangedEventArgs) Handles _EncabezadoEdicionSeleccionado.PropertyChanged
        Try
            If Editando Then
                If e.PropertyName = "intIdDatosTributarios" Then
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblDatosTributarios)

            objRespuesta = Await mdcProxy.DatosTributarios_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblDatosTributarios)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.DatosTributarios_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)
            ...
            Else
                ...
                objRespuesta = Await mdcProxy.DatosTributarios_ConsultarAsync(pstrNombre, pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdDatosTributarios = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdDatosTributarios = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdDatosTributarios > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdDatosTributarios)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblDatosTributarios) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.DatosTributarios_IDAsync(pintID, Program.Usuario, Program.HashConexion)
