...
Partial Public Class TipoDocAutorizacionView
...
#Region "Variables"
    ...
    Private mobjVM As TipoDocAutorizacionViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New TipoDocAutorizacionViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, TipoDocAutorizacionViewModel)
