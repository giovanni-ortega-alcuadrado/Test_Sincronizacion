...
Partial Public Class PreciosDerivadosView
...
#Region "Variables"
    ...
    Private mobjVM As PreciosDerivadosViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New PreciosDerivadosViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, PreciosDerivadosViewModel)
