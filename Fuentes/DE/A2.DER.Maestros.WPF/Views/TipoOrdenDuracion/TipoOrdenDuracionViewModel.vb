...
'''
'''</history>
Public Class TipoOrdenDuracionViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblTipoOrdenDuracion
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblTipoOrdenDuracion
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of tblTipoOrdenDuracion)
    Public Property ListaEncabezado() As List(Of tblTipoOrdenDuracion)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of tblTipoOrdenDuracion))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As tblTipoOrdenDuracion
    Public Property EncabezadoSeleccionado() As tblTipoOrdenDuracion
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As tblTipoOrdenDuracion)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblTipoOrdenDuracion
    Public Property EncabezadoEdicionSeleccionado() As tblTipoOrdenDuracion
        Get
        ...
        Set(ByVal value As tblTipoOrdenDuracion)
            ...
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdTipoOrdenDuracion > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaTipoOrdenDuracion
    Public Property cb() As CamposBusquedaTipoOrdenDuracion
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaTipoOrdenDuracion)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblTipoOrdenDuracion
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strCodigoTipoOrdenDuracion) Or Not String.IsNullOrEmpty(cb.strNombreTipoOrdenDuracion) Or Not String.IsNullOrEmpty(cb.strDescripcion) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.strCodigoTipoOrdenDuracion, cb.strNombreTipoOrdenDuracion, cb.strDescripcion)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOrdenDuracion_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdTipoOrdenDuracion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strCodigoTipoOrdenDuracion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strNombreTipoOrdenDuracion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strDescripcion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitPorDefecto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitRequiereFecha,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdTipoListaAsociada,
                                                                                                                                            _EncabezadoEdicionSeleccionado.strEtiquetaLista,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitVigenciaMax,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intIdTipoOpcionProducto,
                                                                                                                                            _EncabezadoEdicionSeleccionado.bitPermiteSeleccionarTipoSesion,
                                                                                                                                            _EncabezadoEdicionSeleccionado.intNroDiasVencimiento,
                                                                                                                                             False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.strCodigoTipoOrdenDuracion, cb.strNombreTipoOrdenDuracion, cb.strDescripcion)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.TipoOrdenDuracion_EliminarAsync(_EncabezadoSeleccionado.intIdTipoOrdenDuracion, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaTipoOrdenDuracion
            objCB.strCodigoTipoOrdenDuracion = String.Empty
            objCB.strNombreTipoOrdenDuracion = String.Empty
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblTipoOrdenDuracion, ByRef pobjRegistroSalvar As tblTipoOrdenDuracion)
        Dim objEncabezado As tblTipoOrdenDuracion = New tblTipoOrdenDuracion

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdTipoOrdenDuracion = pobjRegistro.intIdTipoOrdenDuracion
                objEncabezado.strCodigoTipoOrdenDuracion = pobjRegistro.strCodigoTipoOrdenDuracion
                objEncabezado.strNombreTipoOrdenDuracion = pobjRegistro.strNombreTipoOrdenDuracion
                objEncabezado.strDescripcion = pobjRegistro.strDescripcion
                objEncabezado.bitPorDefecto = pobjRegistro.bitPorDefecto
                objEncabezado.bitRequiereFecha = pobjRegistro.bitRequiereFecha
                objEncabezado.intIdTipoListaAsociada = pobjRegistro.intIdTipoListaAsociada
                objEncabezado.strEtiquetaLista = pobjRegistro.strEtiquetaLista
                objEncabezado.dtmActualizacion = pobjRegistro.dtmActualizacion
                objEncabezado.strUsuario = pobjRegistro.strUsuario
                objEncabezado.bitVigenciaMax = pobjRegistro.bitVigenciaMax
                objEncabezado.intIdTipoOpcionProducto = pobjRegistro.intIdTipoOpcionProducto
                objEncabezado.bitPermiteSeleccionarTipoSesion = pobjRegistro.bitPermiteSeleccionarTipoSesion
                objEncabezado.intNroDiasVencimiento = pobjRegistro.intNroDiasVencimiento
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblTipoOrdenDuracion)

            objRespuesta = Await mdcProxy.TipoOrdenDuracion_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pstrCodigoTipoOrdenDuracion As String = "",
                                               Optional ByVal pstrNombreTipoOrdenDuracion As String = "",
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of tblTipoOrdenDuracion)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.TipoOrdenDuracion_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                objRespuesta = Await mdcProxy.TipoOrdenDuracion_ConsultarAsync(pstrCodigoTipoOrdenDuracion, pstrNombreTipoOrdenDuracion, pstrDescripcion, Program.Usuario, Program.HashConexion)
            End If
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If pintIDRegistro > 0 Then
                        If ListaEncabezado.Where(Function(i) i.intIdTipoOrdenDuracion = pintIDRegistro).Count > 0 Then
                            EncabezadoSeleccionado = ListaEncabezado.Where(Function(i) i.intIdTipoOrdenDuracion = pintIDRegistro).First
                        End If
                    End If
    ...
    Public Async Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                If _EncabezadoSeleccionado.intIdTipoOrdenDuracion > 0 Then
                    Await ConsultarEncabezadoEdicion(_EncabezadoSeleccionado.intIdTipoOrdenDuracion)
                End If
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblTipoOrdenDuracion) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.TipoOrdenDuracion_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaTipoOrdenDuracion
    Implements INotifyPropertyChanged


    Private _strCodigoTipoOrdenDuracion As String
    Public Property strCodigoTipoOrdenDuracion() As String
        Get
            Return _strCodigoTipoOrdenDuracion
        End Get
        Set(ByVal value As String)
            _strCodigoTipoOrdenDuracion = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoTipoOrdenDuracion"))
        End Set
    End Property

    Private _strNombreTipoOrdenDuracion As String
    Public Property strNombreTipoOrdenDuracion() As String
        Get
            Return _strNombreTipoOrdenDuracion
        End Get
        Set(ByVal value As String)
            _strNombreTipoOrdenDuracion = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strNombreTipoOrdenDuracion"))
        End Set
    End Property
