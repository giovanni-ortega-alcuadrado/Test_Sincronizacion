...
Partial Public Class TipoOrdenDuracionView
...
#Region "Variables"
    ...
    Private mobjVM As TipoOrdenDuracionViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New TipoOrdenDuracionViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, TipoOrdenDuracionViewModel)
...
#End Region
    ...
    Private Sub NavegarAForma(sender As Object, e As RoutedEventArgs)
        If Not IsNothing(mobjVM.EncabezadoSeleccionado) Then
            If mobjVM.EncabezadoSeleccionado.intIdTipoOrdenDuracion.ToString <> CType(sender, Button).Tag Then
                mobjVM.EncabezadoSeleccionado = mobjVM.ListaEncabezado.Where(Function(i) i.intIdTipoOrdenDuracion.ToString = CType(sender, Button).Tag).First
            End If
        Else
            mobjVM.EncabezadoSeleccionado = mobjVM.ListaEncabezado.Where(Function(i) i.intIdTipoOrdenDuracion.ToString = CType(sender, Button).Tag).First
        End If
