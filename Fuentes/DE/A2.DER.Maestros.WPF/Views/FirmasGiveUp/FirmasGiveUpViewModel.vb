...
'''
'''</history>
Public Class FirmasGiveUpViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblFirmasGiveUp
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblFirmasGiveUp
...
#Region "Inicialización - REQUERIDO"
    ...
    ''' Fecha            : Marzo 22/2018
    ''' Pruebas CB       :  Jhon Alexis Echavarria (Alcuadrado S.A.) -Marzo 22/2018 - Resultado Ok 
    ''' </history>
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of CPX_tblFirmasGiveUp)
    Public Property ListaEncabezado() As List(Of CPX_tblFirmasGiveUp)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of CPX_tblFirmasGiveUp))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_tblFirmasGiveUp
    Public Property EncabezadoSeleccionado() As CPX_tblFirmasGiveUp
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_tblFirmasGiveUp)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblFirmasGiveUp
    Public Property EncabezadoEdicionSeleccionado() As tblFirmasGiveUp
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As tblFirmasGiveUp)
            _EncabezadoEdicionSeleccionado = value
            If Not IsNothing(_EncabezadoEdicionSeleccionado) Then
                If _EncabezadoEdicionSeleccionado.intIdFirmaGiveUp > 0 Then
    ...
    ''' </summary>
    Private _cb As CamposBusquedaFirmasGiveUp
    Public Property cb() As CamposBusquedaFirmasGiveUp
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaFirmasGiveUp)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblFirmasGiveUp
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If cb.intIdFirmaNegocio > 0 Or Not String.IsNullOrEmpty(cb.strReferenciaGiveOut) Or Not IsNothing(cb.bitAceptaGiveOut) Or Not IsNothing(cb.bitAceptaGiveIn) Or Not IsNothing(cb.logActiva) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.intIdFirmaNegocio, cb.strReferenciaGiveOut, cb.bitAceptaGiveOut, cb.bitAceptaGiveIn, cb.logActiva)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.FirmasGiveUp_ActualizarAsync(_EncabezadoEdicionSeleccionado.intIdFirmaGiveUp,
                                                                                                                                     _EncabezadoEdicionSeleccionado.intIdFirmaNegocio,
                                                                                                                                     _EncabezadoEdicionSeleccionado.strReferenciaGiveOut,
                                                                                                                                     _EncabezadoEdicionSeleccionado.bitAceptaGiveOut,
                                                                                                                                     _EncabezadoEdicionSeleccionado.bitAceptaGiveIn,
                                                                                                                                     _EncabezadoEdicionSeleccionado.logActiva,
                                                                                                                                     False,
                ...
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                        ...
                        ElseIf strTipoFiltroBusqueda = "BUSQUEDA" And Not IsNothing(cb) Then
                            Await ConsultarEncabezado("BUSQUEDA", String.Empty, Nothing, cb.intIdFirmaNegocio, cb.strReferenciaGiveOut, cb.bitAceptaGiveOut, cb.bitAceptaGiveIn, cb.logActiva)
                        Else
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.FirmasGiveUps_EliminarAsync(_EncabezadoSeleccionado.intID, Program.Usuario, Program.HashConexion)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaFirmasGiveUp
            objCB.intIdFirmaNegocio = -1
            objCB.strReferenciaGiveOut = ""
            objCB.bitAceptaGiveOut = Nothing
            objCB.bitAceptaGiveIn = Nothing
            objCB.logActiva = Nothing
            cb = objCB
        Catch ex As Exception
            IsBusy = False
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblFirmasGiveUp, ByRef pobjRegistroSalvar As tblFirmasGiveUp)
        Dim objEncabezado As tblFirmasGiveUp = New tblFirmasGiveUp

        Try
            If Not IsNothing(pobjRegistro) Then

                objEncabezado.intIdFirmaGiveUp = pobjRegistro.intIdFirmaGiveUp
                objEncabezado.intIdFirmaNegocio = pobjRegistro.intIdFirmaNegocio
                objEncabezado.strReferenciaGiveOut = pobjRegistro.strReferenciaGiveOut
                objEncabezado.bitAceptaGiveOut = pobjRegistro.bitAceptaGiveOut
                objEncabezado.bitAceptaGiveIn = pobjRegistro.bitAceptaGiveIn
                objEncabezado.logActiva = pobjRegistro.logActiva
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            ...
            objRespuesta = Await mdcProxy.FirmasGiveUp_DefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pintIdFirmaNegocio As Integer = -1,
                                               Optional ByVal pstrReferenciaGiveOut As String = "",
                                               Optional ByVal pbitAceptaGiveOut As Boolean = Nothing,
                                               Optional ByVal pbitAceptaGiveIn As Boolean = Nothing,
                                               Optional ByVal plogActiva As Boolean = Nothing) As Task(Of Boolean)

        Dim logResultado As Boolean = False

        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblFirmasGiveUp)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.FirmasGiveUp_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                pstrReferenciaGiveOut = System.Web.HttpUtility.UrlEncode(Program.validarValorString(pstrReferenciaGiveOut, String.Empty))

                objRespuesta = Await mdcProxy.FirmasGiveUp_ConsultarAsync(pintIdFirmaNegocio, pstrReferenciaGiveOut, pbitAceptaGiveOut, pbitAceptaGiveIn, plogActiva, Program.Usuario, Program.HashConexion)
            End If
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblFirmasGiveUp) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.FirmasGiveUp_IDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaFirmasGiveUp
    Implements INotifyPropertyChanged

    Private _intIdFirmaNegocio As Integer
    Public Property intIdFirmaNegocio() As Integer
        Get
            Return _intIdFirmaNegocio
        End Get
        Set(ByVal value As Integer)
            _intIdFirmaNegocio = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("intIdFirmaNegocio"))
        End Set
    End Property

    Private _strReferenciaGiveOut As String
    Public Property strReferenciaGiveOut() As String
        Get
            Return _strReferenciaGiveOut
        End Get
        Set(ByVal value As String)
            _strReferenciaGiveOut = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strReferenciaGiveOut"))
        End Set
    End Property

    Private _bitAceptaGiveOut As Boolean = Nothing
    Public Property bitAceptaGiveOut() As Boolean
        Get
            Return _bitAceptaGiveOut
        End Get
        Set(ByVal value As Boolean)
            _bitAceptaGiveOut = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("bitAceptaGiveOut"))
        End Set
    End Property

    Private _bitAceptaGiveIn As Boolean = Nothing
    Public Property bitAceptaGiveIn() As Boolean
        Get
            Return _bitAceptaGiveIn
        End Get
        Set(ByVal value As Boolean)
            _bitAceptaGiveIn = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("bitAceptaGiveIn"))
        End Set
    End Property

    Private _logActiva As Boolean = Nothing
    Public Property logActiva() As Boolean
        ...
        Set(ByVal value As Boolean)
            _logActiva = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("logActiva"))
        End Set
    End Property
