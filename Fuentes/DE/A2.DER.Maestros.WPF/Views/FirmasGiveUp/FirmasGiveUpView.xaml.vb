...
Partial Public Class FirmasGiveUpView
...
#Region "Variables"
    ...
    Private mobjVM As FirmasGiveUpViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New FirmasGiveUpViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, FirmasGiveUpViewModel)
