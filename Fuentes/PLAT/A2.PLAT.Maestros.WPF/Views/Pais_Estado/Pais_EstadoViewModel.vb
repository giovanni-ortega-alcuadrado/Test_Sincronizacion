...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblPais_Estado
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblPais_Estado
    Private mobjEncabezadoGuardadoAnterior As tblPais_Estado
    Public viewListaPrincipal As Pais_EstadoView
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of CPX_tblPais_Estado)
    Public Property ListaEncabezado() As List(Of CPX_tblPais_Estado)
        Get
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_tblPais_Estado
    Public Property EncabezadoSeleccionado() As CPX_tblPais_Estado
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_tblPais_Estado)
    ...
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblPais_Estado
    Public Property EncabezadoEdicionSeleccionado() As tblPais_Estado
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As tblPais_Estado)
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Sub CrearNuevoDetalle(Optional ByVal plogCopiarValorRegistroAnterior As Boolean = False)
        Try
            Dim objNvoEncabezado As New tblPais_Estado
    ...
    Public Async Function ActualizarRegistroDetalle() As Task(Of Boolean)
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Pais_Estado_ValidarAsync(_EncabezadoEdicionSeleccionado.intID,
                                                                                                                          _EncabezadoEdicionSeleccionado.strCodigo,
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Pais_Estado_EliminarIDAsync(_EncabezadoSeleccionado.intID, Program.Usuario, Program.HashConexion)
    ...
    Public Sub AbrirDetalle()
        Try
            If logVentanaDetalleActiva = False Then
                Dim objViewDetalle As New Pais_EstadoFormView(Me)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblPais_Estado, ByRef pobjRegistroSalvar As tblPais_Estado)
        Dim objEncabezado As tblPais_Estado = New tblPais_Estado

        Try
            If Not IsNothing(pobjRegistro) Then
                objEncabezado.intID = pobjRegistro.intID
                objEncabezado.intIDPais = pobjRegistro.intIDPais
                objEncabezado.strCodigo = pobjRegistro.strCodigo
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblPais_Estado)

            objRespuesta = Await mdcProxy.Pais_Estado_ConsultarDefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblPais_Estado)) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.Pais_Estado_ConsultarAsync(pintIDRegistroPadre, Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblPais_Estado) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.Pais_Estado_ConsultarIDAsync(pintID, Program.Usuario, Program.HashConexion)
