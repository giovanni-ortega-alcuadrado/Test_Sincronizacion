...
''' </summary>
''' <remarks>Natalia Andrea Otalvaro (Alcuadrado S.A.) - 29 de Enero 2018</remarks>
''' <history>
'''
'''</history>
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblPais
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblPais
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of CPX_tblPais)
    Public Property ListaEncabezado() As List(Of CPX_tblPais)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of CPX_tblPais))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_tblPais
    Public Property EncabezadoSeleccionado() As CPX_tblPais
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_tblPais)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblPais
    Public Property EncabezadoEdicionSeleccionado() As tblPais
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As tblPais)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaDatosTributarios
    Public Property cb() As CamposBusquedaDatosTributarios
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaDatosTributarios)
            _cb = value
    ...
    Private _ListaDetalleEstado As List(Of CPX_tblPais_Estado)
    Public Property ListaDetalleEstado() As List(Of CPX_tblPais_Estado)
        Get
            Return _ListaDetalleEstado
        End Get
        Set(ByVal value As List(Of CPX_tblPais_Estado))
            _ListaDetalleEstado = value
            MyBase.CambioItem("ListaDetalleEstado")
        End Set
    End Property

    Private _ListaDetalleMoneda As List(Of CPX_tblPais_Moneda)
    Public Property ListaDetalleMoneda() As List(Of CPX_tblPais_Moneda)
        Get
            Return _ListaDetalleMoneda
        End Get
        Set(ByVal value As List(Of CPX_tblPais_Moneda))
            _ListaDetalleMoneda = value
            MyBase.CambioItem("ListaDetalleMoneda")
        End Set
    End Property
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblPais
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not cb.intID > 0 Or Not String.IsNullOrEmpty(cb.strNombre) Or Not String.IsNullOrEmpty(cb.strCodigoISOAlfa2) Or Not String.IsNullOrEmpty(cb.strCodigoISOAlfa3) Or Not String.IsNullOrEmpty(cb.strCodigoISONumerico) Or Not String.IsNullOrEmpty(cb.strEstado) Then
                Await ConsultarEncabezado("BUSQUEDA", String.Empty, 0, cb.intID, cb.strNombre, cb.strCodigoISOAlfa2, cb.strCodigoISOAlfa3, cb.strCodigoISONumerico, cb.strEstado)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Pais_ValidarAsync(_EncabezadoEdicionSeleccionado.intID,
                                                                                                                          _EncabezadoEdicionSeleccionado.strNombre,
                                                                                                                          _EncabezadoEdicionSeleccionado.strCodigoISOAlfa2,
                                                                                                                          _EncabezadoEdicionSeleccionado.strCodigoISOAlfa3,
                                                                                                                          _EncabezadoEdicionSeleccionado.strCodigoISONumerico,
        ...
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Pais_EliminarIDAsync(_EncabezadoSeleccionado.intID, Program.Usuario, Program.HashConexion)
                    ...
                    If Not IsNothing(objRespuesta) Then
                        If Not IsNothing(objRespuesta.Value) Then
                            ...
                            If (objListaResultado.Where(Function(i) i.logInconsitencia = True).Count) = 0 Then
                                ...
                                Await ConsultarEncabezado("FILTRAR", String.Empty, _EncabezadoSeleccionado.intID)
                            Else
                                MyBase.ActualizarListaInconsistencias(objListaMensajes, Program.TituloSistema)
                                IsBusy = False
                            End If
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaDatosTributarios
            objCB.strNombre = String.Empty
            objCB.strCodigoISOAlfa2 = String.Empty
            objCB.strCodigoISOAlfa3 = String.Empty
            objCB.strCodigoISONumerico = String.Empty
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblPais, ByRef pobjRegistroSalvar As tblPais)
        Dim objEncabezado As tblPais = New tblPais
        ...
        Try
            If Not IsNothing(pobjRegistro) Then
                ...
                objEncabezado.strCodigoISOAlfa2 = pobjRegistro.strCodigoISOAlfa2
                objEncabezado.strCodigoISOAlfa3 = pobjRegistro.strCodigoISOAlfa3
                objEncabezado.strCodigoISONumerico = pobjRegistro.strCodigoISONumerico
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblPais)

            objRespuesta = Await mdcProxy.Pais_ConsultarDefectoAsync(Program.Usuario, Program.HashConexion)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
                                               ...
                                               Optional ByVal pstrCodigoISOAlfa2 As String = "",
                                               Optional ByVal pstrCodigoISOAlfa3 As String = "",
                                               Optional ByVal pstrCodigoISONumerico As String = "",
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblPais)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.Pais_FiltrarAsync(pstrFiltro, Program.Usuario, Program.HashConexion)

            Else
                pstrNombre = System.Web.HttpUtility.UrlEncode(Program.validarValorString(pstrNombre, String.Empty))
                pstrCodigoISOAlfa2 = System.Web.HttpUtility.UrlEncode(Program.validarValorString(pstrCodigoISOAlfa2, String.Empty))
                pstrCodigoISOAlfa3 = System.Web.HttpUtility.UrlEncode(Program.validarValorString(pstrCodigoISOAlfa3, String.Empty))
                pstrCodigoISONumerico = System.Web.HttpUtility.UrlEncode(Program.validarValorString(pstrCodigoISONumerico, String.Empty))
                ...
                objRespuesta = Await mdcProxy.Pais_ConsultarAsync(pintID, pstrNombre, pstrCodigoISOAlfa2, pstrCodigoISOAlfa3, pstrCodigoISONumerico, logEstado, Program.Usuario, Program.HashConexion)
            End If
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblPais) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.Pais_ConsultarIDAsync(pintID, Program.Usuario, Program.HashConexion)
...
''' 
''' </history>
Public Class CamposBusquedaDatosTributarios
    ...
    Private _strCodigoISOAlfa2 As String
    Public Property strCodigoISOAlfa2() As String
        Get
            Return _strCodigoISOAlfa2
        End Get
        Set(ByVal value As String)
            _strCodigoISOAlfa2 = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoISOAlfa2"))
        End Set
    End Property

    Private _strCodigoISOAlfa3 As String
    Public Property strCodigoISOAlfa3() As String
        Get
            Return _strCodigoISOAlfa3
        End Get
        Set(ByVal value As String)
            _strCodigoISOAlfa3 = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoISOAlfa3"))
        End Set
    End Property

    Private _strCodigoISONumerico As String
    Public Property strCodigoISONumerico() As String
        Get
            Return _strCodigoISONumerico
        End Get
        Set(ByVal value As String)
            _strCodigoISONumerico = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strCodigoISONumerico"))
        End Set
    End Property
