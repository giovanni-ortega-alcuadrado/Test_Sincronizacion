...
#Region "Métodos públicos genéricos"
    ...
    Public Shared Function MensajeEditarVersion() As String
        Return ("No se puede editar una versión histórica de la órden. Solo es posible editar la versión actual")
    End Function

    Public Shared Function MensajeEditarEstadoCancelado() As String
        Return ("No se puede editar la orden, ya que se encuentra cancelada. Solo es posible editar la orden en estado Pendiente")
    End Function

    Public Shared Function MensajeEditarEstadoPendiente() As String
        Return ("No se puede editar la orden, ya que se encuentra por fuera de rango de la fecha de cumplimiento")
    End Function
