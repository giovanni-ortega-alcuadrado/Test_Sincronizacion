'RABP20200601: Desarrollo de Control de cierre de operaciones Divisas
Public Class ControlCierreDivisasView
    Inherits UserControl
#Region "Variables"

    Private mobjVM As ControlCierreDivisasViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        mobjVM = New ControlCierreDivisasViewModel
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ControlCierreDivisasViewModel)
