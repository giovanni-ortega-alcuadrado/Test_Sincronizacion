...
Public Class ModulosEstadosConfiguracionViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblModulosEstadosConfiguracion
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Public mobjEncabezadoAnterior As tblModulosEstadosConfiguracion
    Dim strTipoFiltroBusqueda As String = String.Empty

    Public objViewPrincipal As ModulosEstadosConfiguracionView
    ...
    'Private strNombreReporte As String = "ModulosEstadosConfiguracion"
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    Private _ListaEncabezado As List(Of CPX_tblModulosEstadosConfiguracion)
    Public Property ListaEncabezado() As List(Of CPX_tblModulosEstadosConfiguracion)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of CPX_tblModulosEstadosConfiguracion))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_tblModulosEstadosConfiguracion
    Public Property EncabezadoSeleccionado() As CPX_tblModulosEstadosConfiguracion
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_tblModulosEstadosConfiguracion)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblModulosEstadosConfiguracion
    Public Property EncabezadoEdicionSeleccionado() As tblModulosEstadosConfiguracion
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As tblModulosEstadosConfiguracion)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaModulosEstadosConfiguracion
    Public Property cb() As CamposBusquedaModulosEstadosConfiguracion
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaModulosEstadosConfiguracion)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New tblModulosEstadosConfiguracion
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            Await ConsultarEncabezado("BUSQUEDA", String.Empty, cb.intID, cb.intIdModulo, cb.strEstadoInicial, cb.strEstadoPermitido)
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            IsBusy = True
            Dim strDetalleModulosEstadosConfiguracionEstados As String = String.Empty
            Dim strDetalleModulosEstadosConfiguracionEstadosEliminar As String = String.Empty


            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesOrdenes)) = Await mdcProxy.ModulosEstadosConfiguracion_ActualizarAsync(_EncabezadoEdicionSeleccionado.intId,
                                                                                _EncabezadoEdicionSeleccionado.intIdModulo,
                                                                                _EncabezadoEdicionSeleccionado.strEstadoInicial,
                                                                                _EncabezadoEdicionSeleccionado.strEstadoPermitido,
                                                                                Date.Now,
                                                                                  _EncabezadoEdicionSeleccionado.strEstadoRegistro,
                                                                                Program.Usuario,
                                                                                False)
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Function consultarEncabezadoPorDefecto() As Task
        Try
            Dim objRespuesta As InvokeResult(Of tblModulosEstadosConfiguracion)

            objRespuesta = Await mdcProxy.ModulosEstadosConfiguracion_DefectoAsync(Program.Usuario)
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String _
                                            ...
                                            , Optional ByVal pintIdModulo As Integer = 0 _
                                            , Optional ByVal pstrEstadoInicial As String = Nothing _
                                            , Optional ByVal pstrEstadoPermitido As String = Nothing _
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblModulosEstadosConfiguracion)) = Nothing

            Dim objRespuestaEntidad As InvokeResult(Of tblModulosEstadosConfiguracion) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.ModulosEstadosConfiguracion_FiltrarAsync(pstrFiltro, Program.Usuario)
            ElseIf pstrOpcion = "ID" Then
                objRespuestaEntidad = Await mdcProxy.ModulosEstadosConfiguracion_IDAsync(pintID, Program.Usuario)
            Else
                objRespuesta = Await mdcProxy.ModulosEstadosConfiguracion_ConsultarAsync(pintID, pintIdModulo, pstrEstadoInicial, pstrEstadoPermitido, Program.Usuario)
            End If
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintId As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblModulosEstadosConfiguracion) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.ModulosEstadosConfiguracion_IDAsync(pintId, Program.Usuario)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaModulosEstadosConfiguracion
            objCB.intId = Nothing
            objCB.intIdModulo = Nothing
            objCB.strEstadoInicial = Nothing
            objCB.strEstadoPermitido = Nothing
            cb = objCB
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblModulosEstadosConfiguracion, ByRef pobjRegistroSalvar As tblModulosEstadosConfiguracion)
        Dim objEncabezado As tblModulosEstadosConfiguracion = New tblModulosEstadosConfiguracion

        Try
            If Not IsNothing(pobjRegistro) Then
                objEncabezado.intId = pobjRegistro.intId
                objEncabezado.intIdModulo = pobjRegistro.intIdModulo
                objEncabezado.strEstadoInicial = pobjRegistro.strEstadoInicial
                objEncabezado.strEstadoPermitido = pobjRegistro.strEstadoPermitido
                objEncabezado.strUsuario = pobjRegistro.strUsuario
                objEncabezado.dtmActualizacion = pobjRegistro.dtmActualizacion
                objEncabezado.strEstadoRegistro = pobjRegistro.strEstadoRegistro
...
''' 
''' </history>
Public Class CamposBusquedaModulosEstadosConfiguracion
    ...
    Private _intIdModulo As Integer
    Public Property intIdModulo() As Integer
        ...
        Set(ByVal value As Integer)
            _intIdModulo = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("intIdModulo"))
        End Set
    End Property


    Private _strEstadoInicial As String
    Public Property strEstadoInicial() As String
        Get
            Return _strEstadoInicial
        End Get
        Set(ByVal value As String)
            _strEstadoInicial = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strEstadoInicial"))
        End Set
    End Property

    Private _strEstadoPermitido As String
    Public Property strEstadoPermitido() As String
        Get
            Return _strEstadoPermitido
        End Get
        Set(ByVal value As String)
            _strEstadoPermitido = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strEstadoPermitido"))
        End Set
    End Property
