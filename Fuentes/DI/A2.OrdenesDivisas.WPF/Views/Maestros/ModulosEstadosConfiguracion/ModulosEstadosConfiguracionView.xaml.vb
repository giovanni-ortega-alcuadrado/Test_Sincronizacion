...
Public Class ModulosEstadosConfiguracionView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As ModulosEstadosConfiguracionViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        mobjVM = New ModulosEstadosConfiguracionViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ModulosEstadosConfiguracionViewModel)
