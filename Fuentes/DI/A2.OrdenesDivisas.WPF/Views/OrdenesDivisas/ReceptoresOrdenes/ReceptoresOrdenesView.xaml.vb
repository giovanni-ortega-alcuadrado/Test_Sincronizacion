...
Public Class ReceptoresOrdenesView
...
#Region "Variables"
    ...
    Private mobjVM As ReceptoresOrdenesViewModel
...
#Region "Propiedades"
    ...
    Public Shared ReadOnly RegistroEncabezadoProperty As DependencyProperty =
                        DependencyProperty.Register("RegistroEncabezado", GetType(tblOrdenes), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioRegistroEncabezado)})
    ...
    Private Shared Sub CambioRegistroEncabezado(doj As DependencyObject, dp As DependencyPropertyChangedEventArgs)
        Dim myObject = DirectCast(doj, ReceptoresOrdenesView)
    ...
    Public Shared ReadOnly DetalleGuardaIndependienteProperty As DependencyProperty =
                        DependencyProperty.Register("DetalleGuardaIndependiente", GetType(Boolean), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioDetalleGuardaIndependiente)})
    ...
    Public Shared ReadOnly HabilitarEdicionRegistroProperty As DependencyProperty =
                        DependencyProperty.Register("HabilitarEdicionRegistro", GetType(Boolean), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarEdicionRegistro)})
    ...
    Public Shared ReadOnly HabilitarBotonGuardarYCopiarAnteriorProperty As DependencyProperty =
                        DependencyProperty.Register("HabilitarBotonGuardarYCopiarAnterior", GetType(Boolean), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCopiarAnterior)})
    ...
    Public Shared ReadOnly HabilitarBotonGuardarYCrearNuevoProperty As DependencyProperty =
                        DependencyProperty.Register("HabilitarBotonGuardarYCrearNuevo", GetType(Boolean), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCrearNuevo)})
    ...
    Public Shared ReadOnly ListaDetalleProperty As DependencyProperty =
                        DependencyProperty.Register("ListaDetalle", GetType(List(Of CPX_tblOrdenesReceptores)), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalle)})
    Public Property ListaDetalle() As List(Of CPX_tblOrdenesReceptores)
        Get
            Return CType(GetValue(ListaDetalleProperty), List(Of CPX_tblOrdenesReceptores))
        End Get
        Set(value As List(Of CPX_tblOrdenesReceptores))
    ...
    Public Shared ReadOnly DatosAdicionalesOrdenProperty As DependencyProperty =
                        DependencyProperty.Register("DatosAdicionalesOrden", GetType(clsDatosAdicionalesOrden), GetType(ReceptoresOrdenesView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioDatosAdicionalesOrden)})
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New ReceptoresOrdenesViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ReceptoresOrdenesViewModel)
