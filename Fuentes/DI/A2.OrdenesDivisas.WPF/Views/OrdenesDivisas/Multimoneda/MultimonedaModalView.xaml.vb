' Desarrollo de multimoneda para ordedes divisas
...
Public Class MultimonedaModalView
    Inherits Window
    ...
    ''' </summary>
    ''' <remarks>(Alcuadrado S.A.) - 22 de julio 2019</remarks>
#Region "Variables"
...
#Region "Inicializacion"
    ''' <history>
    ''' </history>
    Public Sub New(ByVal pobjViewModel As MultimonedaViewModel)
        InitializeComponent()
