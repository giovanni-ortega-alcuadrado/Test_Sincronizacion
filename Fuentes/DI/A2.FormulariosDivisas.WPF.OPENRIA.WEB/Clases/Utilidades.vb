...
Module Utilidades
    ...
    Friend Function CrearSQLParameter(ByVal pstrNombre As String, ByVal pobjValor As Object, ByVal pobTipo As SqlDbType) As SqlParameter
        ...
        objParametro.SqlDbType = pobTipo
    ...
    ''' Pruebas CB       : Juan Carlos Soto Cruz - Febrero 24/2014 - Resultado Ok 
    ''' </history>    
    Friend Function GenerarExcel(pobjDatos As DataTable, pstrRuta As String, pstrNombreArchivo As String, Optional pstrNombreHoja As String = "") As String
        Try
    ...
    ''' Pruebas CB       : Juan Carlos Soto Cruz - Abril 21/2014 - Resultado Ok 
    ''' </history>   
    Friend Function GenerarExcelVersionesViejas(pobjDatos As DataTable, pstrRuta As String, pstrNombreArchivo As String, Optional pstrNombreHoja As String = "") As String
        Try
    ...
    ''' Descripción      : Se retira la condición de la extensión para que el archivo se visualice correctamente desde el navegador
    ''' Fecha            : Septiembre 12/2014
    ''' Pruebas CB       : Germán Arbey González Osorio - Septiembre 12/2014 - Resultado Ok   
    ''' </history>   
    Friend Function GenerarTextoPlano(pobjDatos As DataTable, pstrRuta As String, pstrNombreArchivo As String, ByVal pstrExtension As String, pstrSeparador As String) As String
        ...
        Try
            ...
            'If String.IsNullOrEmpty(pstrExtension) Then
            pstrExtension = "txt"
            'End If
