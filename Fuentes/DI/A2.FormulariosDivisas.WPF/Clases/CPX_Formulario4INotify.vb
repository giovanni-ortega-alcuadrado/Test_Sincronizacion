...
Public Class CPX_Formulario4INotify
    ...
    Public Property strEstado() As String
        ...
        End Set
    End Property
    Private _blnEnviadoDian As Nullable(Of Boolean)
    Public Property blnEnviadoDian() As Nullable(Of Boolean)
        Get
    ...
    Private _strTipoDocumentoEmpRec As String
    Public Property strTipoDocumentoEmpRec() As String
        Get
            Return _strTipoDocumentoEmpRec
        End Get
        Set(ByVal value As String)
            _strTipoDocumentoEmpRec = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngNumeroidentificacionEmpRec As String
    Public Property lngNumeroidentificacionEmpRec() As String
        Get
            Return _lngNumeroidentificacionEmpRec
        End Get
        Set(ByVal value As String)
            _lngNumeroidentificacionEmpRec = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngDigitoVerificacionEmpRec As Nullable(Of Integer)
    Public Property lngDigitoVerificacionEmpRec() As Nullable(Of Integer)
        Get
            Return _lngDigitoVerificacionEmpRec
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _lngDigitoVerificacionEmpRec = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngNumeroDeclAnteriorFirma As Nullable(Of Integer)
    Public Property lngNumeroDeclAnteriorFirma() As Nullable(Of Integer)
        Get
    ...
    Private _strNombreEmpRec As String
    Public Property strNombreEmpRec() As String
        Get
            Return _strNombreEmpRec
        End Get
        Set(ByVal value As String)
            _strNombreEmpRec = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _intPaisEmpReceptora As Nullable(Of Integer)
    Public Property intPaisEmpReceptora() As Nullable(Of Integer)
        Get
            Return _intPaisEmpReceptora
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _intPaisEmpReceptora = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strTipoDocumentoInv As String
    Public Property strTipoDocumentoInv() As String
        Get
            Return _strTipoDocumentoInv
        End Get
        Set(ByVal value As String)
            _strTipoDocumentoInv = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngNumeroidentificacionInv As String
    Public Property lngNumeroidentificacionInv() As String
        Get
            Return _lngNumeroidentificacionInv
        End Get
        Set(ByVal value As String)
            _lngNumeroidentificacionInv = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngDigitoVerificacionInv As Nullable(Of Integer)
    Public Property lngDigitoVerificacionInv() As Nullable(Of Integer)
        Get
            Return _lngDigitoVerificacionInv
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _lngDigitoVerificacionInv = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strNombreInversionista As String
    Public Property strNombreInversionista() As String
        Get
            Return _strNombreInversionista
        End Get
        Set(ByVal value As String)
            _strNombreInversionista = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strEntidadInversionista As String
    Public Property strEntidadInversionista() As String
        Get
            Return _strEntidadInversionista
        End Get
        Set(ByVal value As String)
            _strEntidadInversionista = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _intPaisInversionista As Nullable(Of Integer)
    Public Property intPaisInversionista() As Nullable(Of Integer)
        Get
            Return _intPaisInversionista
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _intPaisInversionista = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _dtmFechaInversionista As Nullable(Of Date)
    Public Property dtmFechaInversionista() As Nullable(Of Date)
        Get
            Return _dtmFechaInversionista
        End Get
        Set(ByVal value As Nullable(Of Date))
            _dtmFechaInversionista = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngNumeroInversionista As Nullable(Of Integer)
    Public Property lngNumeroInversionista() As Nullable(Of Integer)
        Get
            Return _lngNumeroInversionista
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _lngNumeroInversionista = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _lngNumeralcambiarioOperacion As Nullable(Of Integer)
    Public Property lngNumeralcambiarioOperacion() As Nullable(Of Integer)
        Get
            Return _lngNumeralcambiarioOperacion
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _lngNumeralcambiarioOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strCodigoMonedaOperacion As String
    Public Property strCodigoMonedaOperacion() As String
        Get
            Return _strCodigoMonedaOperacion
        End Get
        Set(ByVal value As String)
            _strCodigoMonedaOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _dblValorMonedaGiroOperacion As Nullable(Of Decimal)
    Public Property dblValorMonedaGiroOperacion() As Nullable(Of Decimal)
        Get
            Return _dblValorMonedaGiroOperacion
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            _dblValorMonedaGiroOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _dblTipoCambioUSDOperacion As Nullable(Of Decimal)
    Public Property dblTipoCambioUSDOperacion() As Nullable(Of Decimal)
        Get
            Return _dblTipoCambioUSDOperacion
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            _dblTipoCambioUSDOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _dblValorUSDOperacion As Nullable(Of Decimal)
    Public Property dblValorUSDOperacion() As Nullable(Of Decimal)
        Get
            Return _dblValorUSDOperacion
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            _dblValorUSDOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _dblTipoCambioPesosOperacion As Nullable(Of Decimal)
    Public Property dblTipoCambioPesosOperacion() As Nullable(Of Decimal)
        Get
            Return _dblTipoCambioPesosOperacion
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            _dblTipoCambioPesosOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _dblValorPesosOperacion As Nullable(Of Decimal)
    Public Property dblValorPesosOperacion() As Nullable(Of Decimal)
        Get
            Return _dblValorPesosOperacion
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            _dblValorPesosOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strDestinoOperacion As Nullable(Of Integer)
    Public Property strDestinoOperacion() As Nullable(Of Integer)
        Get
            Return _strDestinoOperacion
        End Get
        Set(ByVal value As Nullable(Of Integer))
            _strDestinoOperacion = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strPaisInv As String
    Public Property strPaisInv() As String
        Get
            Return _strPaisInv
        End Get
        Set(ByVal value As String)
    ...
    Private _strCiiuInv As String
    Public Property strCiiuInv() As String
        Get
            Return _strCiiuInv
        End Get
        Set(ByVal value As String)
    ...
    Private _strPaisRec As String
    Public Property strPaisRec() As String
        Get
            Return _strPaisRec
        End Get
        Set(ByVal value As String)
    ...
    Private _strCiiuRec As String
    Public Property strCiiuRec() As String
        Get
            Return _strCiiuRec
        End Get
        Set(ByVal value As String)
    ...
    Private _strInversionPlazo As String
    Public Property strInversionPlazo() As String
        Get
            Return _strInversionPlazo
        End Get
        Set(ByVal value As String)
            _strInversionPlazo = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strCiudadEmpRec As String
    Public Property strCiudadEmpRec() As String
        Get
            Return _strCiudadEmpRec
        End Get
        Set(ByVal value As String)
            _strCiudadEmpRec = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strTelefonoEmpRec As String
    Public Property strTelefonoEmpRec() As String
        Get
            Return _strTelefonoEmpRec
        End Get
        Set(ByVal value As String)
            _strTelefonoEmpRec = value
            NotifyPropertyChanged()
        End Set
    End Property

    Private _strAccionesOCuotas As String
    Public Property strAccionesOCuotas() As String
        Get
            Return _strAccionesOCuotas
        End Get
        Set(ByVal value As String)
            _strAccionesOCuotas = value
            NotifyPropertyChanged()
        End Set
    End Property
