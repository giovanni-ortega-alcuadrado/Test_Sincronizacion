...
Public Class Formulario1DescripcionOpView
...
#Region "Variables"
	...
	Private mobjVM As Formulario1DescripcionOpViewModel
...
#Region "Propiedades"
    ...
    Public Shared ReadOnly IDRegistroEncabezadoProperty As DependencyProperty =
                        DependencyProperty.Register("IDRegistroEncabezado", GetType(tblFormulariosBcoRepublica1), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioIDRegistroEncabezado)})
    ...
    Private Shared Sub CambioIDRegistroEncabezado(doj As DependencyObject, dp As DependencyPropertyChangedEventArgs)
		Dim myObject = DirectCast(doj, Formulario1DescripcionOpView)
	...
	Public Shared ReadOnly DetalleGuardaIndependienteProperty As DependencyProperty =
						DependencyProperty.Register("DetalleGuardaIndependiente", GetType(Boolean), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioDetalleGuardaIndependiente)})
	...
	Public Shared ReadOnly HabilitarEdicionRegistroProperty As DependencyProperty =
						DependencyProperty.Register("HabilitarEdicionRegistro", GetType(Boolean), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarEdicionRegistro)})
	...
	Public Shared ReadOnly HabilitarBotonGuardarYCopiarAnteriorProperty As DependencyProperty =
						DependencyProperty.Register("HabilitarBotonGuardarYCopiarAnterior", GetType(Boolean), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCopiarAnterior)})
	...
	Public Shared ReadOnly HabilitarBotonGuardarYCrearNuevoProperty As DependencyProperty =
						DependencyProperty.Register("HabilitarBotonGuardarYCrearNuevo", GetType(Boolean), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCrearNuevo)})
	...
	Public Shared ReadOnly ListaDetalleProperty As DependencyProperty =
						DependencyProperty.Register("ListaDetalle", GetType(List(Of CPX_tblFormulario1DetalleDian)), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalle)})
	Public Property ListaDetalle() As List(Of CPX_tblFormulario1DetalleDian)
		Get
			Return CType(GetValue(ListaDetalleProperty), List(Of CPX_tblFormulario1DetalleDian))
		End Get
		Set(value As List(Of CPX_tblFormulario1DetalleDian))
	...
	Public Shared ReadOnly ListaDetalleEliminarProperty As DependencyProperty =
						DependencyProperty.Register("ListaDetalleEliminar", GetType(List(Of CPX_tblFormulario1DetalleDian)), GetType(Formulario1DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalleEliminar)})
	Public Property ListaDetalleEliminar() As List(Of CPX_tblFormulario1DetalleDian)
		Get
			Return CType(GetValue(ListaDetalleEliminarProperty), List(Of CPX_tblFormulario1DetalleDian))
		End Get
		Set(value As List(Of CPX_tblFormulario1DetalleDian))
...
#Region "Inicializacion"
	...
	Public Sub New()
		InitializeComponent()
		mobjVM = New Formulario1DescripcionOpViewModel
	...
	Private Async Sub inicializar()
		If Not Me.DataContext Is Nothing Then
			mobjVM = CType(Me.DataContext, Formulario1DescripcionOpViewModel)
