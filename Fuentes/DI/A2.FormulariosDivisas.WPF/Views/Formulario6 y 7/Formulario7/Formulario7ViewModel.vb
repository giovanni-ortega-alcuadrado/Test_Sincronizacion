...
Public Class Formulario7ViewModel
...
#Region "Variables - REQUERIDO"
	...
	Private strNombreReporte As String = "Formulario7VB"

	Public mobjView As Formulario7View
...
#Region "Propiedades del Encabezado - REQUERIDO"
	...
	''' </summary>
	Private _cb As CamposBusquedaFormulario7
	Public Property cb() As CamposBusquedaFormulario7
		Get
			Return _cb
		End Get
		Set(ByVal value As CamposBusquedaFormulario7)
			_cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
	...
	Public Overrides Async Sub ActualizarRegistro()
		...
		Try
			...
			Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Formulario7_ActualizarAsync(
	...
	Public Async Sub IniciaEditar()
		ObtenerRegistroAnterior(_EncabezadoEdicionSeleccionado, mobjEncabezadoAnterior)
		'Se comenta esto ya que el formulario 7 no tiene sección de la declaracion anterior
		If _EncabezadoEdicionSeleccionado.logEnviado Then
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
	...
	Private Async Function ConsultarNumerales() As Task(Of Boolean)
		...
		Try
			...
			objRespuesta = Await mdcProxy.NumeralesCambiarios_FiltrarAsync(String.Empty, 7, Program.Usuario)
	...
	Private Async Sub consultarEncabezadoPorDefecto()
		Try
			...
			objRespuesta = Await mdcProxy.Formulario7_DefectoAsync(Program.Usuario)
	...
	Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
		...
		Try
			...
			If pstrOpcion = "FILTRAR" Then
				...
				objRespuesta = Await mdcProxy.Formulario7_FiltrarAsync(pstrFiltro, Program.Usuario)
			ElseIf pstrOpcion = "ID" Then
				objRespuesta = Await mdcProxy.Formulario7_ConsultarAsync(pintID, pdtmFecha, pstrNombre, pstrNumeroIDDeclarante, Program.Usuario)
			Else
				objRespuesta = Await mdcProxy.Formulario7_ConsultarAsync(pintID, pdtmFecha, pstrNombre, pstrNumeroIDDeclarante, Program.Usuario)
	...
	Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
		...
		Try
			...
			objRespuesta = Await mdcProxy.Formulario7_IDAsync(pintID, Program.Usuario)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
	...
	Private Sub PrepararNuevaBusqueda()
		Try
			Dim objCB As New CamposBusquedaFormulario7
			objCB.ID = 0
			objCB.Fecha = Nothing
			cb = objCB
...
''' 
''' </history>
Public Class CamposBusquedaFormulario7
