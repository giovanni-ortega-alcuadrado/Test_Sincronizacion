...
Public Class PlanAmortizacionView
...
#Region "Variables"
	...
	Private mobjVM As PlanAmortizacionViewModel
...
#Region "Propiedades"
	...
	Public Shared ReadOnly IDRegistroEncabezadoProperty As DependencyProperty =
						DependencyProperty.Register("IDRegistroEncabezado", GetType(tblFormularioEndeudamientoExterno), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioIDRegistroEncabezado)})
	Public Property IDRegistroEncabezado() As tblFormularioEndeudamientoExterno
		Get
			Return CType(GetValue(IDRegistroEncabezadoProperty), tblFormularioEndeudamientoExterno)
		End Get
		Set(value As tblFormularioEndeudamientoExterno)
	...
	Private Shared Sub CambioIDRegistroEncabezado(doj As DependencyObject, dp As DependencyPropertyChangedEventArgs)
		Dim myObject = DirectCast(doj, PlanAmortizacionView)
	...
	Public Shared ReadOnly DetalleGuardaIndependienteProperty As DependencyProperty =
						DependencyProperty.Register("DetalleGuardaIndependiente", GetType(Boolean), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioDetalleGuardaIndependiente)})
	...
	Public Shared ReadOnly HabilitarEdicionRegistroProperty As DependencyProperty =
						DependencyProperty.Register("HabilitarEdicionRegistro", GetType(Boolean), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarEdicionRegistro)})
	...
	Public Shared ReadOnly HabilitarBotonGuardarYCopiarAnteriorProperty As DependencyProperty =
						DependencyProperty.Register("HabilitarBotonGuardarYCopiarAnterior", GetType(Boolean), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCopiarAnterior)})
	...
	Public Shared ReadOnly HabilitarBotonGuardarYCrearNuevoProperty As DependencyProperty =
						DependencyProperty.Register("HabilitarBotonGuardarYCrearNuevo", GetType(Boolean), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCrearNuevo)})
	...
	Public Shared ReadOnly ListaDetalleProperty As DependencyProperty =
						DependencyProperty.Register("ListaDetalle", GetType(List(Of CPX_FormularioEndeudamientoDetalle)), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalle)})
	Public Property ListaDetalle() As List(Of CPX_FormularioEndeudamientoDetalle)
		Get
			Return CType(GetValue(ListaDetalleProperty), List(Of CPX_FormularioEndeudamientoDetalle))
		End Get
		Set(value As List(Of CPX_FormularioEndeudamientoDetalle))
	...
	Public Shared ReadOnly ListaDetalleEliminarProperty As DependencyProperty =
						DependencyProperty.Register("ListaDetalleEliminar", GetType(List(Of CPX_FormularioEndeudamientoDetalle)), GetType(PlanAmortizacionView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalleEliminar)})
	Public Property ListaDetalleEliminar() As List(Of CPX_FormularioEndeudamientoDetalle)
		Get
			Return CType(GetValue(ListaDetalleEliminarProperty), List(Of CPX_FormularioEndeudamientoDetalle))
		End Get
		Set(value As List(Of CPX_FormularioEndeudamientoDetalle))
...
#Region "Inicializacion"
	...
	Public Sub New()
		InitializeComponent()
		mobjVM = New PlanAmortizacionViewModel
	...
	Private Async Sub inicializar()
		If Not Me.DataContext Is Nothing Then
			mobjVM = CType(Me.DataContext, PlanAmortizacionViewModel)
