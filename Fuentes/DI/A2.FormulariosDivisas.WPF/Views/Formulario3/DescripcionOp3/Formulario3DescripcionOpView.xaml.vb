...
Public Class Formulario3DescripcionOpView
...
#Region "Variables"
    ...
    Private mobjVM As Formulario3DescripcionOpViewModel
...
#Region "Propiedades"
	...
	Public Shared ReadOnly IDRegistroEncabezadoProperty As DependencyProperty =
						DependencyProperty.Register("IDRegistroEncabezado", GetType(CPX_Formulario3INotify), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioIDRegistroEncabezado)})
	Public Property IDRegistroEncabezado() As CPX_Formulario3INotify
		Get
			Return CType(GetValue(IDRegistroEncabezadoProperty), CPX_Formulario3INotify)
		End Get
		Set(value As CPX_Formulario3INotify)
	...
	Private Shared Sub CambioIDRegistroEncabezado(doj As DependencyObject, dp As DependencyPropertyChangedEventArgs)
        Dim myObject = DirectCast(doj, Formulario3DescripcionOpView)
    ...
    Public Shared ReadOnly DetalleGuardaIndependienteProperty As DependencyProperty =
                        DependencyProperty.Register("DetalleGuardaIndependiente", GetType(Boolean), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioDetalleGuardaIndependiente)})
    ...
    Public Shared ReadOnly HabilitarEdicionRegistroProperty As DependencyProperty =
                        DependencyProperty.Register("HabilitarEdicionRegistro", GetType(Boolean), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarEdicionRegistro)})
    ...
    Public Shared ReadOnly HabilitarBotonGuardarYCopiarAnteriorProperty As DependencyProperty =
                        DependencyProperty.Register("HabilitarBotonGuardarYCopiarAnterior", GetType(Boolean), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCopiarAnterior)})
    ...
    Public Shared ReadOnly HabilitarBotonGuardarYCrearNuevoProperty As DependencyProperty =
                        DependencyProperty.Register("HabilitarBotonGuardarYCrearNuevo", GetType(Boolean), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.DefaultValue = True, .BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioHabilitarBotonGuardarYCrearNuevo)})
    ...
    Public Shared ReadOnly ListaDetalleProperty As DependencyProperty =
                        DependencyProperty.Register("ListaDetalle", GetType(List(Of CPX_tblDetalle1FormulariosBcoRepublica)), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalle)})
    Public Property ListaDetalle() As List(Of CPX_tblDetalle1FormulariosBcoRepublica)
        Get
            Return CType(GetValue(ListaDetalleProperty), List(Of CPX_tblDetalle1FormulariosBcoRepublica))
        End Get
        Set(value As List(Of CPX_tblDetalle1FormulariosBcoRepublica))
    ...
    Public Shared ReadOnly ListaDetalleEliminarProperty As DependencyProperty =
                        DependencyProperty.Register("ListaDetalleEliminar", GetType(List(Of CPX_tblDetalle1FormulariosBcoRepublica)), GetType(Formulario3DescripcionOpView), New FrameworkPropertyMetadata() With {.BindsTwoWayByDefault = True, .PropertyChangedCallback = (AddressOf CambioListaDetalleEliminar)})
    Public Property ListaDetalleEliminar() As List(Of CPX_tblDetalle1FormulariosBcoRepublica)
        Get
            Return CType(GetValue(ListaDetalleEliminarProperty), List(Of CPX_tblDetalle1FormulariosBcoRepublica))
        End Get
        Set(value As List(Of CPX_tblDetalle1FormulariosBcoRepublica))
...
#Region "Inicializacion"
    ...
    Public Sub New()
        InitializeComponent()
        mobjVM = New Formulario3DescripcionOpViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, Formulario3DescripcionOpViewModel)
...
#End Region
    ...
    Private Sub VisualizarDetalle(sender As Object, e As RoutedEventArgs)
        If Not IsNothing(mobjVM.EncabezadoSeleccionado) Then
            If mobjVM.EncabezadoSeleccionado.intSecuencia.ToString <> CType(sender, Button).Tag Then
                mobjVM.EncabezadoSeleccionado = mobjVM.ListaEncabezado.Where(Function(i) i.intSecuencia.ToString = CType(sender, Button).Tag).First
            End If
        Else
            mobjVM.EncabezadoSeleccionado = mobjVM.ListaEncabezado.Where(Function(i) i.intSecuencia.ToString = CType(sender, Button).Tag).First
        End If
