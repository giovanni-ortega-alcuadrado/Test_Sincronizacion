...
Public Class Formulario3DescripcionOpModalView
    Inherits Window
...
#Region "Inicializacion"
    ''' <history>
    ''' </history>
    Public Sub New(ByVal pobjViewModel As Formulario3DescripcionOpViewModel)
        InitializeComponent()
    ...
    Private Sub View_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        Try
            If mlogInicializar Then
                ...
                cm.GridViewRegistros = mobjVM.viewListaPrincipal.datapager3
            End If
