...
Public Class DestinosInvFormulariosView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As DestinosInvFormulariosViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        mobjVM = New DestinosInvFormulariosViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, DestinosInvFormulariosViewModel)
