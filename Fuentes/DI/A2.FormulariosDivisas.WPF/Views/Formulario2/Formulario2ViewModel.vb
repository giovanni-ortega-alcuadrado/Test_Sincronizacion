...
Public Class Formulario2ViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblFormulariosBcoRepublica1
	...
	Private strNombreReporte As String = "Formulario2VB"
...
#Region "Propiedades del Encabezado - REQUERIDO"
	...
	Private _ListaEncabezado As List(Of CPX_Formulario2)
	Public Property ListaEncabezado() As List(Of CPX_Formulario2)
		Get
			Return _ListaEncabezado
		End Get
		Set(ByVal value As List(Of CPX_Formulario2))
	...
	''' </summary>
	Private _EncabezadoSeleccionado As CPX_Formulario2
	Public Property EncabezadoSeleccionado() As CPX_Formulario2
		Get
			Return _EncabezadoSeleccionado
		End Get
		Set(ByVal value As CPX_Formulario2)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaFormulario2
	Public Property cb() As CamposBusquedaFormulario2
		Get
			Return _cb
		End Get
		Set(ByVal value As CamposBusquedaFormulario2)
			_cb = value
    ...
    Private _ListaDetalle As List(Of CPX_DIVISAS_tblDetalle2FormularioBcoRepublica)
    Public Property ListaDetalle() As List(Of CPX_DIVISAS_tblDetalle2FormularioBcoRepublica)
        Get
    ...
    Private _ListaDetalleDIAN As List(Of CPX_tblDetalleFormulario2DIAN)
    Public Property ListaDetalleDIAN() As List(Of CPX_tblDetalleFormulario2DIAN)
        Get
            Return _ListaDetalleDIAN
        End Get
        Set(ByVal value As List(Of CPX_tblDetalleFormulario2DIAN))
            _ListaDetalleDIAN = value
            MyBase.CambioItem("ListaDetalleDIAN")
            CalcularCampos()
        End Set
    End Property

    Private _ListaDetalleEliminar As List(Of CPX_DIVISAS_tblDetalle2FormularioBcoRepublica)
    Public Property ListaDetalleEliminar() As List(Of CPX_DIVISAS_tblDetalle2FormularioBcoRepublica)
        Get
    ...
    Private _ListaDetalleDIANEliminar As List(Of CPX_tblDetalleFormulario2DIAN)
    Public Property ListaDetalleDIANEliminar() As List(Of CPX_tblDetalleFormulario2DIAN)
        Get
            Return _ListaDetalleDIANEliminar
        End Get
        Set(ByVal value As List(Of CPX_tblDetalleFormulario2DIAN))
            _ListaDetalleDIANEliminar = value
            MyBase.CambioItem("ListaDetalleDIANEliminar")
        End Set
    End Property
...
#Region "Métodos públicos del encabezado - REQUERIDO"
	...
	Public Overrides Sub NuevoRegistro()
		Try
            ...
            ObtenerRegistroAnterior(mobjEncabezadoAnterior, objNvoEncabezado)
	...
	Public Overrides Async Sub ActualizarRegistro()
		...
		Try
            ...
            Dim strDetalleDIAN As String = String.Empty
            Dim strDetalleDIANEliminar As String = String.Empty
            ...
            If Not IsNothing(_ListaDetalleEliminar) Then
                ...
                For Each objDet In _ListaDetalleEliminar
                    Dim strXMLDetalleEliminar = <Detalle secuencia=<%= objDet.secuencia %>
                                                    >
                                                </Detalle>
            ...
            If Not IsNothing(_ListaDetalleDIAN) Then
                strDetalleDIAN = "<Detalles>  "
                For Each objDet In _ListaDetalleDIAN
                    Dim strXMLDetalleDIAN = <Detalle intID=<%= objDet.intID %>
                                                lnNumeroDecl=<%= objDet.lnNumeroDecl %>
                                                dtmFecha=<%= objDet.dtmFecha %>
                                                intCiudad=<%= objDet.intCiudad %>
                                                lngNumero=<%= objDet.lngNumero %>
                                                ...
                                                strUsuario=<%= objDet.strUsuario %>
                                                intNumeral=<%= objDet.intNumeral %>
                                                dblvalor=<%= objDet.dblValor %>
                                                >
                                            </Detalle>

                    strDetalleDIAN = strDetalleDIAN & strXMLDetalleDIAN.ToString
                Next
                strDetalleDIAN = strDetalleDIAN & " </Detalles>"
            End If

            If Not IsNothing(_ListaDetalleDIANEliminar) Then
                strDetalleDIANEliminar = "<Detalles>  "
                For Each objDet In _ListaDetalleDIANEliminar
                    Dim strXMLDetalleDIANEliminar = <Detalle intID=<%= objDet.intID %>
                                                        >
                                                    </Detalle>

                    strDetalleDIANEliminar = strDetalleDIANEliminar & strXMLDetalleDIANEliminar.ToString
                Next
                strDetalleDIANEliminar = strDetalleDIANEliminar & " </Detalles>"
            End If
            ...
            Dim strXMLDetFormulario2DIAN As String = System.Web.HttpUtility.UrlEncode(strDetalleDIAN)
            Dim strXMLDetEliminarFormulario2DIAN As String = System.Web.HttpUtility.UrlEncode(strDetalleDIANEliminar)


            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Formulario2_ActualizarAsync(
                                                                                _EncabezadoEdicionSeleccionado.intNumeroDecl,
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
	...
	Private Async Sub consultarEncabezadoPorDefecto()
		Try
            ...
            objRespuesta = Await mdcProxy.Formulario2_DefectoAsync(Program.Usuario)
	...
	Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
		...
		Try
			IsBusy = True
			Dim objRespuesta As InvokeResult(Of List(Of CPX_Formulario2)) = Nothing
			...
			If pstrOpcion = "FILTRAR" Then
				...
				objRespuesta = Await mdcProxy.Formulario2_FiltrarAsync(pstrFiltro, Program.Usuario)
			ElseIf pstrOpcion = "ID" Then
				objRespuesta = Await mdcProxy.Formulario2_ConsultarAsync(plngNumeroDecl, pdtmFecha, pstrNombre, pintOrden, pstrNumeroIdentificacion, Program.Usuario)
			Else
				objRespuesta = Await mdcProxy.Formulario2_ConsultarAsync(plngNumeroDecl, pdtmFecha, pstrNombre, pintOrden, pstrNumeroIdentificacion, Program.Usuario)
	...
	Private Async Function ConsultarEncabezadoEdicion(ByVal plngNumeroDecl As Integer, ByVal pdtmFecha As Date) As Task(Of Boolean)
		...
		Try
			...
			objRespuesta = Await mdcProxy.Formulario2_IDAsync(plngNumeroDecl, pdtmFecha, Program.Usuario)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
	...
	Private Sub PrepararNuevaBusqueda()
		Try
			Dim objCB As New CamposBusquedaFormulario2
			objCB.ID = 0
			objCB.Fecha = Nothing
			cb = objCB
...
''' 
''' </history>
Public Class CamposBusquedaFormulario2
