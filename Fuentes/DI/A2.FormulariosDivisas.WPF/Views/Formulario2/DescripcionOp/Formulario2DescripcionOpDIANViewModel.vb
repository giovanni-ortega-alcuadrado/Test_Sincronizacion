...
'''
'''</history>
Public Class Formulario2DescripcionOpDIANViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As tblDetalle2FormulariosBcoRepublica_DIAN
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As tblDetalle2FormulariosBcoRepublica_DIAN
    Private mobjEncabezadoGuardadoAnterior As tblDetalle2FormulariosBcoRepublica_DIAN
    Public viewListaPrincipal As Formulario2DescripcionOpDIANView
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As List(Of CPX_tblDetalleFormulario2DIAN)
    Public Property ListaEncabezado() As List(Of CPX_tblDetalleFormulario2DIAN)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of CPX_tblDetalleFormulario2DIAN))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_tblDetalleFormulario2DIAN
    Public Property EncabezadoSeleccionado() As CPX_tblDetalleFormulario2DIAN
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_tblDetalleFormulario2DIAN)
    ...
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As tblDetalle2FormulariosBcoRepublica_DIAN
    Public Property EncabezadoEdicionSeleccionado() As tblDetalle2FormulariosBcoRepublica_DIAN
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As tblDetalle2FormulariosBcoRepublica_DIAN)
    ...
    Private _ListaEncabezadoEliminar As New List(Of CPX_tblDetalleFormulario2DIAN)
    Public Property ListaEncabezadoEliminar() As List(Of CPX_tblDetalleFormulario2DIAN)
        Get
    ...
    Private _ListaNumerales As List(Of BusquedaNumeralesCambiariosDIAN)
    Public Property ListaNumerales() As List(Of BusquedaNumeralesCambiariosDIAN)
        Get
            Return _ListaNumerales
        End Get
        Set(ByVal value As List(Of BusquedaNumeralesCambiariosDIAN))
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Sub CrearNuevoDetalle(Optional ByVal plogCopiarValorRegistroAnterior As Boolean = False)
        Try
            Dim objNvoEncabezado As New tblDetalle2FormulariosBcoRepublica_DIAN
    ...
    Public Function ActualizarRegistroDetalle() As Boolean
        ...
        Try
            ...
            Dim objListaEncabezado As New List(Of CPX_tblDetalleFormulario2DIAN)
            If Not IsNothing(_ListaEncabezado) Then
            ...
            If IsNothing(_EncabezadoEdicionSeleccionado.dblValor) Then
                A2Utilidades.Mensajes.mostrarMensaje(Program.MensajValorVacio, Program.TituloSistema, A2Utilidades.wppMensajes.TiposMensaje.Advertencia)
                IsBusy = False
                plogRetorno = False
            Else

                If objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).Count > 0 Then
                    objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).First.lnNumeroDecl = _EncabezadoEdicionSeleccionado.lnNumeroDecl
                    objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).First.dtmFecha = _EncabezadoEdicionSeleccionado.dtmFecha
                    objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).First.intCiudad = _EncabezadoEdicionSeleccionado.intCiudad
                    objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).First.lngNumero = _EncabezadoEdicionSeleccionado.lngNumero
                    ...
                    objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).First.intNumeral = _EncabezadoEdicionSeleccionado.intNumeral
                    ...
                    objListaEncabezado.Where(Function(i) i.intID = _EncabezadoEdicionSeleccionado.intID).First.dtmFechaActualizacion = _EncabezadoEdicionSeleccionado.dtmFechaActualizacion
                ...
                Else
                    Dim objNvoEncabezado As New CPX_tblDetalleFormulario2DIAN
    ...
    Private Sub BorrarRegistroConfirmado(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    Dim objListaDetalle As New List(Of CPX_tblDetalleFormulario2DIAN)
                    ...
                    If IsNothing(_ListaEncabezadoEliminar) Then
                        _ListaEncabezadoEliminar = New List(Of CPX_tblDetalleFormulario2DIAN)
                    End If
    ...
    Public Sub AbrirDetalle()
        Try
            If logVentanaDetalleActiva = False Then
                Dim objViewDetalle As New Formulario2DescripcionOpModalDIANView(Me)
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As tblDetalle2FormulariosBcoRepublica_DIAN, ByRef pobjRegistroSalvar As tblDetalle2FormulariosBcoRepublica_DIAN)
        Dim objEncabezado As tblDetalle2FormulariosBcoRepublica_DIAN = New tblDetalle2FormulariosBcoRepublica_DIAN
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefecto()
        Try
            Dim objRespuesta As InvokeResult(Of tblDetalle2FormulariosBcoRepublica_DIAN)
            If IDRegistroEncabezado IsNot Nothing Then

                objRespuesta = Await mdcProxy.Detalle2FormularioDIAN_DefectoAsync(IDRegistroEncabezado.intNumeroDecl, IDRegistroEncabezado.dtmFecha, Program.Usuario)
    ...
    Private Async Sub ConsultarInformacionEncabezado()
        Try
            ...
            ListaEncabezadoEliminar = New List(Of CPX_tblDetalleFormulario2DIAN)
        Catch ex As Exception
    ...
    Private Async Function ConsultarEncabezado(Optional ByVal pstrOpcion As String = "", Optional ByVal pintIDRegistro As Integer = 0) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblDetalleFormulario2DIAN)) = Nothing

            ErrorForma = String.Empty
            If IDRegistroEncabezado IsNot Nothing Then

                If pstrOpcion = "ID" Then
                    objRespuesta = Await mdcProxy.Detalle2FormularioDIAN_ConsultarAsync(pintIDRegistro, IDRegistroEncabezado.intNumeroDecl, IDRegistroEncabezado.dtmFecha, Program.Usuario)
                Else
                    objRespuesta = Await mdcProxy.Detalle2FormularioDIAN_ConsultarAsync(0, IDRegistroEncabezado.intNumeroDecl, IDRegistroEncabezado.dtmFecha, Program.Usuario)
                End If
    ...
    Public Sub ConsultarEncabezadoEdicion()
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                Dim objEncabezadoEdicion As New tblDetalle2FormulariosBcoRepublica_DIAN
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal pintID As Integer) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of tblDetalle2FormulariosBcoRepublica_DIAN) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.Detalle2FormularioDIAN_ConsultarIDAsync(pintID, IDRegistroEncabezado.intNumeroDecl, IDRegistroEncabezado.dtmFecha, Program.Usuario)
            ...
            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    ...
                    If Not IsNothing(objListaProductos) Then
                        Dim objListaProductosCombo As New List(Of BusquedaNumeralesCambiariosDIAN)
                        For Each li In objListaProductos
                            objListaProductosCombo.Add(New BusquedaNumeralesCambiariosDIAN With {
...
#End Region
End Class
Public Class BusquedaNumeralesCambiariosDIAN
