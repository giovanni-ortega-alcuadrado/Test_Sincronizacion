...
Public Class Formulario5ViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As CPX_Formulario5INotify
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As CPX_Formulario5INotify
    ...
    Private strNombreReporte As String = "Formulario5"
...
#Region "Inicialización - REQUERIDO"
    ...
    ''' Pruebas CB       : Ricardo Barrientos Perez (Alcuadrado S.A.) - Agosto 14/2018 - Resultado Ok 
    ''' </history>
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    Public Property ListaTipoOperacion() As List(Of ProductoCombos)
        ...
        End Set
    End Property
    Private _ListaEncabezado As List(Of CPX_Formulario5)
    Public Property ListaEncabezado() As List(Of CPX_Formulario5)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of CPX_Formulario5))
    ...
    ''' </summary>
    Private _EncabezadoSeleccionado As CPX_Formulario5
    Public Property EncabezadoSeleccionado() As CPX_Formulario5
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As CPX_Formulario5)
    ...
    ''' Elemento de la lista de Registros que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoEdicionSeleccionado As CPX_Formulario5INotify
    Public Property EncabezadoEdicionSeleccionado() As CPX_Formulario5INotify
        Get
            Return _EncabezadoEdicionSeleccionado
        End Get
        Set(ByVal value As CPX_Formulario5INotify)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaFormulario5
    Public Property cb() As CamposBusquedaFormulario5
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaFormulario5)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Function ConvertirACPX_Formulario5INotify(ByRef pobjRegistro As CPX_Formulario5) As CPX_Formulario5INotify
        Dim objEncabezadoNuevo = New CPX_Formulario5INotify
        ...
        objEncabezadoNuevo.intNumeral = pobjRegistro.intNumeral
        objEncabezadoNuevo.dblValorUSD = pobjRegistro.dblValorUSD
    ...
    Public Overrides Sub NuevoRegistro()
        Try
            Dim objNvoEncabezado As New CPX_Formulario5INotify
    ...
    Public Overrides Async Sub ActualizarRegistro()
        ...
        Try
            ...
            Dim objRespuesta As InvokeResult(Of List(Of CPX_tblValidacionesGenerales)) = Await mdcProxy.Formulario5_ActualizarAsync(_EncabezadoEdicionSeleccionado.intNumeroDecl,
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Function ConsultarEncabezado(ByVal pstrOpcion As String,
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of List(Of CPX_Formulario5)) = Nothing
            ...
            If pstrOpcion = "FILTRAR" Then
                ...
                objRespuesta = Await mdcProxy.Formulario5_FiltrarAsync(pstrFiltro, Program.Usuario)
            ElseIf pstrOpcion = "ID" Then
                objRespuesta = Await mdcProxy.Formulario5_ConsultarAsync(plngNumeroDecl, pdtmFecha, pstrNombre, pintOrden, pstrNumeroIdentificacion, Program.Usuario)
            Else
                objRespuesta = Await mdcProxy.Formulario5_ConsultarAsync(plngNumeroDecl, pdtmFecha, pstrNombre, pintOrden, pstrNumeroIdentificacion, Program.Usuario)
    ...
    Private Async Function ConsultarEncabezadoEdicion(ByVal plngNumeroDecl As Integer, ByVal pdtmFecha As Date) As Task(Of Boolean)
        ...
        Try
            IsBusy = True
            Dim objRespuesta As InvokeResult(Of CPX_Formulario5) = Nothing

            ErrorForma = String.Empty

            objRespuesta = Await mdcProxy.Formulario5_IDAsync(plngNumeroDecl, pdtmFecha, Program.Usuario)

            If Not IsNothing(objRespuesta) Then
                If Not IsNothing(objRespuesta.Value) Then
                    EncabezadoEdicionSeleccionado = ConvertirACPX_Formulario5INotify(objRespuesta.Value)
                Else
                    A2Utilidades.Mensajes.mostrarMensaje(DiccionarioMensajesPantalla("GENERICO_ERRORREGISTRO"), Program.TituloSistema, wppMensajes.TiposMensaje.Errores)
                End If
            Else
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaFormulario5
            objCB.ID = 0
            objCB.Fecha = Nothing
            cb = objCB
    ...
    ''' <history>
    ''' </history>
    Private Sub ObtenerRegistroAnterior(ByVal pobjRegistro As CPX_Formulario5INotify, ByRef pobjRegistroSalvar As CPX_Formulario5INotify)
        Dim objEncabezado As CPX_Formulario5INotify = New CPX_Formulario5INotify
...
'' 
'' </history>
Public Class CamposBusquedaFormulario5
