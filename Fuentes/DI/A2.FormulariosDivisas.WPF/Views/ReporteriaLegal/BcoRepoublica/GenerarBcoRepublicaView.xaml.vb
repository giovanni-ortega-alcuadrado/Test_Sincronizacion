...
Public Class GenerarBcoRepublicaView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As GenerarBcoRepublicaViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        mobjVM = New GenerarBcoRepublicaViewModel
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, GenerarBcoRepublicaViewModel)
