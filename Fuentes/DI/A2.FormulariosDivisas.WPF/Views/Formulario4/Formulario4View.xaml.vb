...
Public Class Formulario4View
    Inherits UserControl
#Region "Variables"

    Private mobjVM As Formulario4ViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        mobjVM = New Formulario4ViewModel
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, Formulario4ViewModel)
...
#Region "Eventos de controles"
    ...
    Private Sub DataFormDataField_GotFocus(sender As Object, e As RoutedEventArgs)
