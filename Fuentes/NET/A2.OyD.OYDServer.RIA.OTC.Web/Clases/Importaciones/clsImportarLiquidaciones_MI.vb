...
Err_Reportar:
        ...
        Try
            ...
            Do While objReader.Peek() <> -1
                ...
                If Not strdatos = String.Empty Then
                    If FirmaExtrangera Then
                        If pEstrActual = True Then
                            ExtraerDatosColombiaNuevoFirmaExtrangera(intCual, strdatos, pDateDesde, pDateHasta)
                        Else
                            ExtraerDatosColombiaNuevoFirmaExtrangera(intCual, strdatos, pDateDesde, pDateHasta)
                        End If
                        intCual = intCual + 1
    ...
    Private Sub ExtraerDatosColombiaNuevoFirmaExtrangera(ByVal pintCual As Integer, ByVal pstrDatos As String, ByVal pDateDesde As DateTime, ByVal pDateHasta As DateTime)
        '/******************************************************************************************
        '/* INICIO DOCUMENTO
        ...
        Dim intEncabezado As System.Nullable(Of Integer), _
            strIndicadorEconomico As String, _
            dblPuntosIndicador As System.Nullable(Of Double), _
            logVendido As Boolean, _
            dtmVendido As String, _
            dtmActualizacion As String, _
            dblIvaComision As System.Nullable(Of Double), _
            strIDBaseDias As String, _
             lngID As System.Nullable(Of Integer), _
             lngParcial As System.Nullable(Of Integer), _
             strTipo As String, _
             strClaseOrden As String, _
             strIDEspecie As String, _
             ...
             strTipoOperacion As String = String.Empty, _
             lngDiasContado As Integer = 0, _
             logOrdinaria As System.Nullable(Of Boolean) = True, _
             strObjetoOrdenExtraOrdinaria As String = String.Empty, _
             lngNumPadre As Integer = 0, _
             lngParcialPadre As Integer = 0, _
             dtmOperacionPadre As System.Nullable(Of Date), _
             ...
             strConstanciaEnajenacion As String = String.Empty, _
             strRepoTitulo As String, _
             strUsuario As String = String.Empty, _
             dblServBolsaVble As System.Nullable(Of Double), _
             dblServBolsaFijo As System.Nullable(Of Double), _
             strTraslado As String = String.Empty, _
             curValorIva As System.Nullable(Of Double), _
        ...
        If strClaseOrden = "A" Then
            Call CrearOrden(strTipo, strRepoTitulo, strCodigoCliente, strCodigoOrdenante, curComision, _
                            strUBICACIONTITULO, strIDEspecie, dblCantidad, curPrecio, CDate(dtmCumplimiento), strCuentaFondo, _
