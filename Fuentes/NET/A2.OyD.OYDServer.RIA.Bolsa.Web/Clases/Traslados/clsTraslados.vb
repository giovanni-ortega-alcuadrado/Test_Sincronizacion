...
Public Class clsTraslados
    ...
    Public Function FnTrasladarLiquidaciones(pTipoMercado As String, pstrUsuario As String, pintSucursal As Integer, pstrContacto As String, plogActualizarCostos As Boolean) As List(Of A2.OyD.OYDServer.RIA.Web.OyDBolsa.tblRespuestaValidacionesTraslado)

        Dim retorno As List(Of A2.OyD.OYDServer.RIA.Web.OyDBolsa.tblRespuestaValidacionesTraslado)
        Try
            Dim obj As A2.OyD.OYDServer.RIA.Web.OyDBolsa.tblRespuestaValidacionesTraslado
            Reportar(MSGERROR_INICIO_TRASLADO)

            If (pstrContacto).Trim() = "" Then
                Reportar("No hay nombre de contacto para el archivo de control")
                obj.Mensaje = gStringErrores.ToString()
                retorno.Add(obj)
                Return retorno
                Exit Function
            End If
            ...
            retorno = PrEjecutarTraslado(pTipoMercado, pstrUsuario, pintSucursal, plogActualizarCostos) 'JAG 20140311 se agrega el envio del parametro plogActualizarCostos
    ...
    Public Function FnTrasladarLiquidaciones_OF(pTipoMercado As String, pstrUsuario As String, pintSucursal As Integer, pstrContacto As String, plogActualizarCostos As Boolean) As String
...
ErrorControlado:
    ...
    '    Dim ret = L2SDC.spTrasladarLiquidaciones(pstrClase, pstrUsuario, plngIdSucursal, DemeInfoSesion(pstrUsuario, "PrEjecutarTraslado"), 0, plogActualizarCostos) 'JAG 20140311 se agrega el envio del parametro plogActualizarCostos
    '    Reportar("Registros trasladados: [" & ret & "].")

    'End Sub

    Public Function PrEjecutarTraslado(pstrClase As String, pstrUsuario As String, plngIdSucursal As Integer, plogActualizarCostos As Boolean) As List(Of A2.OyD.OYDServer.RIA.Web.OyDBolsa.tblRespuestaValidacionesTraslado)
        Try
            Dim ret = L2SDC.spTrasladarLiquidaciones(pstrClase, pstrUsuario, plngIdSucursal, DemeInfoSesion(pstrUsuario, "PrEjecutarTraslado"), 0, plogActualizarCostos).ToList
            Return ret
        Catch ex As Exception
