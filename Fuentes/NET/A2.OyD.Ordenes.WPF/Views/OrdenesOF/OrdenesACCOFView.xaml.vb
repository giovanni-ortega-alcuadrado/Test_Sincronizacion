...
Partial Public Class OrdenesACCOFView
...
#Region "Inicializaciones"
    ...
    Public Sub New()
        ...
        Dim pintClaseOrden As OrdenesOFViewModel.ClasesOrden = OrdenesOFViewModel.ClasesOrden.A
...
#End Region
    ...
    Private Sub PrecioInferior_LostFocus(sender As Object, e As RoutedEventArgs)
        If mobjVM.OrdenOFSelected.PrecioInferior > mobjVM.OrdenOFSelected.Precio And mobjVM.OrdenOFSelected.Precio > 0 Then
            mostrarMensaje("Ingrese un precio inferior menor o igual al precio.", Program.TituloSistema, A2Utilidades.wppMensajes.TiposMensaje.Advertencia)
            mobjVM.OrdenOFSelected.PrecioInferior = mobjVM.OrdenOFSelected.Precio
        End If
    End Sub

    Private Sub Precio_LostFocus(sender As Object, e As RoutedEventArgs)
        If mobjVM.OrdenOFSelected.Precio < mobjVM.OrdenOFSelected.PrecioInferior And mobjVM.OrdenOFSelected.PrecioInferior > 0 Then
            mostrarMensaje("Ingrese un precio mayor o igual al precio inferior.", Program.TituloSistema, A2Utilidades.wppMensajes.TiposMensaje.Advertencia)
            mobjVM.OrdenOFSelected.Precio = mobjVM.OrdenOFSelected.PrecioInferior
        End If
    End Sub
