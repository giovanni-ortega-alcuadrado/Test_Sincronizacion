...
Public Class ModalOrdenesAcciones
    Dim objFormulario As OrdenesACCView
    Dim objDatosModalOrdenesAcciones As Datos_ModalOrdenesAcciones
    Public intNroOrden As Integer
    Public strTipoOrden As String
    Public strTipoOperacion As String

    Public Sub New(ByVal pobjDatosModalOrdenesAcciones As Datos_ModalOrdenesAcciones)
        Try
    ...
    Private Sub ModalOrdenesAcciones_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        Try
            objFormulario = New OrdenesACCView(True)
...
Public Class Datos_ModalOrdenesAcciones
