...
Partial Public Class OrdenesACCView
...
#Region "Inicializaciones"
    ...
    Private Sub IniciarFormulario(ByVal plogInicializarModal As Boolean)
        'Cambiar estilos por OyD PLUS Jorge Andres Bedoya 20150616
        'CambiarEstilosAplicacion.ObtenerEstilos(Me, CambiarEstilosAplicacion.OpcionEstilo.OYDPLUS)

        Dim pintClaseOrden As OrdenesViewModel.ClasesOrden = OrdenesViewModel.ClasesOrden.A
...
#Region "Eventos controles"
    ...
    Private Sub txtNroOrdenBusqueda_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Input.KeyEventArgs)
        Try
            ...
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema con el control de número de orden en la búsqueda", Me.Name, "txtNroOrdenBusqueda_KeyDown", Program.TituloSistema, Program.Maquina, ex, Program.RutaServicioLog)
        End Try
    End Sub
    ...
    ''' <summary>
    ''' Al hacer clic con el Enter se lanza la actualización de Órdenes
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>SLB20130918</remarks>
    ...
    ''' <summary>
    ''' Al hacer clic con el Enter se lanza la consulta de Órdenes
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    ''' <remarks>SLB20130918</remarks>
            ...
            If Not IsNothing(pobjComitente) Then
                Select Case pstrClaseControl.ToLower()
                    ...
                    Case "idordenantebuscar"
                        ...
                        Me.mobjVM.CambioItem("cb")
                    Case "idcomitenteadr"
                        Me.mobjVM.OrdenSelected.IDComitenteADR = pobjComitente.CodigoOYD
                        Me.mobjVM.OrdenSelected.NombreComitenteADR = pobjComitente.Nombre
                        Me.mobjVM.OrdenSelected.TipoIdentificacionADR = pobjComitente.TipoIdentificacion
                        Me.mobjVM.OrdenSelected.NroDocumentoADR = pobjComitente.NroDocumento
        ...
        Try
            If Not IsNothing(Me.mobjVM) Then
                If Not String.IsNullOrEmpty(pstrNemotecnico) Then
                    ...
                    ' Me.mobjVM.actualizarNemotecnicoOrden(objEspecie, False)'Se comenta esta linea porque esta daño el seteo de las propiedades despues de buscar la especie GVB20180531
                End If
            End If
        Catch ex As Exception
...
#Region "Eventos para el Buscador de Comisiones"
    ...
    Private Sub BuscadorIdComision_GotFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs)
        Try
            ...
            'Dim obj As A2ComunesControl.BuscadorGenericoListaButon
            'obj = dgComisionesOrden.Columns.Item(5).GetCellContent(dgComisionesOrden.SelectedItem)
            'obj.Agrupamiento = Format(CType(Me.DataContext, OrdenesViewModel).OrdenSelected.FechaEmision, "MM/dd/yyyy") & "," & _
