...
Partial Public Class Aplazamiento_En_Serie_MI
    Inherits Window
    Implements INotifyPropertyChanged
    Dim Fechaliquidacion As DateTime

    Public Sub New(ByVal strTipoAplazamiento As String, ByVal dtmliquidacion As DateTime, ByVal dtmtitulo As DateTime)
        InitializeComponent()
 ...
 & " a la fecha de liquidación(" & Fechaliquidacion.Date.ToShortDateString & ")", Program.TituloSistema, A2Utilidades.wppMensajes.TiposMensaje.Advertencia)
            Exit Sub
        End If
