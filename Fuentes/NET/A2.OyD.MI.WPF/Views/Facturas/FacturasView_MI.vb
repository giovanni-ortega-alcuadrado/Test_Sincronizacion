...
Partial Public Class FacturasView_MI
    Inherits UserControl

    Public Sub New()
        Me.DataContext = New FacturasViewModel_MI
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
        cm.DF = df
        CType(Me.DataContext, FacturasViewModel_MI).NombreColeccionDetalle = Me.ToString
    End Sub
    ...
    Private Sub BuscadorGenerico_finalizoBusquedaComitente(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorClientes)
        If Not IsNothing(pobjItem) Then
            Select Case pstrClaseControl.ToLower
                Case "idcomitente"
                    CType(Me.DataContext, FacturasViewModel_MI).cb.Comitente = pobjItem.IdComitente
                    CType(Me.DataContext, FacturasViewModel_MI).cb.NombreComitente = pobjItem.Nombre
            End Select
        End If
    End Sub
