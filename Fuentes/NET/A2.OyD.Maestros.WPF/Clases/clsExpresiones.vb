...
Public Class clsExpresiones
    ...
    Private Const STR_EXPRESION_NUMEROS_ESPACIOS_GIONES As String = "^[0-9- ]*$"
    Private Const STR_EXPRESIONREEMPLAZAR_NUMEROS_ESPACIOS_GIONES As String = "!*[0-9- ]"
    ...
    Public Shared Function ValidarCaracteresEnCadena(ByVal pstrValor As String, ByVal pobjExpresion As TipoExpresion) As TextoFormateado
        ...
        ElseIf pobjExpresion = TipoExpresion.CuentaBancaria Then
            strExpresion = STR_EXPRESION_NUMEROS_ESPACIOS_GIONES
            strExpresionReemplazar = STR_EXPRESIONREEMPLAZAR_NUMEROS_ESPACIOS_GIONES
        Else
            strExpresion = STR_EXPRESION_CADENACARACTERES
            strExpresionReemplazar = STR_EXPRESIONREEMPLAZAR_CADENACARACTERES
        End If
