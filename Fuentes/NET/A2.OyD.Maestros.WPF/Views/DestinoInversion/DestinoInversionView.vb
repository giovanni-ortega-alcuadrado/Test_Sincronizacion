...
Partial Public Class DestinoInversionView
    Inherits UserControl

    Public Sub New()
        Me.DataContext = New DestinoInversionViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Sub txtClaseEspecie_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Input.KeyEventArgs)
        If Not ((e.Key > 47 And e.Key < 58) Or (e.Key > 95 And e.Key < 106) Or e.Key = 9) Then
            e.Handled = True
        End If
    End Sub
