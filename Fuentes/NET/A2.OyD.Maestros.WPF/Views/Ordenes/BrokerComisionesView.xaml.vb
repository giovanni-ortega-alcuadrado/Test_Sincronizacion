...
Partial Public Class BrokerComisionesView
    Inherits UserControl

    Public Sub New()
        Me.DataContext = New BrokerComisionesViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
        cm.DF = df
        CType(Me.DataContext, BrokerComisionesViewModel).NombreColeccionDetalle = Me.ToString
    End Sub
