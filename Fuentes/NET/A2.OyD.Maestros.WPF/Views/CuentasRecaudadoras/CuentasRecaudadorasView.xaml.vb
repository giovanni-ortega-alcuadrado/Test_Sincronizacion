...
Partial Public Class CuentasRecaudadorasView
    Inherits UserControl

#Region "Variables"
    Private mobjVM As TiposCuentasRecaudadorasViewModel
...
#End Region
    Public Sub New()
        Me.DataContext = New TiposCuentasRecaudadorasViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, TiposCuentasRecaudadorasViewModel)
            mobjVM.NombreView = Me.ToString
            mobjVM.inicializar()
        End If
    End Sub

    Private Sub CuentasRecaudadorasView_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        cm.GridTransicion = grdGridForma
cm.GridViewRegistros = datapager1
        cm.DF = df
        CType(Me.DataContext, TiposCuentasRecaudadorasViewModel).NombreColeccionDetalle = Me.ToString
    End Sub
