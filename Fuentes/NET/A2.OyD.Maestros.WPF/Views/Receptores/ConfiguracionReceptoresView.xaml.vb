...
Partial Public Class ConfiguracionReceptoresView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases ConfiguracionReceptoresView y ConfiguracionReceptoresViewModel
    ''' Pantalla Maestro de configuración de receptores (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Santiago Upegui G (Alcuadrado S.A.) - 16 de Julio 2015</remarks>
    ''' 
#Region "Variables"

    Private mobjVM As ConfiguracionReceptoresViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New ConfiguracionReceptoresViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ConfiguracionReceptoresViewModel)
