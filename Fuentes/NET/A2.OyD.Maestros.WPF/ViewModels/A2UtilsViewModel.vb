...
#End If
    ...
    Public Sub inicializar(Optional ByVal pstrClaseCombos As String = "", Optional ByVal pstrDicCombosEspecificos As String = "", Optional ByVal logRecargaRecursos As Boolean = False)
