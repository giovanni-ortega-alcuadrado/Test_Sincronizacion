...
Public Class clsTraslados_MI

    'Private L2SDC As New OyDBolsaDatacontext
    Private L2SDC As New OyDMILADatacontext
    ...
    Public Function FnTrasladarLiquidaciones_MI(ByVal pTipoMercado As String, ByVal pstrUsuario As String, ByVal pintSucursal As Integer, ByVal pstrContacto As String) As String
        ...
        Try
            ...
            Call PrEjecutarTraslado_MI(pTipoMercado, pstrUsuario, pintSucursal)
    ...
    Friend Sub EscribirArchivoParametrosNotasPortafolio(ByVal pstrNombreContacto As String)
...
ErrorControlado:
    ...
    Private Sub PrEjecutarTraslado_MI(ByVal pstrClase As String, ByVal pstrUsuario As String, ByVal plngIdSucursal As Integer)

        Dim ret = L2SDC.spTrasladarLiquidaciones_MI(pstrClase, pstrUsuario, plngIdSucursal, DemeInfoSesion(pstrUsuario, "PrEjecutarTraslado"), 0)
