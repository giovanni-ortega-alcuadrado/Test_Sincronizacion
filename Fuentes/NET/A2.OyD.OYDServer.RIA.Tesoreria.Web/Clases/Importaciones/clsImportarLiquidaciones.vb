...
#End Region
    ...
    Private Function VerificarOrden(ByVal pstrOrden As String,
                                    ...
                                    ByRef pstrEstadoAprobCliente As String) As Boolean
        VerificarOrden = True
    ...
    Private Function VerificarSiEspecieExiste(ByVal plngIDBolsa As Long, _
                                      ByRef pstrIdEspecie As String, _
    ...
    Private Function ExisteLiquidacion(ByVal pdtmLiquidacion As Date, ByVal plngIDLiq As Long, ByVal plngParcial As Long, _
    ...
    Private Sub Validar_Campo_a_Campo(ByVal pdtmLiquidacion As Date, ByVal plngIDLiq As Long, ByVal plngParcial As Long, _
        ...
        Dim ret As List(Of usp_Bolsa_ConsultarOperacionExistente_VALIDARResult) = L2SDC.uspOyDNet_Importaciones_ConsultarOperacionExistente(CDate(pdtmLiquidacion), CType(plngIDLiq, Integer?), CType(plngParcial, Integer?), pstrTipo, _
...
Err_Reportar:
    ...
    Public Function EvaluarLineaColombia(ByVal pNombreEncabezado As String, ByVal pEstrActual As Boolean, ByVal pDateDesde As DateTime, ByVal pDateHasta As DateTime, ByVal pstrUsuario As String) As String
        '     '/******************************************************************************************
        '     '/* INICIO DOCUMENTO
    ...
    Private Sub ExtraerDatosColombiaNuevo(ByVal pintCual As Integer, ByVal pstrDatos As String, ByVal pDateDesde As DateTime, ByVal pDateHasta As DateTime, ByVal pstrUsuario As String)
        '/******************************************************************************************
        '/* INICIO DOCUMENTO
        ...
        Try
            ...
            Dim lngID As System.Nullable(Of Integer), _
                 ...
                 lngIDComisionistaOtraPlaza As Integer, _
                 lngIDCiudadOtraPlaza As System.Nullable(Of Integer), _
                 dblTasaEfectiva As System.Nullable(Of Double), _
                 ...
                 lngPlazoOriginal As System.Nullable(Of Integer), _
                 ...
                 dblValorEntregaContraPago As System.Nullable(Of Double), _
                 strAquienSeEnviaRetencion As System.Nullable(Of Char), _
                 strBaseDias As System.Nullable(Of Char), _
                 ...
                 dblPorcIvaComision As System.Nullable(Of Double), _
            ...
            If strVencimiento = "" Then
                ...
                Exit Sub
            ElseIf Not IsDate(dtmLiquidacion) Then
            ...
            If IsNumeric(strOrden) And Len(Trim(strOrden)) = 10 Then
                ...
                If strTipoDeOferta = "2" Or ((strTipoDeOferta = "R" Or strTipoDeOferta = "A") And (strTipo = "R" Or strTipo = "S")) Then
                ...
                ExisteOrden = VerificarOrden(strOrden, strTipo, strClaseOrden, CStr(strIDEspecie), strNroDocumento, lngIDComitente, lngIDOrdenante, logOrdinaria, strObjeto, strDepositoOrden, strEstadoAprobOrden, strEstadoAprobCliente)
                ...
                Else 'Si existe la orden pero se debe validar que si tenga el mismo deposito de la liquidacion Jorge Arango 2009/11/03
                    ...
                    If Not IsNothing(strEstadoAprobCliente) Then
                        ...
                        If Mid(strEstadoAprobCliente, 1, 2) = ESTADO_7_RETIRADO_PENDIENTE_POR_APROBACION Or Mid(strEstadoAprobCliente, 1, 2) = ESTADO_8_APROBADO_LUEGO_DE_RETIRO Or _
            ...
            If strTipo = "R" And dblPatrimonioTecnicoFirma > 0 And ExisteOrden Then
                Call dblTotalValorFuturoRepo(fmtCodigo(lngIDComitente), _
                                             dtmCumplimiento, _
                                             curTotalLiq, _
                                             dblTotalRecompras, _
                                             dblTotalFuturoOrdenesRepos, _
                                             dblTotalRecomprasImportadas, _
                                             dblPatrimonioTecnicoFirma, _
                                             dblSuperaPatrimonioTecnico)
                If dblSuperaPatrimonioTecnico > 0 Then
                    dblTotalFuturoRepo = dblTotalRecompras + _
                                         dblTotalFuturoOrdenesRepos + _
                                         dblTotalRecomprasImportadas + _
                                         curTotalLiq
                    lngOrden = 0
            ...
            Dim ret = L2SDC.sp_GrabarLiquidacion(lngID, _
                                                    lngParcial, _
                                                    strTipo, _
                                                    strClaseOrden, _
                                                    strIDEspecie, _
                                                    ...
                                                    DemeInfoSesion("ExtraerDatosColombiaNuevo"), _
    ...
    Private Sub ExtraerDatosColombiaNuevoCompensacion(ByVal pintCual As Integer, ByVal pstrDatos As String, ByVal pDateDesde As DateTime, ByVal pDateHasta As DateTime, ByVal pstrUsuario As String, ByVal pbAcciones As Boolean, ByVal pbCrediticio As Boolean, ByVal pbAmbos As Boolean)
        ...
        Try
            ...
            Dim lngID As System.Nullable(Of Integer), _
                 ...
                 dtmOperacionPadre As System.Nullable(Of Date), _
                 lngDiasTramo As System.Nullable(Of Integer) = 0, _
                 logVendido As System.Nullable(Of Boolean) = False, _
                 dtmVendido As System.Nullable(Of Date) = Nothing, _
                 dblValorTraslado As System.Nullable(Of Double), _
                 dblValorBrutoCompraVencida As System.Nullable(Of Double) = 0, _
                 strAutoRetenedor As String = String.Empty, _
                 strSujeto As String = String.Empty, _
            ...
            Dim ret = L2SDC.uspOyDNet_Importaciones_GrabarLiquidacionesCompensacion(lngID, _
                                                    lngParcial, _
                                                    strTipo, _
                                                    strClaseOrden, _
                                                    strIDEspecie, _
                                                    ...
                                                    strGeneraConstancia, _
                                                    strCodigoIntermediario, _
                                                    DemeInfoSesion("ExtraerDatosColombiaNuevoCompensacion"), _
                                                    ClsConstantes.GINT_ErrorPersonalizado)
        ...
        Try
            ...
            Do While objReader.Peek <> -1
                ...
                If Not strlinea = String.Empty Then
                    Dim ret = L2SDC.usp_InsertarServicioBolsa(strdatos(0), _
                    strdatos(1), _
                    strdatos(2), _
                    strdatos(3), _
                    strdatos(4), _
                    CDate(Mid(strdatos(5), 1, 4) & "/" & Mid(strdatos(5), 5, 2) & "/" & Mid(strdatos(5), 7, 2)), _
                    CDate(Mid(strdatos(6), 1, 4) & "/" & Mid(strdatos(6), 5, 2) & "/" & Mid(strdatos(6), 7, 2)), _
                    strdatos(7), _
                    CDbl(Trim(strdatos(8).Replace(".", "").Replace(",", "."))), _
                    CDbl(Trim(strdatos(9).Replace(".", "").Replace(",", "."))), _
                    CDbl(Trim(strdatos(10).Replace(".", "").Replace(",", "."))), _
                    CDbl(Trim(strdatos(11).Replace(".", "").Replace(",", "."))), _
                    strusuario)
                End If
            Loop
...
#Region "Importar Precios Especies"
    ...
    Public Function EvaluarPreciosEspecie(ByVal pNombreEncabezado As String, ByVal pDateDesde As DateTime, ByVal pstrUsuario As String) As String
        ...
        Try
            ...
            If RegBuenos > 0 Then
                L2SDC.uspOyDNet_Importaciones_MovPreciosEspecies("", pDateDesde, 0, "V", pstrUsuario, DemeInfoSesion("EvaluarPreciosEspecie"), _
                                                                     ClsConstantes.GINT_ErrorPersonalizado)
            End If
        ...
        Try
            ...
            If Trim(strIdEspecie) <> String.Empty Then
                If UCase(strTipo) = "E" Or UCase(strTipo) = "T" Then
                    ...
                    L2SDC.uspOyDNet_Importaciones_MovPreciosEspecies(strIdEspecie, dtmCierre, CDec(strPrecio), strTipo, pstrUsuario, DemeInfoSesion("ExtraerDatosEspecies"), _
                                                                     ClsConstantes.GINT_ErrorPersonalizado)
