...
Partial Public Class CargaMasivaTeImportar_EgresosView
...
#Region "Eventos"
    ...
    Private Sub Button_Click_BuscadorListaConceptos(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs)
        Try
            If Not IsNothing(objVMTesoreria.ImportacionDetalleTeSelected) Then
                Dim objBuscadorConceptos As New A2ComunesControl.BuscarConceptoTesoreria("CE",
    ...
    Private Sub Banco_MouseLeftButtonDown(sender As Object, e As MouseButtonEventArgs)
        Try
            If objVMTesoreria.DiccionarioEdicionCampos("IdBanco") Then
                ctlBuscadorBanco.AbrirBuscador()
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Ocurrio un error al intentar abrir el buscador.", Me.ToString, "Banco_MouseLeftButtonDown", Program.TituloSistema, Program.Maquina, ex, Program.RutaServicioLog)
        End Try
    End Sub
...
#Region "Buscadores Tesoreria Comprobantes Egreso"
    ...
    Private Sub BuscadorGenerico_finalizoBusquedaNITS(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorGenerico)
        ...
        End If
    End Sub
    Private Sub BuscadorGenerico_finalizoBusquedaFE(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorGenerico)
        If Not IsNothing(pobjItem) Then
            objVMTesoreria.ImportacionDetalleTeSelected.FormaEntrega = pobjItem.IdItem
            objVMTesoreria.ImportacionDetalleTeSelected.DescripcionFormaEntrega = pobjItem.Nombre
        End If
    End Sub
    Private Sub BuscadorGenerico_finalizoBusquedaBene(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorGenerico)
        If Not IsNothing(pobjItem) Then
            objVMTesoreria.ImportacionDetalleTeSelected.TipoIdentBeneficiario = pobjItem.IdItem
            objVMTesoreria.ImportacionDetalleTeSelected.DescripcionTipoIdentBeneficiario = pobjItem.CodItem
        End If
    End Sub
    Private Sub BuscadorGenerico_finalizoBusquedaBD(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorGenerico)
        If Not IsNothing(pobjItem) Then
            objVMTesoreria.ImportacionDetalleTeSelected.BancoDestino = pobjItem.IdItem
            objVMTesoreria.ImportacionDetalleTeSelected.NombreBancoDestino = pobjItem.Descripcion
        End If
    End Sub
    Private Sub BuscadorGenerico_finalizoBusquedaTC(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorGenerico)
        If Not IsNothing(pobjItem) Then
            objVMTesoreria.ImportacionDetalleTeSelected.TipoIdTitular = pobjItem.IdItem
            objVMTesoreria.ImportacionDetalleTeSelected.DescripcionTipoCuenta = pobjItem.Nombre
        End If
    End Sub
    Private Sub BuscadorGenerico_finalizoBusquedaTT(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorGenerico)
        If Not IsNothing(pobjItem) Then
            objVMTesoreria.ImportacionDetalleTeSelected.TipoCuenta = pobjItem.IdItem
            objVMTesoreria.ImportacionDetalleTeSelected.DescripcionTipoIdTitular = pobjItem.Nombre
        End If
    End Sub
