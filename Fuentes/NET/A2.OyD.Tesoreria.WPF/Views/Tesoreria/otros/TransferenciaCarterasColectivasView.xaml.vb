...
Partial Public Class TransferenciaCarterasColectivasView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As TransferenciasCarterasColectivasViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Try
            Me.DataContext = New TransferenciasCarterasColectivasViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, TransferenciasCarterasColectivasViewModel)
