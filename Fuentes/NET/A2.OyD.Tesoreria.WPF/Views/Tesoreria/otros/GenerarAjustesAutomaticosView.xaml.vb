...
Partial Public Class GenerarAjustesAutomaticosView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As GenerarAjustesAutomaticosViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Try
            Me.DataContext = New GenerarAjustesAutomaticosViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, GenerarAjustesAutomaticosViewModel)
...
#End Region
    ...
    Private Sub btnAyuda_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.Ayuda()
    End Sub

    Private Sub mostrarMensaje(p1 As String, p2 As String, tiposMensaje As A2Utilidades.wppMensajes.TiposMensaje)
