...
Partial Public Class TransaccionesCarterasColectivasView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As TransaccionesCarterasColectivasViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Try
            Me.DataContext = New TransaccionesCarterasColectivasViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, TransaccionesCarterasColectivasViewModel)
