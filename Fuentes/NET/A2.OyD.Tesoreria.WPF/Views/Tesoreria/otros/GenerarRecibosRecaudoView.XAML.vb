...
Partial Public Class GenerarRecibosRecaudoView
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Try
            Me.DataContext = New GenerarRecibosRecaudoViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, GenerarRecibosRecaudoViewModel)
...
#End Region
    ...
    Private Sub btnExportarRC_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.Exportar()
    End Sub

    Private Sub btnProcesarTraslado_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.Procesar()
    End Sub
