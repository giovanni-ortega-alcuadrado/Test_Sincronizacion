...
Partial Public Class GenerarComprobantesEgresos_IntermediaView
    Inherits UserControl


    ''' <summary>
    ''' Eventos creados para la comunicación con las clases GenerarRecibosCaja_IntermediaView y GenerarComprobantesEgresos_IntermediaViewModel
    ''' Pantalla Procesar Portafolio (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Jorge Peña (Alcuadrado S.A.) - 21 de Febrero 2014</remarks>
#Region "Variables"

    Private mobjVM As GenerarComprobantesEgresos_IntermediaViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Try
            Me.DataContext = New GenerarComprobantesEgresos_IntermediaViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, GenerarComprobantesEgresos_IntermediaViewModel)
...
#Region "Manejadores error"
    ...
    Private Sub GenerarCE_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.GenerarCE()
    End Sub
