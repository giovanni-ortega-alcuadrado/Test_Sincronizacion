...
Partial Public Class CarterasCuentasActivasConfianzaView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As CarterasCuentasActivasConfianzaViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Try
            Me.DataContext = New CarterasCuentasActivasConfianzaViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, CarterasCuentasActivasConfianzaViewModel)
...
#End Region
    ...
    Private Sub btnAyuda_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
        mobjVM.Ayuda()
    End Sub
