...
Partial Public Class GenerarCE_CarteraColectivasView
    Inherits UserControl


#Region "Variables"

    Private mobjVM As GenerarCE_CarteraColectivasViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New GenerarCE_CarteraColectivasViewModel
InitializeComponent()
    End Sub
    ...
    Private Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, GenerarCE_CarteraColectivasViewModel)
