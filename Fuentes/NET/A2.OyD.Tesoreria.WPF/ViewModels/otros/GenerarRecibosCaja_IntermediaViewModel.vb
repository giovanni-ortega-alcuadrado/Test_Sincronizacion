...
Public Class GenerarRecibosCaja_IntermediaViewModel
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private WithEvents _ListaEncabezado As List(Of GenerarRCIntermedia)
    Public Property ListaDetalle() As List(Of GenerarRCIntermedia)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of GenerarRCIntermedia))
    ...
    ''' </summary>
    Private WithEvents _DetalleSeleccionado As GenerarRCIntermedia
    Public Property DetalleSeleccionado() As GenerarRCIntermedia
        Get
            Return _DetalleSeleccionado
        End Get
        Set(ByVal value As GenerarRCIntermedia)
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Async Sub ConfirmarTotalmenteGenerarRC(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            If Not IsNothing(ListaDetalle) Then
                ...
                objRet = Await mdcProxy.Load(mdcProxy.GenerarRC_Intermedia_GenerarSyncQuery(intSucursal, Date.Now, xmlCompleto, Program.Usuario, Program.Maquina, Program.HashConexion)).AsTask()
    ...
    Public Async Function ConsultarDocumentos() As Task
        Try
            ...
            objRet = Await mdcProxy.Load(mdcProxy.GenerarRC_Intermedia_ConsultarSyncQuery(intSucursal, Date.Now, Date.Now, Program.Usuario, Program.Maquina, Program.HashConexion)).AsTask()
    ...
    ''' </summary>
    Public Async Sub GenerarRC_Intermedia_Resultados()
        Try
            Dim objRet As LoadOperation(Of ResultadosGenerarRCIntermedia)
            Dim viewImportacion As New cwCargaArchivos(CType(Me, GenerarRecibosCaja_IntermediaViewModel), String.Empty, String.Empty)
            ...
            objRet = Await mdcProxy.Load(mdcProxy.GenerarRC_Intermedia_ResultadosSyncQuery(Program.Usuario, Program.Maquina, Program.HashConexion)).AsTask()
