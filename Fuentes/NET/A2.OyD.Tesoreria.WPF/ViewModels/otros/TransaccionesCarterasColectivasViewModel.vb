...
Public Class TransaccionesCarterasColectivasViewModel
    Inherits A2ControlMenu.A2ViewModel

    Implements INotifyPropertyChanged

#Region "Constantes"
    Private Const RUTAARCHIVO As String = "RUTA_CONSECUTIVO_TRANSACCIONES_CC"
    ...
    Public Function inicializar() As Boolean
        ...
        Try
            ...
            If Not Program.IsDesignMode() Then
                ...
                mdcProxyUtilidad.Load(mdcProxyUtilidad.cargarCombosEspecificosQuery("TransaccionesCarterasColectivas", Program.Usuario, Program.HashConexion), AddressOf TerminoCargarCombosEspecificos, "")
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la inicialización del objeto de negocio.", Me.ToString(), "inicializar", Application.Current.ToString(), Program.Maquina, ex)
        End Try
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private WithEvents _ListaEncabezado As List(Of TransaccionesCarterasColectivas)
    Public Property ListaEncabezado() As List(Of TransaccionesCarterasColectivas)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As List(Of TransaccionesCarterasColectivas))
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Sub Consultar()
        Try
            If Not String.IsNullOrEmpty(ConsecutivoSeleccionado) And Not String.IsNullOrEmpty(CuentaBancaria) Then
                ...
                If Not IsNothing(mdcProxy.TransaccionesCarterasColectivas) Then
                    mdcProxy.TransaccionesCarterasColectivas.Clear()
                End If

                mdcProxy.Load(mdcProxy.TransaccionesCarterasColectivas_ConsultarQuery(FechaProceso, ConsecutivoSeleccionado, CuentaBancaria, Program.Usuario, Program.Maquina, Program.HashConexion), AddressOf TerminoConsultarTransaccionesCarterasColectivas, String.Empty)
            End If
    ...
    Private Sub TerminoConsultarTransaccionesCarterasColectivas(ByVal lo As LoadOperation(Of OyDTesoreria.TransaccionesCarterasColectivas))
        Try
            If Not lo.HasError Then
                ListaEncabezado = lo.Entities.ToList
            Else
                A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se generó un problema al consultar las transacciones.", Me.ToString(), "TerminoConsultarTransaccionesCarterasColectivas", Application.Current.ToString(), Program.Maquina, lo.Error)
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se generó un problema al consultar las transacciones.", Me.ToString(), "TerminoConsultarTransaccionesCarterasColectivas", Application.Current.ToString(), Program.Maquina, ex)
        End Try
        IsBusy = False
    End Sub
    ...
    Public Sub ConfirmarTotalmenteGenerar(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            Else
                ...
                mdcProxy.Load(mdcProxy.TransaccionesCarterasColectivas_ValidarQuery(FechaProceso, ConsecutivoSeleccionado, CuentaBancaria, Program.Usuario, Program.Maquina, Program.HashConexion), AddressOf TerminoValidarDocumento, String.Empty)
            End If
            ...
            If Not lo.HasError Then
                ...
                If objListaRespuesta.Count > 0 Then
                    If objListaRespuesta.Where(Function(i) i.logDetieneIngreso).Count > 0 Then
                        ...
                        objViewImportarArchivo.Title = "Transacciones carteras colectivas"
                    ...
                    Else
                        ...
                        strNombreArchivoExportar = RetornoOperacion & intConsecutivo.ToString & FechaProceso.Year.ToString.Substring(2, 2) & IIf(FechaProceso.Month <= 9, "0" & FechaProceso.Month.ToString, FechaProceso.Month.ToString) & IIf(FechaProceso.Day <= 9, "0" & FechaProceso.Day.ToString, FechaProceso.Day.ToString)
                        ...
                        End If
                        dcProxyImportaciones.Load(dcProxyImportaciones.TransaccionesCarterasColectivas_ExportarQuery(strRutaArchivoExporta, strNombreArchivoExportar, FechaProceso, ConsecutivoSeleccionado, CuentaBancaria, "TransaccionCC", Program.Usuario, Program.Maquina, Program.HashConexion), AddressOf TerminoExportarArchivo, String.Empty)
                    End If
                Else
