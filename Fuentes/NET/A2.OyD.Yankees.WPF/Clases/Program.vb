...
Public Class Program
    ...
    Friend Const NOMBRE_PARAM_RUTA_SERV_YANKEES As String = "URLServicioYankees"
    ...
    Public Shared ReadOnly Property RutaServicioNegocio() As String
        Get
            If Application.Current.Resources.Contains(Recursos.RecursosApp.A2Consola_AppActiva.ToString()) Then
                If CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.ContainsKey(NOMBRE_PARAM_RUTA_SERV_YANKEES) Then
                    Return CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.Item(NOMBRE_PARAM_RUTA_SERV_YANKEES).ToString()
                Else
                    Return (clsRecursos.SimularURL_ServiciosRIA(NOMBRE_PARAM_RUTA_SERV_YANKEES))
                End If
            Else
                Return (clsRecursos.SimularURL_ServiciosRIA(NOMBRE_PARAM_RUTA_SERV_YANKEES))
            End If
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As YankeesDomainContext)
        If Not IsNothing(pobjProxy) Then
            If pobjProxy.FacturaYankees.HasChanges Then
                For Each li In pobjProxy.FacturaYankees
                ...
                Next
            End If
            If pobjProxy.Liquidaciones_Yankee_Admons.HasChanges Then
                For Each li In pobjProxy.Liquidaciones_Yankee_Admons
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.NotasYankees.HasChanges Then
                For Each li In pobjProxy.NotasYankees
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.NotasYankeesDetalles.HasChanges Then
                For Each li In pobjProxy.NotasYankeesDetalles
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.ReceptoresYankees.HasChanges Then
                For Each li In pobjProxy.ReceptoresYankees
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.tblDetalleLiquida_YANKEEs.HasChanges Then
                For Each li In pobjProxy.tblDetalleLiquida_YANKEEs
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.tblLiquidaciones_YANKEEs.HasChanges Then
                For Each li In pobjProxy.tblLiquidaciones_YANKEEs
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
