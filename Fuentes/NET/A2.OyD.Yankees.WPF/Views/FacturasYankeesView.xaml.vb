...
'Archivo: FacturasYankeesView.xaml.vb
'Generado el : 06/13/2011 12:09:03
'Propiedad de Alcuadrado S.A. 2010
Imports A2.OyD.OYDServer.RIA.Web

Partial Public Class FacturasYankeesView
    Inherits UserControl

    Public Sub New()
        Me.DataContext = New FacturasYankeesViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
        cm.DF = df
        CType(Me.DataContext, FacturasYankeesViewModel).NombreColeccionDetalle = Me.ToString
    End Sub
    ...
    Private Sub BuscadorGenerico_finalizoBusquedaComitente(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorClientes)
        If Not IsNothing(pobjItem) Then
            Select Case pstrClaseControl.ToLower
                Case "idcomitente"
                    CType(Me.DataContext, FacturasYankeesViewModel).cb.Comitente = pobjItem.IdComitente
                    CType(Me.DataContext, FacturasYankeesViewModel).cb.NombreComitente = pobjItem.Nombre
            End Select
        End If
    End Sub
