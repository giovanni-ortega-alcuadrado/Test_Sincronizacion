...
Partial Public Class FacturasView
    Inherits UserControl

    Public Sub New()
        Me.DataContext = New FacturasViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
        cm.DF = df
        CType(Me.DataContext, FacturasViewModel).NombreColeccionDetalle = Me.ToString
    End Sub
    ...
    Private Sub BuscadorGenerico_finalizoBusquedaComitente(ByVal pstrClaseControl As System.String, ByVal pobjItem As OYDUtilidades.BuscadorClientes)
        If Not IsNothing(pobjItem) Then
            Select Case pstrClaseControl.ToLower
                Case "idcomitente"
                    CType(Me.DataContext, FacturasViewModel).cb.Comitente = pobjItem.IdComitente
                    CType(Me.DataContext, FacturasViewModel).cb.NombreComitente = pobjItem.Nombre
            End Select
        End If
    End Sub
