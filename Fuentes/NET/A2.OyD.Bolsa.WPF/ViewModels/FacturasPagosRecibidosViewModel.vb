...
Public Class FacturasPagosRecibidosViewModel
    ...
    Public Sub New()
        ...
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la creación de los objetos", _
                                 Me.ToString(), "FacturasPagosRecibidosViewModel.New", Application.Current.ToString(), Program.Maquina, ex)
        End Try
    End Sub
...
#Region "Resultados Asincrónicos"
    ...
    Private Sub TerminoConsultarPagosComisiones(ByVal lo As LoadOperation(Of PagosComisiones))
        ...
        If Not lo.HasError Then
            ...
            If dcProxy.PagosComisiones.Count = 0 Then
                If _ListaFacturasPagosRecibidosTemporal.Count = 0 Then
                ...
                Else
                    ListaFacturasPagosRecibidos = (From c In _ListaFacturasPagosRecibidosTemporal
            ...
            Else
                _ListaFacturasPagosRecibidosTemporal.AddRange(dcProxy.PagosComisiones.ToList)

                _intUltimoId = (From c In _ListaFacturasPagosRecibidosTemporal
                                  Select c.Id).ToList.Max

                _strProceso = (From c In _ListaFacturasPagosRecibidosTemporal
                                Select c).ToList.FirstOrDefault.Proceso

                dcProxy.PagosComisiones.Clear()
                dcProxy.Load(dcProxy.ConsultarPagosComisionesQuery(_Fondo, _Fecha, _Consecutivo, _intUltimoId, _strProceso, Program.Usuario, Program.HashConexion), AddressOf TerminoConsultarPagosComisiones, "")

            End If
            'Fin Cambio: SA_CONSULTARPAGOSLOTES

        Else
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la obtención de la lista de Pagos Comisiones", _
    ...
    Private Sub TerminoFacturarPagos(ByVal lo As InvokeOperation(Of Boolean))
        If Not lo.HasError Then
            ...
            If Not IsNothing(_ListaFacturasPagosRecibidosSeleccionadas) Then
                For Each obj In _ListaFacturasPagosRecibidosSeleccionadas
                    ListaFacturasPagosRecibidos.Remove(obj)
                Next

            End If

            _ListaFacturasPagosRecibidosTemporal = ListaFacturasPagosRecibidos
            ListaFacturasPagosRecibidos = Nothing
            ListaFacturasPagosRecibidos = _ListaFacturasPagosRecibidosTemporal

            marcarDesmarcarTodos(False)

            _ListaFacturasPagosRecibidosSeleccionadas = Nothing
...
#Region "Propiedades"
    ...
    Private _ListaFacturasPagosRecibidosTemporal As New List(Of PagosComisiones)
    'Fin Cambio: SA_CONSULTARPAGOSLOTES
    '_ListaFacturasPagosRecibidosTem = ListaFacturasPagosRecibidos
    Private _ListaFacturasPagosRecibidosSeleccionadas As List(Of PagosComisiones)

    Private _ListaFacturasPagosRecibidos As New List(Of PagosComisiones)
    Public Property ListaFacturasPagosRecibidos() As List(Of PagosComisiones)
        Get
            Return _ListaFacturasPagosRecibidos
        End Get
        Set(ByVal value As List(Of PagosComisiones))
            _ListaFacturasPagosRecibidos = value

            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("ListaFacturasPagosRecibidos"))
        End Set
    End Property

    Private _FacturasPagosRecibidosSelected As PagosComisiones
    Public Property FacturasPagosRecibidosSelected() As PagosComisiones
        Get
            Return _FacturasPagosRecibidosSelected
        End Get
        Set(ByVal value As PagosComisiones)
            _FacturasPagosRecibidosSelected = value

            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("FacturasPagosRecibidosSelected"))
        End Set
    End Property
...
#Region "Métodos"
    ...
    Public Sub marcarDesmarcarTodos(ByVal logMarcar As Boolean)
        ...
        Try
            ...
            If Not IsNothing(ListaFacturasPagosRecibidos) Then
                If ListaFacturasPagosRecibidos.Count > 0 Then
                    For Each facturaPago In ListaFacturasPagosRecibidos
    ...
    'Consulta las facturas de pagos según los parámetros de busqueda seleccionados
    Public Sub ConsultarPagos()

        Try

            If _Fondo <> String.Empty And Not IsNothing(_Fecha) And _Consecutivo <> String.Empty Then
                If _Fecha.Year >= 1753 Then
                    ...
                    'Cambio: SA_CONSULTARPAGOSLOTES
                    ListaFacturasPagosRecibidos = Nothing
                    _ListaFacturasPagosRecibidosTemporal.Clear()
                    _intUltimoId = 0
                    _strProceso = Nothing
                    'Fin Cambio: SA_CONSULTARPAGOSLOTES
                    ...
                    logPuedeEnviar = False
                    marcarTodos = False
                    dcProxy.Load(dcProxy.ConsultarPagosComisionesQuery(_Fondo, _Fecha, _Consecutivo, 0, Nothing, Program.Usuario, Program.HashConexion), AddressOf TerminoConsultarPagosComisiones, "")
                    IsBusy = True
                Else
        ...
        Catch ex As Exception
            IsBusy = False
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema al consultar los pagos recibidos", _
    ...
    Public Sub LimpiarControles()
        Try
            ...
            dcProxy.PagosComisiones.Clear()
            ListaFacturasPagosRecibidos = Nothing
            _FacturasPagosRecibidosSelected = Nothing
            logPuedeEnviar = False
            marcarTodos = False
        Catch ex As Exception
    ...
    Public Sub FacturarPagos()
        ...
        Try
            IsBusy = True
            _ListaFacturasPagosRecibidosSeleccionadas = New list(Of PagosComisiones)
            For Each obj In _ListaFacturasPagosRecibidos
                If obj.Marcar = True Then
                    _ListaFacturasPagosRecibidosSeleccionadas.Add(obj)
                End If
            Next
            ...
            If Not IsNothing(_ListaFacturasPagosRecibidosSeleccionadas) Then
                ...
                For Each obj In _ListaFacturasPagosRecibidosSeleccionadas
                    ...
                    Dim strXML = <Datos CodigoOyD=<%= obj.CodigoOyD %>
                                     ...
                                     Consecutivo=<%= obj.NombreConsecutivo %>
                                     NroConsecutivo=<%= obj.IDDocumento %>
                ...
                'Cambio: SA_CONSULTARPAGOSLOTES
                dcProxy.FacturarPagosComisiones(strXMLCompleto, "D", _Fecha, Program.Usuario, Program.HashConexion, AddressOf TerminoFacturarPagos, "")
                'Fin Cambio: SA_CONSULTARPAGOSLOTES
            Else
                IsBusy = False
            End If
    ...
    Public Sub HabilitarFacturar()
        Try
            If Not IsNothing(ListaFacturasPagosRecibidos) Then
                Dim CantidadMarcados = (From c In ListaFacturasPagosRecibidos _
