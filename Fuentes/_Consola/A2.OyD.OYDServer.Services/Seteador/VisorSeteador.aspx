<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VisorSeteador.aspx.vb" Inherits="A2.OyD.OYDServer.Services.VisorSeteador" %>
...
<body style="background-color: #EEEEEE;font-family:Calibri; font-size:12px" >
    ...
    <div>
        <asp:Label id="lblServicioOK" runat="server" Visible="false">Servicio OK</asp:Label>
