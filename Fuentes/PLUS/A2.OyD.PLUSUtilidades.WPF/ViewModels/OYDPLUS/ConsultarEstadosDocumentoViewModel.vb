...
#Region "Propiedades"
    ...
    Private _ListaEstadosDocumento As List(Of OYDPLUSUtilidades.tblRN_ContadorReglasAutorizacion)
    Public Property ListaEstadosDocumento() As List(Of OYDPLUSUtilidades.tblRN_ContadorReglasAutorizacion)
        Get
            Return _ListaEstadosDocumento
        End Get
        Set(ByVal value As List(Of OYDPLUSUtilidades.tblRN_ContadorReglasAutorizacion))
...
#Region "Resultados asincronicos"
    ...
    Private Sub TerminoConsultarEstado(ByVal lo As LoadOperation(Of OYDPLUSUtilidades.tblRN_ContadorReglasAutorizacion))
        Try
