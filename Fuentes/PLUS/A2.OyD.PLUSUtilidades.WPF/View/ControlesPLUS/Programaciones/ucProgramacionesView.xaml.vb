...
Partial Public Class ucProgramacionesView
    ...
    Private Sub btnCancelar_Click(sender As System.Object, e As System.Windows.RoutedEventArgs)
    ...
    Private Sub UcProg_RecurrenciaView1_Loaded(sender As Object, e As RoutedEventArgs)
