...
Public Class Program
    ...
    ''' 
    Friend Const NOMBRE_PARAM_RUTA_SERV_ORDENES As String = "URLServicioPLUSOrdenes"
...
#End Region
    ...
    Friend Shared ReadOnly Property SeguridadIntegrada() As Boolean
        Get
            If Application.Current.Resources.Contains(Recursos.RecursosApp.A2Consola_SeguridadIntegrada.ToString()) Then
                Return CBool(CStr(Application.Current.Resources(Recursos.RecursosApp.A2Consola_SeguridadIntegrada.ToString())))
            Else
                Return True
            End If
        End Get
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As OYDPLUSOrdenesDomainContext)
