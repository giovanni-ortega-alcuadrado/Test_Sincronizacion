...
Public Class Program
    ...
    ''' 
    Friend Const NOMBRE_PARAM_RUTA_SERV_ORDENES As String = "URLServicioPLUSOrdenesDerivados"
...
#End Region
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As OyDPLUSordenesderivadosDomainContext)
        If Not IsNothing(pobjProxy) Then
            If pobjProxy.OrdenDerivados.HasChanges Then
                For Each li In pobjProxy.OrdenDerivados
