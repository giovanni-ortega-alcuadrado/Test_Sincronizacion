...
'Archivo: MensajesView.xaml.vb
'Generado el : 11/04/2012 17:00:40
'Propiedad de Alcuadrado S.A. 2010


Partial Public Class  MensajesView
    ...
    Public Sub New()
        ...
        Me.DataContext = New MensajesViewModel
InitializeComponent()
...
cm.GridViewRegistros = datapager1
        cm.DF = df
		CType(Me.DataContext,MensajesViewModel).NombreView = Me.ToString
    End Sub
    ...
    Private Sub cm_EventoRefrescarCombos(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles cm.EventoRefrescarCombos
        Try
            If Me.Resources.Contains("A2VM") Then
                CType(Me.DataContext, MensajesViewModel).IsBusy = True
                CType(Me.Resources("A2VM"), A2UtilsViewModel).EjecutaActualizacionCombos(Me.ToString)
                CType(Me.DataContext, MensajesViewModel).IsBusy = False
            End If
