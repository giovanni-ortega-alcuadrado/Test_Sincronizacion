...
Partial Public Class BancoNacionalFondosView
    ...
    Public Sub New()
        ...
        Me.DataContext = New CostosViewModel
InitializeComponent()

    End Sub

    Private Sub Costos_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        cm.GridTransicion = grdGridForma
cm.GridViewRegistros = datapager1
        cm.DF = df
        CType(Me.DataContext, CostosViewModel).NombreView = Me.ToString
    End Sub
    ...
    Private Sub cm_EventoRefrescarCombos(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles cm.EventoRefrescarCombos
        Try
            If Me.Resources.Contains("A2VM") Then
                CType(Me.DataContext, CostosViewModel).IsBusy = True
                CType(Me.Resources("A2VM"), A2UtilsViewModel).EjecutaActualizacionCombos(Me.ToString)
                CType(Me.DataContext, CostosViewModel).IsBusy = False
            End If
