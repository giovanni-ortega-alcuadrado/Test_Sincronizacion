...
Partial Public Class ControlHorarioFondosView
    ...
    Public Sub New()
        Try
            ...
            Me.DataContext = New ControlHorariosFondosViewModel
InitializeComponent()
    ...
    Private Sub cm_EventoRefrescarCombos(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles cm.EventoRefrescarCombos
        Try
            If Me.Resources.Contains("A2VM") Then
                CType(Me.DataContext, ControlHorariosFondosViewModel).IsBusy = True
                CType(Me.Resources("A2VM"), A2UtilsViewModel).EjecutaActualizacionCombos(Me.ToString)
                CType(Me.DataContext, ControlHorariosFondosViewModel).IsBusy = False
            End If
        Catch ex As Exception
