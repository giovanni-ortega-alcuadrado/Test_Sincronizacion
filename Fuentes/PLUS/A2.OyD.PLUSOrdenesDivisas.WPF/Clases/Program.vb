...
Public Class Program
    ...
    ''' 
    Friend Const NOMBRE_PARAM_RUTA_SERV_ORDENES As String = "URLServicioPLUSOrdenesDivisas"
...
#End Region
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As OyDPLUSordenesdivisasDomainContext)
        If Not IsNothing(pobjProxy) Then
            If pobjProxy.OrdenDivisas.HasChanges Then
                For Each li In pobjProxy.OrdenDivisas
                ...
                Next
            End If
            If pobjProxy.OrdenDivisasDetalles.HasChanges Then
                For Each li In pobjProxy.OrdenDivisasDetalles
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
