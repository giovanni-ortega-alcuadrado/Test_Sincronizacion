...
Public Class OrdenPago_DetalleOYDViewModel
...
#Region "Declaraciones"
    ...
    Private strConceptoDefectoOYD_Fondos As String = String.Empty
    ...
    Public Sub New()
        ...
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la creación de los objetos",
                                 Me.ToString(), "OrdenPago_DetalleOYDViewModel.New", Application.Current.ToString(), Program.Maquina, ex)
        End Try
    End Sub
...
#Region "Metodos"
    ...
    Public Sub PrepararNuevoRegistro()
        Try
            ...
            If Not String.IsNullOrEmpty(strConceptoDefectoOYD_Fondos) Then
                DetalleConcepto = strConceptoDefectoOYD_Fondos.Replace("[CARTERACOLECTIVA]", CarteraColectivaFondos)
                DetalleConcepto = DetalleConcepto.Replace("[ENCARGO]", NroEncargoFondos)
            Else
    ...
    Public Function ValidarRegistro() As Boolean
        Try
            ...
            If (IsNothing(_IDConcepto) Or _IDConcepto <= 0) And (IsNothing(_DetalleConcepto) Or String.IsNullOrEmpty(_DetalleConcepto)) Then
        ...
        Try
            If lo.HasError = False Then
                If lo.Entities.Count > 0 Then
                    ...
                    If DiccionarioCombosOYDPlusCompleto.ContainsKey("CONCEPTODEFECTO_OYD_FONDOS") Then
                        If DiccionarioCombosOYDPlusCompleto("CONCEPTODEFECTO_OYD_FONDOS").Count > 0 Then
                            strConceptoDefectoOYD_Fondos = DiccionarioCombosOYDPlusCompleto("CONCEPTODEFECTO_OYD_FONDOS").First.Retorno
                        End If
                    End If
