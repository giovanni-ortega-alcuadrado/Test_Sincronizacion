...
Public Class OrdenPago_DetalleCarteraColectivaViewModel
...
#Region "Declaraciones"
    ...
    Public viewRegistro As OrdenPago_DetalleCarteraColectivaView = Nothing
    ...
    Private logFechaAplicacionCarteraEsHabil As Boolean = True
    ...
    Public Sub New()
        ...
        Catch ex As Exception
            ...
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la creación de los objetos",
                                 Me.ToString(), "OrdenPago_DetalleCarteraColectivaViewModel.New", Application.Current.ToString(), Program.Maquina, ex)
        End Try
    End Sub
...
#Region "Metodos"
        ...
        Try
            ...
            If logEsFondosOYD Then
                ...
                If Not IsNothing(FechaAplicacion) And Not IsNothing(FechaOrden) Then
                    If logFechaAplicacionCarteraEsHabil = False Then
                        strMensajeValidacion = String.Format("{0}{1} - La fecha de aplicación no es un día habil o es menor a la fecha de la orden.", strMensajeValidacion, vbCrLf)
                        logTieneError = True
                    Else
                        If TipoAccionFondosOYD = GSTR_FONDOS_TIPOACCION_ADICION Then
                            If FechaAplicacion.Date < FechaOrden.Date Then
                                strMensajeValidacion = String.Format("{0}{1} - {2}", strMensajeValidacion, vbCrLf, "La fecha de aplicación no puede ser menor a la fecha de orden.")
                                logTieneError = True
                            ElseIf FechaAplicacion.Date < DateAdd(DateInterval.Day, intDiasAplicacionFondosAdicion, FechaOrden.Date) Then
                                strMensajeValidacion = String.Format("{0}{1} - {2}", strMensajeValidacion, vbCrLf, String.Format("La fecha de aplicación no puede ser menor a la fecha de orden + los días de aplicación {0:yyyy-MM-dd}", DateAdd(DateInterval.Day, intDiasAplicacionFondosAdicion, FechaOrden.Date)))
                                logTieneError = True
                            End If
                        ElseIf TipoAccionFondosOYD = GSTR_FONDOS_TIPOACCION_CONSTITUCION Then
                            If FechaAplicacion.Date < FechaOrden.Date Then
                                strMensajeValidacion = String.Format("{0}{1} - {2}", strMensajeValidacion, vbCrLf, "La fecha de aplicación no puede ser menor a la fecha de orden.")
                                logTieneError = True
                            ElseIf FechaAplicacion.Date < DateAdd(DateInterval.Day, intDiasAplicacionFondosApertura, FechaOrden.Date) Then
                                strMensajeValidacion = String.Format("{0}{1} - {2}", strMensajeValidacion, vbCrLf, String.Format("La fecha de aplicación no puede ser menor a la fecha de orden + los días de aplicación {0:yyyy-MM-dd}", DateAdd(DateInterval.Day, intDiasAplicacionFondosApertura, FechaOrden.Date)))
                                logTieneError = True
                            End If
                        End If
                    End If
        ...
        Try
            ...
            If ValidarRegistro() Then
                ...
                If ConsultarValoresBaseDatos Then
                    ...
                    If logEsFondosOYD Then
                        strDetalleConcepto = ConcatenarDetalle(DescripcionConcepto, DetalleConcepto, EncargoCarteraOYD, "CC")
                    Else
                        strDetalleConcepto = ConcatenarDetalle(DescripcionConcepto, DetalleConcepto, EncargoCarteraExterno, "CC")
                    End If
                ...
                If logEsFondosOYD Then
                    If Not IsNothing(FechaAplicacion) And Not IsNothing(FechaOrden) Then
                        ...
                        If logTieneMensajeValidacion = False Then
                            ...
                            dcProxy.Load(dcProxy.CalcularDiaHabilQuery(TipoProducto, CarteraColectivaOYD, FechaAplicacion.ToShortDateString, Program.Usuario, Program.HashConexion), AddressOf TerminoValidarFechas, "ValidarFechaAplicacion")
                        End If
                    End If
                End If
            End If
    ...
    Private Sub CalcularFechaAplicacionExterno()
        Try
            ...
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presento un problema al calcular la fecha de aplicación.", Me.ToString(), "CalcularFechaAplicacionExterno", Program.TituloSistema, Program.Maquina, ex, Program.RutaServicioLog)
        End Try
    End Sub
        ...
        Try
            ...
            If lo.HasError = False Then
                If dcProxy.tblFechasHabiles.Count > 0 Then
                    ...
                    VerificarRestriccionesTipoCartera("FECHAAPLICACIONCARTERA")
                End If
            Else
