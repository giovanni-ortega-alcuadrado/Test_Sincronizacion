...
'
Partial Public Class OrdenPago_DetalleTrasladoFondosView
    Inherits Window
    Dim vm As OrdenPago_DetalleTrasladoFondosViewModel
    ...
    Public Sub New(ByVal pintIDDetalle As Integer,
                   ByVal pintIDEncabezado As Integer)
        Try
            vm = New OrdenPago_DetalleTrasladoFondosViewModel
            InitializeComponent()
