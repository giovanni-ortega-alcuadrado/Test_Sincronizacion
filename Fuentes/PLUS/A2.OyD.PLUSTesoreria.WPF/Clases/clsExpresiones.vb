...
Public Class clsExpresiones
    ...
    Private Const STR_EXPRESION_CADENACARACTERES As String = "^[a-z A-ZÑ 0-9 á-ú Á-Ú ¿?()!¡._-]*$"
    Private Const STR_EXPRESIONREEMPLAZAR_CADENACARACTERES As String = "!*[a-z A-ZÑ 0-9 á-ú Á-Ú ¿?()!¡._-]"
    Private Const STR_EXPRESION_CADENACARACTERES2 As String = "^[a-z A-ZÑ 0-9 á-ú Á-Ú ¿?()!¡._&-]*$"
    Private Const STR_EXPRESIONREEMPLAZAR_CADENACARACTERES2 As String = "!*[a-z A-ZÑ 0-9 á-ú Á-Ú ¿?()!¡._&-]"
    ...
    Public Shared Function ValidarCaracteresEnCadena(ByVal pstrValor As String, ByVal pobjExpresion As TipoExpresion) As TextoFormateado
        ...
        ElseIf pobjExpresion = TipoExpresion.Caracteres2 Then
            strExpresion = STR_EXPRESION_CADENACARACTERES2
            strExpresionReemplazar = STR_EXPRESIONREEMPLAZAR_CADENACARACTERES2
