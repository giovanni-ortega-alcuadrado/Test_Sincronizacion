...
Module ModuloGral
    ...
    Public Const GSTR_TRASLADOFONDOS As String = "TF"
    ...
    Public Const GSTR_ORDENFONDOS_CANCELACION As String = "CA"
    ...
    Public Const GSTR_RECHAZADAS_Plus = "RE"
    Public Const GSTR_GENERADAADMINISTRADOR_Plus = "G"
    Public Const GSTR_RESPUESTAADMINISTRADOR_Plus = "O"
    ...
    Public Const GSTR_INCONSISTENCIAS_Plus = "I"
    ...
    Public Const GSTR_GMF_NOAPLICA = "N" 'Aplica para la edicion que se realiza desde el TESORERO
    Public Const GSTR_OT = "OT"
    Public Const GSTR_T = "T" 'JFSB 20171025 Se crea constante para la cancelación de registro
    ...
    Public Const GSTR_FUTURAS = "Futuras"
    Public Const GSTR_RECHAZADAS = "Rechazadas"
    ...
    Public Const GSTR_FONDOS_TIPOACCION_RETIRO = "R"
    Public Const GSTR_FONDOS_TIPOACCION_CANCELACION = "C"
    Public Const GSTR_TESOREROEDITAR = "TESORERO_EDITAR"

    Public Const GSTR_TABORDENESPAGO_CHEQUE_CODIGO = "CHEQUE"
    Public Const GSTR_TABORDENESPAGO_CHEQUE_CODIGOINTERNO = "C"
    Public Const GSTR_TABORDENESPAGO_CHEQUE_DESCRIPCION = "Cheque"
    Public Const GSTR_TABORDENESPAGO_TRANSFERENCIA_CODIGO = "TRANSFERENCIA"
    Public Const GSTR_TABORDENESPAGO_TRANSFERENCIA_CODIGOINTERNO = "T"
    Public Const GSTR_TABORDENESPAGO_TRANSFERENCIA_DESCRIPCION = "Transferencias"
    Public Const GSTR_TABORDENESPAGO_CARTERASCOLECTIVAS_CODIGO = "CARTERASCOLECTIVAS"
    Public Const GSTR_TABORDENESPAGO_CARTERASCOLECTIVAS_CODIGOINTERNO = "CC"
    Public Const GSTR_TABORDENESPAGO_CARTERASCOLECTIVAS_DESCRIPCION = "Carteras colectivas"
    Public Const GSTR_TABORDENESPAGO_OYD_CODIGO = "OYD"
    Public Const GSTR_TABORDENESPAGO_OYD_CODIGOINTERNO = "OYD"
    Public Const GSTR_TABORDENESPAGO_OYD_DESCRIPCION = "OYD"
    Public Const GSTR_TABORDENESPAGO_TRASLADOFONDOS_CODIGO = "TRASLADOFONDOS"
    Public Const GSTR_TABORDENESPAGO_TRASLADOFONDOS_CODIGOINTERNO = "TF"
    Public Const GSTR_TABORDENESPAGO_TRASLADOFONDOS_DESCRIPCION = "Traslado Fondos"
    Public Const GSTR_TABORDENESPAGO_INTERNOS_CODIGO = "INTERNOS"
    Public Const GSTR_TABORDENESPAGO_INTERNOS_CODIGOINTERNO = "I"
    Public Const GSTR_TABORDENESPAGO_INTERNOS_DESCRIPCION = "Internos"
    Public Const GSTR_TABORDENESPAGO_BLOQUEORECURSOS_CODIGO = "BLOQUEORECURSOS"
    Public Const GSTR_TABORDENESPAGO_BLOQUEORECURSOS_CODIGOINTERNO = "BS"
    Public Const GSTR_TABORDENESPAGO_BLOQUEORECURSOS_DESCRIPCION = "Bloqueo o liberar recursos"
    Public Const GSTR_TABORDENESPAGO_OPERACIONESESPECIALES_CODIGO = "OPERACIONESESPECIALES"
    Public Const GSTR_TABORDENESPAGO_OPERACIONESESPECIALES_CODIGOINTERNO = "OE"
    Public Const GSTR_TABORDENESPAGO_OPERACIONESESPECIALES_DESCRIPCION = "Operaciones especiales"

    Public Const GSTR_TABORDENESRECAUDO_CHEQUE_CODIGO = "CHEQUE"
    Public Const GSTR_TABORDENESRECAUDO_CHEQUE_CODIGOINTERNO = "C"
    Public Const GSTR_TABORDENESRECAUDO_CHEQUE_DESCRIPCION = "Cheque"
    Public Const GSTR_TABORDENESRECAUDO_TRANSFERENCIA_CODIGO = "TRANSFERENCIA"
    Public Const GSTR_TABORDENESRECAUDO_TRANSFERENCIA_CODIGOINTERNO = "T"
    Public Const GSTR_TABORDENESRECAUDO_TRANSFERENCIA_DESCRIPCION = "Transferencias"
    Public Const GSTR_TABORDENESRECAUDO_CONSIGNACION_CODIGO = "CONSIGNACION"
    Public Const GSTR_TABORDENESRECAUDO_CONSIGNACION_CODIGOINTERNO = "CG"
    Public Const GSTR_TABORDENESRECAUDO_CONSIGNACION_DESCRIPCION = "Consignaciones"
