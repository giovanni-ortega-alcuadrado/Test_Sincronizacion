...
Public Class CambiarEstilosAplicacion
    ...
    Private Shared Sub AdicionarRecurso(ByVal objVentana As Object, ByVal strUrl As String, ByVal pstrNombreProyecto As String)
        Try
            ...
            If Not IsNothing(objVentana) Then
                If TypeOf objVentana Is SilverlightFX.UserInterface.View Then
                    CType(objVentana, SilverlightFX.UserInterface.View).Resources.MergedDictionaries.Add(objRecursoEstilo)
                ElseIf TypeOf objVentana Is UserControl Then
                    CType(objVentana, UserControl).Resources.MergedDictionaries.Add(objRecursoEstilo)
                ElseIf TypeOf objVentana Is ChildWindow Then
                    CType(objVentana, ChildWindow).Resources.MergedDictionaries.Add(objRecursoEstilo)
                End If
            End If
    ...
    Private Shared Sub LimpiarRecursos(ByVal objVentana As Object)
        Try
            If Not IsNothing(objVentana) Then
                If TypeOf objVentana Is SilverlightFX.UserInterface.View Then
                    CType(objVentana, SilverlightFX.UserInterface.View).Resources.MergedDictionaries.Clear()
                ElseIf TypeOf objVentana Is UserControl Then
                    CType(objVentana, UserControl).Resources.MergedDictionaries.Clear()
                ElseIf TypeOf objVentana Is ChildWindow Then
                    CType(objVentana, ChildWindow).Resources.MergedDictionaries.Clear()
                End If
            End If
