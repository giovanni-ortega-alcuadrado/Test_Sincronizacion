...
Public Class Program
    ...
    ''' 
    Friend Const NOMBRE_PARAM_RUTA_SERV_ORDENES As String = "URLServicioPLUSOrdenesBolsa"
    ...
    Friend Const LAPSO_RECARGA_OYDPLUS As String = "LapsoRecargaAutomaticaOYDPLUS"
...
#Region "Parámetros para la página del seteador"
    ...
    Friend Const TIPO_NEGOCIO_TTVC As String = "TipoNegocioTTVC"
    Friend Const TIPO_NEGOCIO_REPOC As String = "TipoNegocioREPOC"
    ...
    Friend Const TIPO_NEGOCIO_ADR As String = "TipoNegocioADR"
    ...
    Friend Const DURACIONDEFECTO_ORDENES_RENTAFIJA As String = "DuracionDefectoOrdenesRentaFija"
...
#End Region
    ...
    Public Shared ReadOnly Property URLWebPageSeteadorSinOrden() As String
        Get
            If Application.Current.Resources.Contains(Recursos.RecursosApp.A2Consola_AppActiva.ToString()) Then
                If CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.ContainsKey(NOMBRE_PARAM_RUTA_VISORSETEADOR) Then
                    Dim strUrlVisorSeteador As String = CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.Item(NOMBRE_PARAM_RUTA_VISORSETEADOR).ToString()
                    strUrlVisorSeteador = strUrlVisorSeteador.Replace("?IdOrden=", "")
                    Return strUrlVisorSeteador
                Else
                    Return ("http://a2serverpro:1020/OyDServiciosRIA/OYDPLUS/DatosVisorPage.aspx")
                End If
            Else
                Return ("http://a2serverpro:1020/OyDServiciosRIA/OYDPLUS/DatosVisorPage.aspx")
            End If
...
#Region "Propiedades para estados propios del seteador"
    ...
    Public Shared ReadOnly Property Par_lapso_recarga_OYDPLUS() As Integer
        Get
            Dim intRecarga As Integer = 3
            Try
                intRecarga = Integer.Parse(RetornarClave(LAPSO_RECARGA_OYDPLUS))
                If intRecarga < 1 Then
                    intRecarga = 3
                End If
...
#Region "Tipos de negocio"
    ...
    Public Shared ReadOnly Property TN_REPOC() As String
        Get
            Return RetornarClave(TIPO_NEGOCIO_REPOC)
        End Get
    End Property
    ...
    Public Shared ReadOnly Property TN_TTVC() As String
        Get
            Return RetornarClave(TIPO_NEGOCIO_TTVC)
        End Get
    End Property
    ...
    Public Shared ReadOnly Property TN_ADR() As String
        Get
            Return RetornarClave(TIPO_NEGOCIO_ADR)
        End Get
    End Property
...
#Region "Ordenes de OYDPLUS"
    ...
    Public Shared ReadOnly Property DURACIONXDEFECTO_ORDEN_RENTAFIJA() As String
        Get
            Return RetornarClave(DURACIONDEFECTO_ORDENES_RENTAFIJA)
        End Get
    End Property
...
#End Region
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As OYDPLUSOrdenesBolsaDomainContext)
        If Not IsNothing(pobjProxy) Then
            If pobjProxy.ReceptoresOrdens.HasChanges Then
                ...
                Next
            End If
            If pobjProxy.OrdenOYDPLUS.HasChanges Then
                For Each li In pobjProxy.OrdenOYDPLUS
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.RegistroOperacionesPorReceptors.HasChanges Then
                For Each li In pobjProxy.RegistroOperacionesPorReceptors
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
