...
#Region "Combos"
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function cargarCombos() As List(Of OYDUtilidades.ItemCombo)
        Try
    ...
    Public Function cargarCombos_Usuario(ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
        Try
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function cargarCombosEspecificos(ByVal pstrListasCombos As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
        Try
...
#End Region
    ...
    ''' <remarks></remarks>
    '''
    Public Function Verificaparametro(ByVal strparametro As String) As String
        Try
        ...
        End Try
    End Function
    Public Function VerificaparametroSync(ByVal strparametro As String) As String
        Dim objTask As Task(Of String) = Me.VerificaparametroAsync(strparametro)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function VerificaparametroAsync(ByVal strparametro As String) As Task(Of String)
        Dim objTaskComplete As TaskCompletionSource(Of String) = New TaskCompletionSource(Of String)()
        objTaskComplete.TrySetResult(Verificaparametro(strparametro))
        Return (objTaskComplete.Task)
    End Function

    Public Function listaVerificaparametro(ByVal strparametro As String, ByVal strretorno As String) As List(Of valoresparametro)
        Try
        ...
        End Try
    End Function
    Public Function listaVerificaparametroSync(ByVal strparametro As String, ByVal strretorno As String) As List(Of valoresparametro)
        Dim objTask As Task(Of List(Of valoresparametro)) = Me.listaVerificaparametroAsync(strparametro, strretorno)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function listaVerificaparametroAsync(ByVal strparametro As String, ByVal strretorno As String) As Task(Of List(Of valoresparametro))
        ...
        objTaskComplete.TrySetResult(listaVerificaparametro(strparametro, strretorno))
        Return (objTaskComplete.Task)
    End Function
    ...
    Public Function ConsularCamposObligatorios(ByVal pstrNombreTabla As String, ByVal pstrNombreCampoObligado As String, ByVal pstrNombreCampoCondicionante As String, ByVal pstrValorCampoCondicionante As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.CamposObligatorios)
        Try
            Dim ret = Me.DataContext.usp_OyD_CamposObligatorios_Consultar_OyDNet(pstrNombreTabla, pstrNombreCampoObligado, pstrNombreCampoCondicionante, pstrValorCampoCondicionante, pstrUsuario, DemeInfoSesion("ConsularCamposObligatorios"), 0).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Sub InsertCamposObligatorio(ByVal CampoObligatorio As CamposObligatorios)
        Try
            CampoObligatorio.InfoSesion = DemeInfoSesion("InsertCamposObligatorio")
    ...
    Public Sub DeleteCampoObligatorio(ByVal CampoObligatorio As CamposObligatorios)
        Try
            CampoObligatorio.InfoSesion = DemeInfoSesion("DeleteCampoObligatorio")
    ...
    Public Function ValidarClienteInhabilitado(ByVal pstrNroDocumento As String, ByVal pstrNombre As String) As List(Of ClienteInhabilitado)
        Try
            Dim ret = Me.DataContext.usp_ConsultarInhabilitados_OyDNet(pstrNroDocumento, pstrNombre, False, DemeInfoSesion("ValidarClienteInhabilitado"), 0).ToList
            Return ret
        Catch ex As Exception
    ...
    End Function
    <Query(HasSideEffects:=True)> _
    Public Function ValidarClienteInhabilitadoNombre(ByVal pstrNroDocumento As String, ByVal pstrNombre As String) As List(Of ClienteInhabilitado)
        Try
            Dim ret = Me.DataContext.usp_ConsultarInhabilitados_OyDNet(pstrNroDocumento, pstrNombre, False, DemeInfoSesion("ValidarClienteInhabilitado"), 0).ToList
            Return ret
        Catch ex As Exception
    ...
    End Function
    <Query(HasSideEffects:=True)> _
    Public Function ValidarClienteInhabilitadoSegundoMensaje(ByVal pstrNroDocumento As String, ByVal pstrNombre As String, ByVal psegundomensaje As Boolean) As List(Of ClienteInhabilitado)
        Try
            Dim ret = Me.DataContext.usp_ConsultarInhabilitados_OyDNet(pstrNroDocumento, pstrNombre, psegundomensaje, DemeInfoSesion("ValidarClienteInhabilitado"), 0).ToList
            Return ret
        Catch ex As Exception
            ManejarError(ex, Me.ToString(), "ValidarClienteInhabilitado")
            Return Nothing
    ...
    Public Function GrabarListaClinton(ByVal pstrForma As String, ByVal plngIDComitente As String, ByVal pstrDocumento As String, ByVal pstrCliente As String, _
                                       ByVal pstrClienteInhabilitado As String, ByVal pdblPorcentajeCercania As Decimal, ByVal pstrUsuario As String) As Boolean
        Try
    ...
    Public Function cargarCombosCondicional(ByVal pstrListasCombos As String, ByVal pstrCondicionTexto As String, ByVal pintCondicionNumerica As Integer, ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
        Try
...
#Region "Buscadores"
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarClientes(ByVal pstrCondicionFiltro As String, ByVal pstrEstadoCliente As String, ByVal pstrTipoVinculacion As String, ByVal pstrAgrupacion As String, ByVal pstrUsuario As String, ByVal plogExcluirCodigosCompania As Boolean, ByVal pintIDCompania As Nullable(Of Integer)) As List(Of OYDUtilidades.BuscadorClientes)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Clientes(HttpUtility.UrlDecode(pstrCondicionFiltro), pstrEstadoCliente, pstrTipoVinculacion, pstrAgrupacion, pstrUsuario, DemeInfoSesion("buscarClientes", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogExcluirCodigosCompania, pintIDCompania).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarClientesOYDPLUS(ByVal pstrCondicionFiltro As String, ByVal pstrEstadoCliente As String, ByVal pstrTipoVinculacion As String, _
                                          ByVal pstrAgrupacion As String, ByVal plogCargarUsuariosRestriccion As Boolean, ByVal plogCargarClientesTerecero As Boolean, _
                                          ByVal pstrIDReceptor As String, ByVal pstrTipoNegocio As String, ByVal pstrTipoProducto As String, ByVal pstrPerfilRiesgo As String, ByVal pstrUsuario As String, ByVal plogExcluirCodigosCompania As Boolean, ByVal pintIDCompania As Nullable(Of Integer)) As List(Of OYDUtilidades.BuscadorClientes)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_ClientesOYDPLUS(HttpUtility.UrlDecode(pstrCondicionFiltro), pstrEstadoCliente, pstrTipoVinculacion, pstrAgrupacion, plogCargarUsuariosRestriccion, plogCargarClientesTerecero, pstrIDReceptor, pstrTipoNegocio, pstrTipoProducto, pstrPerfilRiesgo, pstrUsuario, DemeInfoSesion("buscarClientesOYDPLUS", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogExcluirCodigosCompania, pintIDCompania).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function buscarClienteEspecifico(ByVal pstrIdCliente As String, ByVal pstrUsuario As String, ByVal pstrAgrupacion As String) As List(Of OYDUtilidades.BuscadorClientes)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Clientes(pstrIdCliente, "", "", pstrAgrupacion, pstrUsuario, DemeInfoSesion("buscarClienteEspecifico", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, False, 0).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function buscarClienteEspecificoCompania(ByVal pstrIdCliente As String, ByVal pstrUsuario As String, ByVal pstrAgrupacion As String, ByVal plogExcluirCodigosCompania As Boolean, ByVal pintIDCompania As Nullable(Of Integer)) As List(Of OYDUtilidades.BuscadorClientes)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Clientes(pstrIdCliente, "", "", pstrAgrupacion, pstrUsuario, DemeInfoSesion("buscarClienteEspecificoCompania", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogExcluirCodigosCompania, pintIDCompania).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarEspecies(ByVal pstrCondicionFiltro As String, ByVal pstrMercado As String, ByVal pstrEstadoEspecie As String, ByVal pstrAgrupacion As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.BuscadorEspecies)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Especies(HttpUtility.UrlDecode(pstrCondicionFiltro), pstrMercado, pstrEstadoEspecie, pstrAgrupacion, False, String.Empty, String.Empty, pstrUsuario, DemeInfoSesion("buscarEspecies", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, True).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarEspeciesControl(ByVal pstrCondicionFiltro As String, ByVal pstrMercado As String, ByVal pstrEstadoEspecie As String, ByVal pstrAgrupacion As String, ByVal pstrUsuario As String, ByVal plogTraerEspeciesVencidas As Boolean) As List(Of OYDUtilidades.BuscadorEspecies)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Especies(pstrCondicionFiltro, pstrMercado, pstrEstadoEspecie, pstrAgrupacion, False, String.Empty, String.Empty, pstrUsuario, DemeInfoSesion("buscarEspeciesControl", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogTraerEspeciesVencidas).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarEspeciesOyDPLUS(ByVal pstrCondicionFiltro As String, ByVal pstrMercado As String, ByVal pstrEstadoEspecie As String, ByVal pstrAgrupacion As String, ByVal pstrTipoNegocio As String, ByVal pstrTipoProducto As String, ByVal pstrUsuario As String, ByVal plogTraerEspeciesVencidas As Boolean) As List(Of OYDUtilidades.BuscadorEspecies)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Especies(pstrCondicionFiltro, pstrMercado, pstrEstadoEspecie, pstrAgrupacion, True, pstrTipoNegocio, pstrTipoProducto, pstrUsuario, DemeInfoSesion("buscarEspeciesOyDPLUS", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogTraerEspeciesVencidas).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function buscarNemotecnicoEspecifico(ByVal pstrMercado As String, ByVal pstrNemotecnico As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.BuscadorEspecies)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Especies(RetornarValorDescodificado(pstrNemotecnico), pstrMercado, "", "nemotecnico", False, String.Empty, String.Empty, pstrUsuario, DemeInfoSesion("buscarNemotecnicoEspecifico", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, True).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarItems(ByVal pstrCondicionFiltro As String, ByVal pstrTipoItem As String, ByVal pstrEstadoItem As String, ByVal pstrAgrupacion As String, ByVal pstrCondicion1 As String, ByVal pstrCondicion2 As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.BuscadorGenerico)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Generico(HttpUtility.UrlDecode(pstrCondicionFiltro), pstrTipoItem, pstrEstadoItem, pstrAgrupacion, pstrCondicion1, pstrCondicion2, pstrUsuario, DemeInfoSesion("buscarItems", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function buscarItemEspecifico(ByVal pstrTipoItem As String, ByVal pstrIdItem As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.BuscadorGenerico)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_Generico(pstrIdItem, pstrTipoItem, "", "IdItem", Nothing, Nothing, pstrUsuario, DemeInfoSesion("buscarItemEspecifico", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarOrdenantesComitente(ByVal pstrIdComitente As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.BuscadorOrdenantes)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_ClientesOrdenantes(pstrIdComitente, pstrUsuario, DemeInfoSesion("buscarOrdenantesComitente", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function buscarCuentasDepositoComitente(ByVal pstrIdComitente As String, ByVal plogRetornarTodasLosDepositos As Boolean, ByVal pstrUsuario As String) As List(Of OYDUtilidades.BuscadorCuentasDeposito)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Buscador_ClientesCuentasDeposito(pstrIdComitente, pstrUsuario, DemeInfoSesion("buscarCuentasDepositoComitente", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogRetornarTodasLosDepositos).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' <remarks></remarks>
    Public Function consultarFechaCierre(ByVal pstrModulo As String, ByVal pstrUsuario As String) As System.Nullable(Of Date)
    ...
    End Function
    Public Function consultarFechaCierreSync(ByVal pstrModulo As String, ByVal pstrUsuario As String) As System.Nullable(Of Date)
        Dim objTask As Task(Of System.Nullable(Of Date)) = Me.consultarFechaCierreAsync(pstrModulo, pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function consultarFechaCierreAsync(ByVal pstrModulo As String, ByVal pstrUsuario As String) As Task(Of System.Nullable(Of Date))
        ...
        objTaskComplete.TrySetResult(consultarFechaCierre(pstrModulo, pstrUsuario))
        Return (objTaskComplete.Task)
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function consultarConsecutivo(pstrNombreConsecutivo As String, pstrIdOwner As String) As System.Nullable(Of Integer)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function PreimpresoOLineas() As System.Nullable(Of Boolean)
    ...
    Public Function consultarFechaHabilPosteriorCierreCompania(ByVal pintIDCompania As Integer, ByVal pstrUsuario As String) As System.Nullable(Of Date)
        Dim dtmFechaHabil As System.Nullable(Of Date) = Nothing
        Try
            Me.DataContext.uspOyDNet_Compiania_DiaHabilPorterioFechaCierre(pintIDCompania, dtmFechaHabil, pstrUsuario, DemeInfoSesion("consultarFechaHabilPosteriorCierreCompania", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, Nothing)
        Catch ex As Exception
            ManejarError(ex, Me.ToString(), "consultarFechaHabilPosteriorCierreCompania")
        End Try
        Return dtmFechaHabil
    End Function
    Public Function consultarFechaHabilPosteriorCierreCompaniaSync(ByVal pintIDCompania As Integer, ByVal pstrUsuario As String) As System.Nullable(Of Date)
        Dim objTask As Task(Of System.Nullable(Of Date)) = Me.consultarFechaHabilPosteriorCierreCompaniaAsync(pintIDCompania, pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function consultarFechaHabilPosteriorCierreCompaniaAsync(ByVal pintIDCompania As Integer, ByVal pstrUsuario As String) As Task(Of System.Nullable(Of Date))
        Dim objTaskComplete As TaskCompletionSource(Of System.Nullable(Of Date)) = New TaskCompletionSource(Of System.Nullable(Of Date))()
        objTaskComplete.TrySetResult(consultarFechaHabilPosteriorCierreCompania(pintIDCompania, pstrUsuario))
        Return (objTaskComplete.Task)
    End Function

    Public Function consultarFechaCierreCompania(ByVal pintIDCompania As Integer, ByVal pstrUsuario As String) As System.Nullable(Of Date)
        Dim dtmFechaCierre As System.Nullable(Of Date) = Nothing
        Try
            Me.DataContext.uspOyDNet_Compiania_DiaHabilPorterioFechaCierre(pintIDCompania, Nothing, pstrUsuario, DemeInfoSesion("consultarFechaHabilPosteriorCierreCompania", pstrUsuario), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, dtmFechaCierre)
        Catch ex As Exception
            ManejarError(ex, Me.ToString(), "consultarFechaHabilPosteriorCierreCompania")
        End Try
        Return dtmFechaCierre
    End Function
    Public Function consultarFechaCierreCompaniaSync(ByVal pintIDCompania As Integer, ByVal pstrUsuario As String) As System.Nullable(Of Date)
        Dim objTask As Task(Of System.Nullable(Of Date)) = Me.consultarFechaHabilPosteriorCierreCompaniaAsync(pintIDCompania, pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function consultarFechaCierreCompaniaAsync(ByVal pintIDCompania As Integer, ByVal pstrUsuario As String) As Task(Of System.Nullable(Of Date))
        Dim objTaskComplete As TaskCompletionSource(Of System.Nullable(Of Date)) = New TaskCompletionSource(Of System.Nullable(Of Date))()
        objTaskComplete.TrySetResult(consultarFechaHabilPosteriorCierreCompania(pintIDCompania, pstrUsuario))
        Return (objTaskComplete.Task)
    End Function
...
#Region "DTS"
    ...
    Public Function DTSFiltrar(ByVal pstrFiltro As String) As List(Of DT)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Utilidades_DTS_Filtrar(pstrFiltro, DemeInfoSesion("DTSFiltrar"), 0).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function DTSConsultar(ByVal pIDDTS As Integer) As List(Of DT)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Utilidades_DTS_Consultar(pIDDTS, DemeInfoSesion("BuscarDTS"), 0).ToList
            Return ret
            Exit Function
        Catch ex As Exception
    ...
    Public Function TraerDTPorDefecto() As DT
        Try
            Dim e As New DT
            'e.IDComisionista = 
            'e.IDSucComisionista = 
    ...
    Public Sub InsertDT(ByVal DT As DT)
        Try
            DT.InfoSesion = DemeInfoSesion("InsertDT")
    ...
    Public Sub UpdateDT(ByVal currentDT As DT)
        Try
            currentDT.InfoSesion = DemeInfoSesion("UpdateDT")
    ...
    ''' <remarks>Santiago Vergara - Octubre 30/2013</remarks>
    Public Function UsuariosDTS_Actualizar(ByVal pintIdDTS As Integer, ByVal pstrUsuariosConsecutivos As String, ByVal pstrUsuario As String) As Boolean
        Try
            Dim ret = Me.DataContext.uspOyDNet_UsuariosDTS_Actualizar(pintIdDTS, pstrUsuariosConsecutivos, pstrUsuario, DemeInfoSesion("UsuariosDTS_Actualizar"), 0)
            Return True
        Catch ex As Exception
...
#Region "Auditoria"
    ...
    Public Function AuditoriaFiltrar(ByVal pstrOpcion As String, ByVal pstrNombreTabla As String, ByVal pstrUsuario As String) As List(Of AuditoriaTabla)
        Try

            If pstrNombreTabla = String.Empty Then
                Dim ret = Me.DataContext.uspOyDNet_Utilidades_Auditorias_Consulta(pstrOpcion, Nothing, Nothing, Nothing, Nothing, pstrUsuario, DemeInfoSesion("AuditoriaFiltrar"), 0).ToList
                Return ret
            Else
                Dim ret = Me.DataContext.uspOyDNet_Utilidades_Auditorias_Consulta(pstrOpcion, pstrNombreTabla, Nothing, Nothing, Nothing, pstrUsuario, DemeInfoSesion("AuditoriaFiltrar"), 0).ToList
                Return ret
            End If
    ...
    Public Function AuditoriaConsultar(ByVal pstrOpcion As String, ByVal pstrNombreTabla As String, ByVal plogIngreso As Boolean, _
                                       ByVal plogModificacion As Boolean, ByVal plogEliminacion As Boolean, ByVal pstrUsuario As String) As List(Of AuditoriaTabla)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Utilidades_Auditorias_Consulta(pstrOpcion, pstrNombreTabla, plogIngreso, plogModificacion, plogEliminacion, pstrUsuario, DemeInfoSesion("Traer_Auditoria"), 0).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function AuditoriaPorDefecto() As AuditoriaTabla
        Try
    ...
    Public Sub InsertAuditoriaTabla(ByVal Auditori As AuditoriaTabla)
        Try
            Auditori.InfoSesion = DemeInfoSesion("InsertAuditori")
    ...
    Public Sub UpdateAuditoriaTabla(ByVal currentAuditori As AuditoriaTabla)
        Try
            currentAuditori.InfoSesion = DemeInfoSesion("UpdateAuditori")
    ...
    Public Sub DeleteAuditoriaTabla(ByVal Auditori As AuditoriaTabla)
        Try
            'Me.DataContext.uspOyDNet_Utilidades_Auditoria_Eliminar(, DemeInfoSesion("DeleteAuditori"),0).ToList
            Auditori.InfoSesion = DemeInfoSesion("DeleteAuditori")
    ...
    Public Function cargarCombosAuditoria(ByVal pstrListasCombos As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
        Try
            Dim ret = From c In Me.DataContext.uspA2utils_CargarCombosAuditoria(pstrListasCombos, pstrUsuario, DemeInfoSesion("cargarCombosAuditoria"), 0)
            Return ret.ToList
        Catch ex As Exception
            ManejarError(ex, Me.ToString(), "cargarCombosEspecificos")
            Return Nothing
    ...
    Public Function cargarCombosEspeciesCalculosFinancieros() As List(Of OYDUtilidades.ItemCombo)
        Try
...
#Region "Utilidades"
    ...
    Public Function cargarCombosSistemasCargaArchivos() As List(Of OYDUtilidades.ItemCombo)
        Try
...
#Region "InformeAuditoria"
   ...
   pstrUsuario As String) As System.Nullable(Of Boolean)
        Try
            Dim ret = Me.DataContext.Usp_AuditoriaInforme_OyDNet(pdtmFechainicial, pdtmFechafin,
   pstrTabla, pstrFiltroClave, pstrFiltroContenido, pstrUsuario, DemeInfoSesion("DatosInforme"), 0).ToList
    ...
    Private Sub exportDataGrid(ByVal dGrid As DataGrid, ByVal strFormat As String)
        ...
        RETORNO = Guardar_ArchivoServidor(CSTR_NOMBREPROCESO_AUDITORIA_TABLAS, Usuario, String.Format("InformeAuditoriatablas{0}.csv", Now.ToString("yyyy-mm-dd")), strLineas)
    ...
    End Sub
    Public Function Guardar_ArchivoServidor(ByVal NombreProceso As String, ByVal Usuario As String, ByVal NombreArchivo As String, ByVal Lista As List(Of String)) As Boolean
        Try
...
#Region "ParametrosConsola"
    ...
    Public Function leerParametrosAppConsola(ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
    ...
    Public Function leerParametrosAppConsolaSync(ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
        Dim objTask As Task(Of List(Of OYDUtilidades.ItemCombo)) = Me.leerParametrosAppConsolaAsync(pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function

    Private Function leerParametrosAppConsolaAsync(ByVal pstrUsuario As String) As Task(Of List(Of OYDUtilidades.ItemCombo))
        ...
        objTaskComplete.TrySetResult(leerParametrosAppConsola(pstrUsuario))
        Return (objTaskComplete.Task)
    End Function
...
#Region "NIIF"
    ...
    ''' <remarks></remarks>
    ''' 
    Public Function cargarCombosNiff(ByVal pstrCargarParametro As String, ByVal pintItems As Int32, ByVal pstrCriterio As String, ByVal pstrUsuario As String) As List(Of OYDUtilidades.ItemCombo)
        Try
            Dim ret = From c In Me.DataContext.uspOyDNet_NIIF_ConsultarItemsPorEspecie_Cliente(pstrCargarParametro, pintItems, pstrCriterio, pstrUsuario, DemeInfoSesion("cargarCombosNiff"), 0)
            Return ret.ToList
        Catch ex As Exception
    ...
    Public Function ActualizarSegmentosNegocios(ByVal pxmlCodigosSegmentos As String, ByVal intIDConcepto As Int32, ByVal logOperacionesActivo As Boolean, _
                                                ByVal plogTesoreriaActivo As Boolean, ByVal pstrSegmentoDefecto As String, ByVal pstrUsuario As String) As Boolean
        Try
            Dim ret = Me.DataContext.uspOyDNet_Actualizar_SegmentosNegocios(pxmlCodigosSegmentos, intIDConcepto, logOperacionesActivo, plogTesoreriaActivo, pstrSegmentoDefecto, pstrUsuario, DemeInfoSesion("ActualizarSegmentosNegocios"), 0)
            Return True
        Catch ex As Exception
    ...
    Public Function NIIF_ConsultaInicial(ByVal pintConcepto As Int32, pstrUsuario As String) As List(Of NIIFInicial)
        Try
            Dim ret = Me.DataContext.uspOyDNet_NIIF_ConsultaInicial(pintConcepto, pstrUsuario, DemeInfoSesion("NIIF_ConsultaInicial"), 0)
            Return ret.ToList
        Catch ex As Exception
...
#Region "Geeración de archivos planos"
    ...
    <Query(HasSideEffects:=True)> _
    Public Function GenerarArchivoPlano(ByVal pstrCarpetaProceso As String, ByVal pstrProceso As String, ByVal pstrParametros As String, ByVal pstrNombreArchivo As String, ByVal pstrSeparador As String, ByVal pstrExtensionArchivo As String, ByVal pstrMaquina As String, ByVal pstrUsuario As String) As List(Of GenerarArchivosPlanos)
        ...
        Try
            ...
            objListaParametros.Add(CrearSQLParameter("pstrInfoSesion", DemeInfoSesion("GenerarArchivoPlano"), SqlDbType.VarChar))
    ...
    Public Function GenerarArchivoPlanoSync(ByVal pstrCarpetaProceso As String, ByVal pstrProceso As String, ByVal pstrParametros As String, ByVal pstrNombreArchivo As String, ByVal pstrSeparador As String, ByVal pstrExtensionArchivo As String, ByVal pstrMaquina As String, ByVal pstrUsuario As String) As List(Of GenerarArchivosPlanos)
        Dim objTask As Task(Of List(Of GenerarArchivosPlanos)) = Me.GenerarArchivoPlanoAsync(pstrCarpetaProceso, pstrProceso, pstrParametros, pstrNombreArchivo, pstrSeparador, pstrExtensionArchivo, pstrMaquina, pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function GenerarArchivoPlanoAsync(ByVal pstrCarpetaProceso As String, ByVal pstrProceso As String, ByVal pstrParametros As String, ByVal pstrNombreArchivo As String, ByVal pstrSeparador As String, ByVal pstrExtensionArchivo As String, ByVal pstrMaquina As String, ByVal pstrUsuario As String) As Task(Of List(Of GenerarArchivosPlanos))
        ...
        objTaskComplete.TrySetResult(GenerarArchivoPlano(pstrCarpetaProceso, pstrProceso, pstrParametros, pstrNombreArchivo, pstrSeparador, pstrExtensionArchivo, pstrMaquina, pstrUsuario))
        Return (objTaskComplete.Task)
    End Function
...
#Region "Descargar Archivo Reporte"
    ...
    <Query(HasSideEffects:=True)> _
    Public Function GenerarArchivoReporte(ByVal pstrRutaServidorReportes As String, _
                                          ByVal pstrReporte As String, _
                                          ByVal pstrParametrosReporte As String, _
                                          ByVal pstrSeparadorParametros As String, _
                                          ByVal pstrFormatoReporte As String, _
                                          ByVal pstrCarpetaProceso As String, _
                                          ByVal pstrNombreArchivo As String,
                                          ByVal pstrUsuario As String) As List(Of GenerarArchivosPlanos)
        Dim objRetorno As New List(Of GenerarArchivosPlanos)
        objRetorno.Add(New GenerarArchivosPlanos With {.Mensaje = "", .RutaArchivoPlano = "", .Exitoso = False})
        ...
        Try
            ...
            objGeneracionReporte.generarArchivo(pstrRutaServidorReportes, _
                                                pstrReporte, _
                                                objRutas.RutaArchivosLocal, _
                                                pstrNombreArchivo, _
                                                pstrFormatoReporte, _
                                                pstrParametrosReporte, _
                                                pstrUsuario,
    ...
    End Function
    <Query(HasSideEffects:=True)> _
    Public Function GenerarArchivoReporteSync(ByVal pstrRutaServidorReportes As String, _
                                          ByVal pstrReporte As String, _
                                          ByVal pstrParametrosReporte As String, _
                                          ByVal pstrSeparadorParametros As String, _
                                          ByVal pstrFormatoReporte As String, _
                                          ...
                                          ByVal pstrNombreArchivo As String,
                                          ByVal pstrUsuario As String) As List(Of GenerarArchivosPlanos)
        Dim objTask As Task(Of List(Of GenerarArchivosPlanos)) = Me.GenerarArchivoReporteAsync(pstrRutaServidorReportes, pstrReporte, pstrParametrosReporte, pstrSeparadorParametros, pstrFormatoReporte, pstrCarpetaProceso, pstrNombreArchivo, pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function
    Private Function GenerarArchivoReporteAsync(ByVal pstrRutaServidorReportes As String, _
                                          ByVal pstrReporte As String, _
                                          ByVal pstrParametrosReporte As String, _
                                          ByVal pstrSeparadorParametros As String, _
                                          ByVal pstrFormatoReporte As String, _
                                          ByVal pstrCarpetaProceso As String, _
                                          ByVal pstrNombreArchivo As String,
                                          ByVal pstrUsuario As String) As Task(Of List(Of GenerarArchivosPlanos))
        Dim objTaskComplete As TaskCompletionSource(Of List(Of GenerarArchivosPlanos)) = New TaskCompletionSource(Of List(Of GenerarArchivosPlanos))()
        objTaskComplete.TrySetResult(GenerarArchivoReporte(pstrRutaServidorReportes, pstrReporte, pstrParametrosReporte, pstrSeparadorParametros, pstrFormatoReporte, pstrCarpetaProceso, pstrNombreArchivo, pstrUsuario))
        Return (objTaskComplete.Task)
    End Function
...
#Region "Procesos Masivos"
    ...
    ''' </summary>
    ''' 
    Public Function Procesos_ConsultarTipos(ByVal pstrUsuario As String) As List(Of ProcesoTipos)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Proceso_ConsultarTipos(pstrUsuario, DemeInfoSesion("Procesos_ConsultarTipos"), GINT_INICIO_MSGERR_SQL_PERSONALIZADO).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function Procesos_Consultar(ByVal pintIDTipoProceso As Integer, ByVal pstrUsuario As String) As List(Of Proceso)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Proceso_Consultar(pintIDTipoProceso, pstrUsuario, DemeInfoSesion("Procesos_Consultar"), GINT_INICIO_MSGERR_SQL_PERSONALIZADO).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' </summary>
    ''' 
    Public Function Procesos_ConsultarDetalle(ByVal pintIDProceso As Integer, ByVal pstrUsuario As String) As List(Of ProcesoDetalle)
        Try
            Dim ret = Me.DataContext.uspOyDNet_Proceso_ConsultarDetalle(pintIDProceso, pstrUsuario, DemeInfoSesion("Procesos_ConsultarDetalle"), GINT_INICIO_MSGERR_SQL_PERSONALIZADO).ToList
            Return ret
        Catch ex As Exception
    ...
    ''' </summary>
    ''' 
    Public Function Procesos_Iniciar(ByVal pintIDTipoProceso As Integer, ByVal pstrUsuario As String, ByVal plogSolicitarFecha As Boolean, ByVal pdtmFechaProceso As Nullable(Of DateTime)) As List(Of ResultadoProceso)
        Try

            'JAEZ 20161003
            Me.DataContext.ActualizarModulo(Modulos())

            Dim ret = Me.DataContext.uspOyDNet_Proceso_Iniciar(pintIDTipoProceso, pstrUsuario, DemeInfoSesion("Procesos_Iniciar"), GINT_INICIO_MSGERR_SQL_PERSONALIZADO, plogSolicitarFecha, pdtmFechaProceso).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function ConsultarConsecutivoExistente(pstrNombreConsecutivo As String, pstrUsuario As String) As System.Nullable(Of Boolean)
        Dim bolConsultarConsecutivo As System.Nullable(Of Boolean) = Nothing
        Try
            Me.DataContext.spA2utils_ConsultarConsecutivo(pstrNombreConsecutivo, pstrUsuario, DemeInfoSesion("ConsultarConsecutivoExistente", pstrUsuario), 0, bolConsultarConsecutivo)
        Catch ex As Exception
...
#Region "Lista archivos Directorio"
    ...
    Public Function ListarArchivosDirectorioEnDirectorio(ByVal pstrDirectorioUploads As String) As List(Of ArchivosDirectorio)
        Try
    ...
    Public Function ListarArchivosDirectorioEnDirectorioSync(ByVal pstrDirectorioUploads As String) As List(Of ArchivosDirectorio)
        Dim objTask As Task(Of List(Of ArchivosDirectorio)) = Me.ListarArchivosDirectorioEnDirectorioAsync(pstrDirectorioUploads)
        objTask.Wait()
        Return objTask.Result
    End Function

    Private Function ListarArchivosDirectorioEnDirectorioAsync(ByVal pstrDirectorioUploads As String) As Task(Of List(Of ArchivosDirectorio))
        ...
        objTaskComplete.TrySetResult(ListarArchivosDirectorioEnDirectorio(pstrDirectorioUploads))
        Return (objTaskComplete.Task)
    End Function
...
#Region "Validaciones GMF"
    <Query(HasSideEffects:=True)> _
    Public Function VerificarCobroGMF(ByVal pstrNombreConsecutivo As String, ByVal pintIDBanco As Nullable(Of Integer), ByVal pstrNombreBeneficiario As String, ByVal pstrDocumentoBeneficiario As String, ByVal pstrTipoDocumentoBeneficiario As String, ByVal pstrFormaPago As String, ByVal pstrTipoCheque As String, ByVal pstrCuentaBancaria As String, ByVal pstrDetalleInstruccion As String, ByVal pstrDetalles As String, ByVal pstrTipo As String, ByVal pstrUsuario As String) As List(Of TempRetornoCalculo)
        Try
            Dim strxmlDetTesoreria = HttpUtility.HtmlDecode(pstrDetalles)
            Dim ret = Me.DataContext.uspOyDNet_VerificarCobroGMF(pstrNombreConsecutivo, pintIDBanco, pstrNombreBeneficiario, pstrDocumentoBeneficiario, pstrTipoDocumentoBeneficiario, pstrFormaPago, pstrTipoCheque, pstrCuentaBancaria, pstrDetalleInstruccion, strxmlDetTesoreria, pstrTipo, pstrUsuario, DemeInfoSesion("Procesos_Consultar"), 0).ToList
            Return ret
        Catch ex As Exception
    ...
    Public Function VerificarCobroGMFSync(ByVal pstrNombreConsecutivo As String, ByVal pintIDBanco As Nullable(Of Integer), ByVal pstrNombreBeneficiario As String, ByVal pstrDocumentoBeneficiario As String, ByVal pstrTipoDocumentoBeneficiario As String, ByVal pstrFormaPago As String, ByVal pstrTipoCheque As String, ByVal pstrCuentaBancaria As String, ByVal pstrDetalleInstruccion As String, ByVal pstrDetalles As String, ByVal pstrTipo As String, ByVal pstrUsuario As String) As List(Of TempRetornoCalculo)
        Dim objTask As Task(Of List(Of TempRetornoCalculo)) = Me.VerificarCobroGMFAsync(pstrNombreConsecutivo, pintIDBanco, pstrNombreBeneficiario, pstrDocumentoBeneficiario, pstrTipoDocumentoBeneficiario, pstrFormaPago, pstrTipoCheque, pstrCuentaBancaria, pstrDetalleInstruccion, pstrDetalles, pstrTipo, pstrUsuario)
        objTask.Wait()
        Return objTask.Result
    End Function

    Private Function VerificarCobroGMFAsync(ByVal pstrNombreConsecutivo As String, ByVal pintIDBanco As Nullable(Of Integer), ByVal pstrNombreBeneficiario As String, ByVal pstrDocumentoBeneficiario As String, ByVal pstrTipoDocumentoBeneficiario As String, ByVal pstrFormaPago As String, ByVal pstrTipoCheque As String, ByVal pstrCuentaBancaria As String, ByVal pstrDetalleInstruccion As String, ByVal pstrDetalles As String, ByVal pstrTipo As String, ByVal pstrUsuario As String) As Task(Of List(Of TempRetornoCalculo))
        ...
        objTaskComplete.TrySetResult(VerificarCobroGMF(pstrNombreConsecutivo, pintIDBanco, pstrNombreBeneficiario, pstrDocumentoBeneficiario, pstrTipoDocumentoBeneficiario, pstrFormaPago, pstrTipoCheque, pstrCuentaBancaria, pstrDetalleInstruccion, pstrDetalles, pstrTipo, pstrUsuario))
        Return (objTaskComplete.Task)
    End Function
