        ...
        Try
            ...
            If Me.DiccionarioCombosEspecificos.Count = 0 Or logRecargaRecursos Then
                If Application.Current.Resources.Contains(pstrDicCombosEspecificos) And Not logRecargaRecursos Then
                    DiccionarioCombosEspecificos = DirectCast(Application.Current.Resources(pstrDicCombosEspecificos),
            ...
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la consulta de las listas de selección específicas",
    ...
    Private Sub TerminoCargarCombos(ByVal lo As LoadOperation(Of OYDUtilidades.ItemCombo))
        ...
        Try
            If Not lo.HasError Then
                ...
                End If
            Else
                A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la carga los combos",
