...
Partial Public Class CargarArchivosView
...
#Region "Declaraciones"
    ...
    Private dcProxy As OYDServer.RIA.Web.ImportacionesDomainContext
...
#Region "Contructores"
    ...
    Public Sub New()
        ...
        If System.Diagnostics.Debugger.IsAttached And Program.ejecutarAppSegunAmbiente() Then
            dcProxy = New OYDServer.RIA.Web.ImportacionesDomainContext
        Else
            dcProxy = New OYDServer.RIA.Web.ImportacionesDomainContext(New System.Uri(Program.RutaServicioNegocio))
        End If
...
#Region "Sub y Eventos"
    ...
    Private Sub ctlCargarArchivos_TerminoCargarArchivos(sender As System.Object, e As System.EventArgs)
        dcProxy.Archivos.Clear()
        dcProxy.Load(dcProxy.TraerArchivosDirectorioQuery(_strNombreProceso, Program.Usuario, Program.HashConexion), AddressOf TerminoTraerArchivosAdjuntos, Nothing)
    End Sub
