...
Module Generales
    ...
    Public Function fmtCodigo(ByVal pvstrCodigo As String) As String
        ...
        'Julian Rincón
        '23/04/2016
        'Descripción:   Se realiza cambio ya que la función anterior estaba asignando sólo "@" 
        'ocasionando problemas en la creación de ordenes y demás
        'Casos de prueba CP000255, CP000256, CP000257

        fmtCodigo = RSet(pvstrCodigo, 17)
    End Function
    ''' <summary>
