...
#Region "Constantes generales"
    ...
    Public Const SeparadorError As String = "ERROR::"
    Public Const SeparadorMensaje As String = "MSG::"

    Public Enum TiposResultadoScript As Byte
        Ninguno
        Mensaje
        Plano
        Excel
    ...
    Public Enum TipoSeparadorArchivo
        TAB
        COMA
        PIPE
        PUNTOYCOMA
