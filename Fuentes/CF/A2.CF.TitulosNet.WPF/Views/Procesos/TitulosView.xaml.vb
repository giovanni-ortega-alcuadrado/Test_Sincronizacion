...
Private Sub btnArchivosDeceval_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.ConsultarArchivosSolicitados()
    End Sub

Private Sub btnSolicitarArchivoDeceval_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.SolicitarArchivoDeceval()
    End Sub

Private Sub btnComprar_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.Cargar()
    End Sub
...
Private Sub btnVolver_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.Volver()
    End Sub
