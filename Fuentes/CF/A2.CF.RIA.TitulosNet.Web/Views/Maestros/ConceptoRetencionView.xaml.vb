...
Partial Public Class ConceptoRetencionView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases ConceptoRetencionView y ConceptoRetencionViewModel
    ''' Pantalla ConceptoRetencion (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Jorge Peña (Alcuadrado S.A.) - 19 de Enero/2018</remarks>
#Region "Variables"
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New ConceptoRetencionViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ConceptoRetencionViewModel)
