...
Partial Public Class CalificadorasView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases CalificadorasView y CalificadorasViewModel
    ''' Pantalla Calificadoras (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Jorge Peña (Alcuadrado S.A.) - 21 de Febrero 2014</remarks>
#Region "Variables"

    Private mobjVM As CalificadorasViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New CalificadorasViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, CalificadorasViewModel)
