...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Sub ConsultarArchivosSolicitados()
        Try
            ...
            objControlArchivos.Show()
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema al abrir el control para seleccionar los archivos.", _
    ...
    Private Sub RespuestaControlListarDirectorio(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema al recibir la respuesta para seleccionar los archivos.", _
    ...
    Public Sub SolicitarArchivoDeceval()
        ...
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema al solicitar los archivos de Deceval.", _
