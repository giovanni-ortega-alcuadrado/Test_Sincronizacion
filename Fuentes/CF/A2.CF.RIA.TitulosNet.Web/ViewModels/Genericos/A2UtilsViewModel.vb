            ...
            If Not objCombos Is Nothing Then
                If objCombos.Count > 0 Then
                    ...
                    Else
                        ...
                        End If
                        Application.Current.Resources.Add(pstrNombreControl, dicListaCombos)
...
#Region "Cache"
    ...
    ''' <remarks></remarks>
    Private Sub CargaCacheDiccionario(ByRef dicCombos As Dictionary(Of String, ObservableCollection(Of RIAWeb.OYDUtilidades.ItemCombo)), ByVal strItemCache As String, ByVal strItemRecurso As String)

        'busco los datos en la cache local
                'If A2SingletonObject.Instance.A2Cache.ExisteItem(strItemCache) Then
        '    dicCombos = A2SingletonObject.Instance.A2Cache.LeerItem(Of Dictionary(Of String, ObservableCollection(Of RIAWeb.OYDUtilidades.ItemCombo)))(strItemCache)
        '    If Application.Current.Resources.Contains(strItemRecurso) Then
        '        Application.Current.Resources.Remove(strItemRecurso)
        '    End If
        '    Application.Current.Resources.Add(strItemRecurso,
        '                                      dicCombos.ToDictionary(Function(k) k.Key, Function(k) k.Value.ToList()))
        'End If
