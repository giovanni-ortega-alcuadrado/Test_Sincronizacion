...
Partial Public Class CierrePasivoDeshacerValoracionView
    Inherits UserControl

#Region "Variables"

    Private mobjVM As CierrePasivoDeshacerValoracionViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        ...
        Me.DataContext = New CierrePasivoDeshacerValoracionViewModel
InitializeComponent()
    End Sub
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, CierrePasivoDeshacerValoracionViewModel)
...
#Region "Manejadores error"
    ...
    Private Sub btnProcesar_Click(sender As Object, e As RoutedEventArgs)
        mobjVM.ProcesarDeshacerCierrePasivo()
    End Sub
