...
Partial Public Class IndicadoresView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases IndicadoresView y IndicadoresViewModel
    ''' Pantalla Indicadores (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Jorge Peña (Alcuadrado S.A.) - 21 de Febrero 2014</remarks>
#Region "Variables"

    Private mobjVM As IndicadoresViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New IndicadoresViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    ''' <summary>
    ''' ''ID CAT20150904
    ''' se hace llado a los diccionarios de combos
    ''' Pantalla Indicadores (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Carlos Andres Toro(Alcuadrado S.A.) - 04 de Septiembre 2015</remarks>
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, IndicadoresViewModel)
