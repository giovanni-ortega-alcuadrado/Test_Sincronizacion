...
Module General
    ...
    Friend Function inicializarProxyCalculosFinancieros() As CalculosFinancierosDomainContext
        Dim objProxy As CalculosFinancierosDomainContext = Nothing
        If System.Diagnostics.Debugger.IsAttached And Program.ejecutarAppSegunAmbiente() Then
            objProxy = New CalculosFinancierosDomainContext()
        Else
            objProxy = New CalculosFinancierosDomainContext(New System.Uri(Program.RutaServicioNegocio(Program.TipoServicio.URLServicioCFCalculosFinancieros.ToString())))
        End If

        DirectCast(objProxy.DomainClient, WebDomainClient(Of CalculosFinancierosDomainContext.ICalculosFinancierosDomainServiceContract)).ChannelFactory.Endpoint.Binding.SendTimeout = New TimeSpan(0, A2ComunesControl.FuncionesCompartidas.TimeUpProxy, 0)
        DirectCast(objProxy.DomainClient, WebDomainClient(Of CalculosFinancierosDomainContext.ICalculosFinancierosDomainServiceContract)).ChannelFactory.Endpoint.Binding.ReceiveTimeout = New TimeSpan(0, A2ComunesControl.FuncionesCompartidas.TimeUpProxy, 0)
