...
Partial Public Class HomologacionTipoOrigenView
    Inherits UserControl

#Region "Variables"
    Private mobjVM As HomologacionTipoOrigenViewModel
...
#Region "Inicializacion"
    ...
    Public Sub New()
        ...
        Try
            Me.DataContext = New HomologacionTipoOrigenViewModel
InitializeComponent()
        Catch ex As Exception
    ...
    Private Async Sub inicializar()
        Try
            If Not Me.DataContext Is Nothing Then
                mobjVM = CType(Me.DataContext, HomologacionTipoOrigenViewModel)
