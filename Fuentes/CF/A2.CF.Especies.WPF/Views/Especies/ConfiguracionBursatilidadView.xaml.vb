...
Partial Public Class ConfiguracionBursatilidadView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases ConfiguracionBursatilidadView y ConfiguracionBursatilidadViewModel
...
#Region "Variables"
    ...
    Private mobjVM As ConfiguracionBursatilidadViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New ConfiguracionBursatilidadViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ConfiguracionBursatilidadViewModel)
