        ...
        Try
            ...
            If logInicializarCombos Then
                ...
                If Not DiccionarioCombosA2.Any() Or logRecargaRecursos Then
                    ...
                    mdcProxy.Load(mdcProxy.cargarCombosQuery(pstrUsuario:=Program.Usuario, pstrInfoConexion:=Program.HashConexion), AddressOf TerminoCargarCombos, logRecargaRecursos)
                End If
