...
Public Class clsExpresiones
    ...
    Private Const STR_EXPRESION_SOLOLETRASNUMEROS As String = "^[a-zA-Z0-9]*$"
    Private Const STR_EXPRESIONREEMPLAZAR_SOLOLETRASNUMEROS As String = "!*[a-zA-Z0-9]"
    Private Const STR_EXPRESION_SOLOLETRASNUMEROSGIONES As String = "^[a-zA-Z0-9_-]*$"
    Private Const STR_EXPRESIONREEMPLAZAR_SOLOLETRASNUMEROSGIONES As String = "!*[a-zA-Z0-9_-]"
    ...
    Public Shared Function ValidarCaracteresEnCadena(ByVal pstrValor As String, ByVal pobjExpresion As TipoExpresion) As TextoFormateado
        ...
        ElseIf pobjExpresion = TipoExpresion.LetrasNumerosGiones Then
            strExpresion = STR_EXPRESION_SOLOLETRASNUMEROSGIONES
            strExpresionReemplazar = STR_EXPRESIONREEMPLAZAR_SOLOLETRASNUMEROSGIONES
