...
#Region "Constantes públicas específicas"
    ...
    Friend Const NOMBRE_PARAM_NOMBRE_APLICACION_API As String = "OYDSERVICIOSRIA_API_SITIOWEB"
    Friend Const NOMBRE_PARAM_NOMBRE_APLICACION_API_DIRECTORIOVIRTUAL As String = "OYDSERVICIOSRIA_API_DIRECTORIOVIRTUAL"
...
#Region "Métodos públicos genéricos"
    ...
    Public Shared ReadOnly Property RutaServicioBase_Api() As String
        Get
            If Application.Current.Resources.Contains(Recursos.RecursosApp.A2Consola_AppActiva.ToString()) Then
                If CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.ContainsKey(NOMBRE_PARAM_NOMBRE_APLICACION_API) Then
                    Return CType(CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.Item(NOMBRE_PARAM_NOMBRE_APLICACION_API), String)
                Else
                    Return ("")
                End If
            Else
    ...
    Public Shared ReadOnly Property RutaServicioBase_Api_DirectorioVirtual() As String
        Get
            If Application.Current.Resources.Contains(Recursos.RecursosApp.A2Consola_AppActiva.ToString()) Then
                If CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.ContainsKey(NOMBRE_PARAM_NOMBRE_APLICACION_API_DIRECTORIOVIRTUAL) Then
                    Return CType(CType(Application.Current.Resources(Recursos.RecursosApp.A2Consola_AppActiva.ToString()), Aplicacion).Parametros.Item(NOMBRE_PARAM_NOMBRE_APLICACION_API_DIRECTORIOVIRTUAL), String)
                Else
                    Return ("")
                End If
            Else
...
#End Region
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As UtilidadesCFDomainContext)
