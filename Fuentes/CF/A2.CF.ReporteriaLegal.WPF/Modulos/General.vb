...
Module General
    ...
    Friend Function inicializarProxyReporteriaLegal() As ReporteriaLegalDomainContext
        Dim objProxy As ReporteriaLegalDomainContext = Nothing
        If System.Diagnostics.Debugger.IsAttached And Program.ejecutarAppSegunAmbiente() Then
            objProxy = New ReporteriaLegalDomainContext()
        Else
            objProxy = New ReporteriaLegalDomainContext(New System.Uri(Program.RutaServicioNegocio(Program.TipoServicio.URLServicioReporteriaLegal.ToString())))
        End If

        DirectCast(objProxy.DomainClient, WebDomainClient(Of ReporteriaLegalDomainContext.IReporteriaLegalDomainServiceContract)).ChannelFactory.Endpoint.Binding.SendTimeout = New TimeSpan(0, A2ComunesControl.FuncionesCompartidas.TimeUpProxy, 0)
        DirectCast(objProxy.DomainClient, WebDomainClient(Of ReporteriaLegalDomainContext.IReporteriaLegalDomainServiceContract)).ChannelFactory.Endpoint.Binding.ReceiveTimeout = New TimeSpan(0, A2ComunesControl.FuncionesCompartidas.TimeUpProxy, 0)
