        ...
        Try
            ...
            If pstrClaseCombos.Equals(String.Empty) Then
                If Application.Current.Resources.Contains(Program.NombreListaCombos) AndAlso Not logRecargaRecursos Then
                    CargaCacheDiccionario(DiccionarioCombos, pstrClaseCombos, Program.NombreListaCombos)
                ...
                Else
                    ...
                    If Not DiccionarioCombos.Any() Or logRecargaRecursos Then
                        ...
                        Dim objDebug As New clsDebug With {.strMensajeDebug = "Termino consultarCombos"}
            ...
            Else
                If Application.Current.Resources.Contains(pstrNombreControl) AndAlso Not logRecargaRecursos Then
                    CargaCacheDiccionario(DiccionarioCombosEspecificos, pstrClaseCombos, pstrNombreControl)
                ...
                Else
                    ...
                    If Not DiccionarioCombosEspecificos.Any() Or logRecargaRecursos Then
                        ...
                        Dim objDebug As New clsDebug With {.strMensajeDebug = "Termino consultarCombos: " & pstrClaseCombos}
                        Messenger.Default.Send(Of clsDebug)(objDebug)
                    End If
