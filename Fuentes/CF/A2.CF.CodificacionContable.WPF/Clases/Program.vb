...
#End Region
    ...
    Public Shared Sub VerificarCambiosProxyServidor(ByRef pobjProxy As CodificacionContableDomainContext)
        If Not IsNothing(pobjProxy) Then
            If pobjProxy.ConfiguracionContableXModulos.HasChanges Then
                For Each li In pobjProxy.ConfiguracionContableXModulos
                ...
                Next
            End If
            If pobjProxy.CodificacionContables.HasChanges Then
                For Each li In pobjProxy.CodificacionContables
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.ConfiguracionContableXValors.HasChanges Then
                For Each li In pobjProxy.ConfiguracionContableXValors
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
                ...
                Next
            End If
            If pobjProxy.ConfiguracionContableConceptos.HasChanges Then
                For Each li In pobjProxy.ConfiguracionContableConceptos
                    If li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Deleted _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Modified _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.[New] _
                        Or li.EntityState = OpenRiaServices.DomainServices.Client.EntityState.Detached Then
