...
Partial Public Class EstadosEntradaSalidaTitulosView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases EstadosEntradaSalidaTitulosView y EstadosEntradaSalidaTitulosViewModel
    ''' </summary>
    ''' <remarks>Jorge Peña (Alcuadrado S.A.) - 22 de Agosto 2017</remarks>
#Region "Variables"

    Private mobjVM As EstadosEntradaSalidaTitulosViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New EstadosEntradaSalidaTitulosViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, EstadosEntradaSalidaTitulosViewModel)
