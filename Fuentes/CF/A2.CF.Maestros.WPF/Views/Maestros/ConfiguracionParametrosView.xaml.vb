...
Partial Public Class ConfiguracionParametrosView
...
#Region "Variables"
    ...
    Private mobjVM As ConfiguracionParametrosViewModel
...
#Region "Inicializacion"
    ''' <history>
    ''' ID caso de prueba:  CP001, CP002
    ''' Descripción:        Se actualiza ventana a estilo Metro y se añade el campo Descripción al Grid y al filtro
    ''' Responsable:        Javier Pardo (Alcuadrado S.A.)
    ''' Fecha:              10 de julio/2015
    ''' Pruebas CB:         Javier Pardo (Alcuadrado S.A.) - 10 de julio/2015
    ''' </history>
    Public Sub New()
        Try
        ...
        Me.DataContext = New ConfiguracionParametrosViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, ConfiguracionParametrosViewModel)
...
#End Region
    ...
    Private Sub TextBox_Codigo_TextChanged(sender As Object, e As TextChangedEventArgs)
        Try
