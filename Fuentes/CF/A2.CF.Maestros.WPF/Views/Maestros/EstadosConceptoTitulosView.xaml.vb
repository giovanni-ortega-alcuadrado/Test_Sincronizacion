...
Partial Public Class EstadosConceptoTitulosView
    Inherits UserControl

    ''' <summary>
    ''' Eventos creados para la comunicación con las clases EstadosConceptoTitulosView y EstadosConceptoTitulosViewModel
    ''' Pantalla EstadosConceptoTitulos (Calculos Financieros)
    ''' </summary>
    ''' <remarks>Jorge Peña (Alcuadrado S.A.) - 21 de Febrero 2014</remarks>
#Region "Variables"

    Private mobjVM As EstadosConceptoTitulosViewModel
...
#Region "Inicializacion"
    Public Sub New()
        ...
        Me.DataContext = New EstadosConceptoTitulosViewModel
InitializeComponent()
    End Sub
...
cm.GridViewRegistros = datapager1
    ...
    Private Async Sub inicializar()
        If Not Me.DataContext Is Nothing Then
            mobjVM = CType(Me.DataContext, EstadosConceptoTitulosViewModel)
