...
''' <summary>
''' ViewModel para la pantalla EstadosConceptoTitulos perteneciente al proyecto de Cálculos Financieros.
''' </summary>
...
Public Class EstadosConceptoTitulosViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As EstadosConceptoTitulos
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As EstadosConceptoTitulos
#End Region
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' <summary>
    ''' Lista de EstadosConceptoTitulos que se encuentran cargadas en el grid del formulario
    ''' </summary>
    ''' <history>
    ...
    ''' Pruebas CB:         Jorge Peña - 20 Agosto/2015 - Resultado Ok 
    ''' </history>
    Private _ListaEncabezado As EntitySet(Of EstadosConceptoTitulos)
    Public Property ListaEncabezado() As EntitySet(Of EstadosConceptoTitulos)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As EntitySet(Of EstadosConceptoTitulos))
    ...
    ''' <summary>
    ''' Colección que pagina la lista de EstadosConceptoTitulos para navegar sobre el grid con paginación
    ''' </summary>
    ...
    ''' <summary>
    ''' Elemento de la lista de EstadosConceptoTitulos que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoSeleccionado As EstadosConceptoTitulos
    Public Property EncabezadoSeleccionado() As EstadosConceptoTitulos
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As EstadosConceptoTitulos)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaEstadosConceptoTitulos
    Public Property cb() As CamposBusquedaEstadosConceptoTitulos
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaEstadosConceptoTitulos)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        ...
        Dim objNvoEncabezado As New EstadosConceptoTitulos
        ...
        Try
            ...
            If Not mobjEncabezadoPorDefecto Is Nothing Then
                Program.CopiarObjeto(Of EstadosConceptoTitulos)(mobjEncabezadoPorDefecto, objNvoEncabezado)
            Else
                objNvoEncabezado.intIDEstadosConceptoTitulos = -1
                objNvoEncabezado.strConceptoTitulo = String.Empty
                objNvoEncabezado.strEstadoEntrada = String.Empty
                objNvoEncabezado.strEstadoSalida = String.Empty
            End If
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not String.IsNullOrEmpty(cb.strConceptoTitulo) Or Not String.IsNullOrEmpty(cb.strEstadoEntrada) Or
                Not String.IsNullOrEmpty(cb.strEstadoSalida) Then 'Validar que ingresó algo en los campos de búsqueda
                Await ConsultarEncabezado(False, String.Empty, cb.strConceptoTitulo, cb.strEstadoEntrada, cb.strEstadoSalida)
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Public Overrides Sub ActualizarRegistro()
        ...
        Try
            ...
            If ValidarRegistro() Then
                ...
                intNroOcurrencias = (From e In ListaEncabezado Where e.intIDEstadosConceptoTitulos = _EncabezadoSeleccionado.intIDEstadosConceptoTitulos Select e).Count
    ...
    Public Overrides Sub BorrarRegistro()
        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                ...
                A2Utilidades.Mensajes.mostrarMensajePregunta("Está opción borra el estado concepto título seleccionado. ¿Confirma el borrado de este registro?", Program.TituloSistema, ValoresUserState.Borrar.ToString(), AddressOf BorrarRegistroConfirmado)
            End If
        Catch ex As Exception
            IsBusy = False
        ...
        Try
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    If mdcProxy.EstadosConceptoTitulos.Where(Function(i) i.intIDEstadosConceptoTitulos = EncabezadoSeleccionado.intIDEstadosConceptoTitulos).Count > 0 Then
                        mdcProxy.EstadosConceptoTitulos.Remove(mdcProxy.EstadosConceptoTitulos.Where(Function(i) i.intIDEstadosConceptoTitulos = EncabezadoSeleccionado.intIDEstadosConceptoTitulos).First)
                    End If
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaEstadosConceptoTitulos
            objCB.strConceptoTitulo = String.Empty
            objCB.strEstadoEntrada = String.Empty
            objCB.strEstadoSalida = String.Empty
            cb = objCB
        Catch ex As Exception
            IsBusy = False
    ...
    ''' </summary>
    Private Function ObtenerRegistroAnterior() As EstadosConceptoTitulos
        Dim objEncabezado As EstadosConceptoTitulos = New EstadosConceptoTitulos

        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                Program.CopiarObjeto(Of EstadosConceptoTitulos)(_EncabezadoSeleccionado, objEncabezado)
                objEncabezado.intIDEstadosConceptoTitulos = _EncabezadoSeleccionado.intIDEstadosConceptoTitulos
            End If
        Catch ex As Exception
    ...
    Private Function ValidarRegistro() As Boolean
        ...
        Try
            ...
            '-------------------------------------------------------------------------------------------------------------------------
            If Not IsNothing(_EncabezadoSeleccionado) Then
                'Valida el concepto título
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strDescripcionConceptoTitulo) Then
                    strMsg = String.Format("{0}{1} + El concepto título es un campo requerido.", strMsg, vbCrLf)
                End If

                'Valida el estado entrada
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strEstadoEntrada) Then
                    strMsg = String.Format("{0}{1} + El estado entrada es un campo requerido.", strMsg, vbCrLf)
                End If

                'Valida el estado salida
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strEstadoSalida) Then
                    strMsg = String.Format("{0}{1} + El estado salida es un campo requerido.", strMsg, vbCrLf)
                End If
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefectoSync()
        Dim objRet As LoadOperation(Of EstadosConceptoTitulos)
        Dim dcProxy As MaestrosCFDomainContext

        Try
            dcProxy = inicializarProxyMaestros()

            objRet = Await dcProxy.Load(dcProxy.ConsultarEstadosConceptoTitulosPorDefectoSyncQuery(Program.Usuario, Program.HashConexion)).AsTask
    ...
    ''' <summary>
    ''' Consultar de forma sincrónica los datos de EstadosConceptoTitulos
    ''' </summary>
    ...
    Private Async Function ConsultarEncabezado(ByVal plogFiltrar As Boolean,
                                               ...
                                               Optional ByVal pstrConceptoTitulo As String = "",
                                               Optional ByVal pstrEstadoEntrada As String = "",
                                               Optional ByVal pstrEstadoSalida As String = "") As Task(Of Boolean)
        ...
        Try
            ...
            mdcProxy.EstadosConceptoTitulos.Clear()
            ...
            If plogFiltrar Then
                ...
                objRet = Await mdcProxy.Load(mdcProxy.FiltrarEstadosConceptoTitulosSyncQuery(pstrFiltro:=pstrFiltro, pstrUsuario:=Program.Usuario, pstrInfoConexion:=Program.HashConexion)).AsTask()
            Else
                objRet = Await mdcProxy.Load(mdcProxy.ConsultarEstadosConceptoTitulosSyncQuery(pstrConceptoTitulo:=pstrConceptoTitulo,
                                                                                            pstrEstadoEntrada:=pstrEstadoEntrada,
                                                                                            pstrEstadoSalida:=pstrEstadoSalida,
            ...
            If Not objRet Is Nothing Then
                If objRet.HasError Then
                    ...
                    objRet.MarkErrorAsHandled()
                Else
                    ListaEncabezado = mdcProxy.EstadosConceptoTitulos
...
''' </summary>
Public Class CamposBusquedaEstadosConceptoTitulos
