...
Public Class EstadosBloqueoTitulosViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As EstadosBloqueoTitulos
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As EstadosBloqueoTitulos
#End Region
...
#Region "Inicialización - REQUERIDO"
    ...
    ''' </summary>
    ''' <history>
    ''' Fecha:              Septiembre 2/2015
    ''' Pruebas CB:         Jhonatan Arley Acevedo Martínez - Septiembre 2/2015 - Resultado Ok 
    ''' </history>
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefectoSync()
        Dim objRet As LoadOperation(Of EstadosBloqueoTitulos)
        Dim dcProxy As MaestrosCFDomainContext

        Try
            dcProxy = inicializarProxyMaestros()

            objRet = Await dcProxy.Load(dcProxy.ConsultarEstadosBloqueoTitulosPorDefectoSyncQuery(Program.Usuario, Program.HashConexion)).AsTask
            ...
            If Not objRet Is Nothing Then
                If objRet.HasError Then
                    ...
                    Else
                        A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se generó un problema al ejecutar la consulta de los valores por defecto.", Me.ToString(), "ConsultarEstadosBloqueoTitulosPorDefectoQuery", Program.TituloSistema, Program.Maquina, objRet.Error)
                    End If
            ...
            End If
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se generó un problema al ejecutar la consulta de los valores por defecto.", Me.ToString(), "ConsultarEstadosBloqueoTitulosPorDefectoQuery", Program.TituloSistema, Program.Maquina, ex)
        End Try
    End Sub

    ''' <summary>
    ''' Consultar de forma sincrónica los datos de EstadosBloqueoTitulos
    ''' </summary>
    ...
    Private Async Function ConsultarEncabezado(ByVal plogFiltrar As Boolean,
                                               ...
                                               Optional ByVal pstrEstadoBloqueo As String = "",
                                               Optional ByVal pstrEstadoDesBloqueo As String = "",
                                               Optional ByVal pstrMecanismo As String = "",
                                               Optional ByVal pstrMotivoBloqueo As String = "") As Task(Of Boolean)
        ...
        Try
            ...
            mdcProxy.EstadosBloqueoTitulos.Clear()
            ...
            If plogFiltrar Then
                ...
                objRet = Await mdcProxy.Load(mdcProxy.FiltrarEstadosBloqueoTitulosSyncQuery(pstrFiltro:=pstrFiltro, pstrUsuario:=Program.Usuario, pstrInfoConexion:=Program.HashConexion)).AsTask()
            Else
                objRet = Await mdcProxy.Load(mdcProxy.ConsultarEstadosBloqueoTitulosSyncQuery(pstrEstadoBloqueo:=pstrEstadoBloqueo,
                                                                                              pstrEstadoDesBloqueo:=pstrEstadoDesBloqueo,
            ...
            If Not objRet Is Nothing Then
                If objRet.HasError Then
                    ...
                    objRet.MarkErrorAsHandled()
                Else
                    ListaEncabezado = mdcProxy.EstadosBloqueoTitulos
            ...
            logResultado = True
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la recepción de la lista de EstadosBloqueoTitulos ", Me.ToString(), "ConsultarEncabezado", Application.Current.ToString(), Program.Maquina, ex)
        Finally
            IsBusy = False
        End Try
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' <summary>
    ''' Lista de EstadosBloqueoTitulos que se encuentran cargadas en el grid del formulario
    ''' </summary>
    ''' <history>
    ''' Fecha:              Septiembre 2/2015
    ''' Pruebas CB:         Jhonatan Arley Acevedo Martínez - Septiembre 2/2015 - Resultado Ok 
    ''' </history>
    Private _ListaEncabezado As EntitySet(Of EstadosBloqueoTitulos)
    Public Property ListaEncabezado() As EntitySet(Of EstadosBloqueoTitulos)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As EntitySet(Of EstadosBloqueoTitulos))
    ...
    ''' <summary>
    ''' Colección que pagina la lista de EstadosBloqueoTitulos para navegar sobre el grid con paginación
    ''' </summary>
    ...
    ''' <summary>
    ''' Elemento de la lista de EstadosBloqueoTitulos que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoSeleccionado As EstadosBloqueoTitulos
    Public Property EncabezadoSeleccionado() As EstadosBloqueoTitulos
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As EstadosBloqueoTitulos)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaEstadosBloqueoTitulos
    Public Property cb() As CamposBusquedaEstadosBloqueoTitulos
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaEstadosBloqueoTitulos)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        ...
        Dim objNvoEncabezado As New EstadosBloqueoTitulos
        ...
        Try
            ...
            If Not mobjEncabezadoPorDefecto Is Nothing Then
                Program.CopiarObjeto(Of EstadosBloqueoTitulos)(mobjEncabezadoPorDefecto, objNvoEncabezado)
            Else
                objNvoEncabezado.intID = -1
                objNvoEncabezado.strEstadoBloqueo = String.Empty
                objNvoEncabezado.strMotivoBloqueo = String.Empty
            End If
    ...
    ''' Ejecuta una búsqueda sobre los datos que contengan en los campos definidos internamente en el procedimiento de búsqueda (filtrado) el texto ingresado 
    ''' en el campo Filtro de la barra de herramientas
    ''' </summary>
    ''' <history>
    ''' Fecha:              Septiembre 2/2015
    ''' Pruebas CB:         Jhonatan Arley Acevedo Martínez - Septiembre 2/2015 - Resultado Ok 
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not IsNothing(cb.strEstadoBloqueo) Or Not IsNothing(cb.strEstadoDesBloqueo) Or Not IsNothing(cb.strMecanismo) Or Not IsNothing(cb.strMotivoBloqueo) Then 'Validar que ingresó algo en los campos de búsqueda
                Await ConsultarEncabezado(False, String.Empty, cb.strEstadoBloqueo, cb.strEstadoDesBloqueo, cb.strMecanismo, cb.strMotivoBloqueo)
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Public Overrides Sub BorrarRegistro()
        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                ...
                A2Utilidades.Mensajes.mostrarMensajePregunta("Está opción borra el Estado bloqueo título. ¿Confirma el borrado de este registro?", Program.TituloSistema, ValoresUserState.Borrar.ToString(), AddressOf BorrarRegistroConfirmado)
            End If
        Catch ex As Exception
            IsBusy = False
        ...
        Try
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    If mdcProxy.EstadosBloqueoTitulos.Where(Function(i) i.intID = EncabezadoSeleccionado.intID).Count > 0 Then
                        mdcProxy.EstadosBloqueoTitulos.Remove(mdcProxy.EstadosBloqueoTitulos.Where(Function(i) i.intID = EncabezadoSeleccionado.intID).First)
                    End If
                    'mdcProxy.EliminarEstadosBloqueoTitulos(EncabezadoSeleccionado.intID, Program.Usuario, String.Empty, 0, "borrar")
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaEstadosBloqueoTitulos
            objCB.strEstadoBloqueo = String.Empty
            objCB.strEstadoDesBloqueo = String.Empty
            objCB.strMotivoBloqueo = String.Empty
    ...
    ''' </summary>
    Private Function ObtenerRegistroAnterior() As EstadosBloqueoTitulos
        Dim objEncabezado As EstadosBloqueoTitulos = New EstadosBloqueoTitulos

        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                Program.CopiarObjeto(Of EstadosBloqueoTitulos)(_EncabezadoSeleccionado, objEncabezado)
    ...
    Private Function ValidarRegistro() As Boolean
        ...
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                ...
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strEstadoBloqueo) Then
                    strMsg = String.Format("{0}{1} + El estado de bloqueo es un capo requerido.", strMsg, vbCrLf)
                End If

                'Valida el estado de desbloqueo 
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strEstadoDesBloqueo) Then
                    strMsg = String.Format("{0}{1} + El estado de desbloqueo es un capo requerido.", strMsg, vbCrLf)
                End If
                ...
                'Valida el Motivo de bloqueo
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strMotivoBloqueo) Then
                    strMsg = String.Format("{0}{1} + El motivo de bloqueo es un campo requerido.", strMsg, vbCrLf)
                End If
...
''' </summary>
Public Class CamposBusquedaEstadosBloqueoTitulos
    Implements INotifyPropertyChanged

    Private _strEstadoBloqueo As String
    Public Property strEstadoBloqueo() As String
        Get
            Return _strEstadoBloqueo
        End Get
        Set(ByVal value As String)
            _strEstadoBloqueo = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strEstadoBloqueo"))
        End Set
    End Property
    ...
    Public Property strEstadoDesBloqueo() As String
        Get
            Return _strEstadoDesBloqueo
        End Get
        Set(ByVal value As String)
            _strEstadoDesBloqueo = value
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strEstadoDesBloqueo"))
        End Set
    End Property
    ...
    Public Property strMotivoBloqueo() As String
        ...
        Set(ByVal value As String)
            ...
            RaiseEvent PropertyChanged(Me, New PropertyChangedEventArgs("strMotivoBloqueo"))
        End Set
    End Property
