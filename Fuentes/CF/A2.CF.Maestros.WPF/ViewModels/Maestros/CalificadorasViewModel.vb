...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As Calificadoras
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As Calificadoras
#End Region
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' </summary>
    Private _ListaEncabezado As EntitySet(Of Calificadoras)
    Public Property ListaEncabezado() As EntitySet(Of Calificadoras)
        Get
    ...
    ''' </summary>
    Private WithEvents _EncabezadoSeleccionado As Calificadoras
    Public Property EncabezadoSeleccionado() As Calificadoras
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As Calificadoras)
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        ...
        Dim objNvoEncabezado As New Calificadoras
        ...
        Try
            ...
            If Not mobjEncabezadoPorDefecto Is Nothing Then
                Program.CopiarObjeto(Of Calificadoras)(mobjEncabezadoPorDefecto, objNvoEncabezado)
            Else
    ...
    Public Overrides Sub BorrarRegistro()
        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                ...
                A2Utilidades.Mensajes.mostrarMensajePregunta("Esta opción borra la calificadora seleccionada. ¿Confirma el borrado de esta Calificadora?", Program.TituloSistema, ValoresUserState.Borrar.ToString(), AddressOf borrarRegistroConfirmado)
            End If
        Catch ex As Exception
            IsBusy = False
        ...
        Try
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    If mdcProxyActualizar.Calificadoras.Where(Function(i) i.intIdCalificadora = EncabezadoSeleccionado.intIdCalificadora).Count > 0 Then
                        mdcProxyActualizar.Calificadoras.Remove(mdcProxyActualizar.Calificadoras.Where(Function(i) i.intIdCalificadora = EncabezadoSeleccionado.intIdCalificadora).First)
                    End If
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    ''' </summary>
    ''' 
    Private Function obtenerRegistroAnterior() As Calificadoras
        Dim objEncabezado As Calificadoras = New Calificadoras

        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                Program.CopiarObjeto(Of Calificadoras)(_EncabezadoSeleccionado, objEncabezado)
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefectoSync()
        Dim objRet As LoadOperation(Of Calificadoras)
        Dim dcProxy As MaestrosCFDomainContext

        Try
            dcProxy = inicializarProxyMaestros()

            objRet = Await dcProxy.Load(dcProxy.ConsultarCalificadorasPorDefectoSyncQuery(Program.Usuario, Program.HashConexion)).AsTask
    ...
    Private Async Function consultarEncabezado(ByVal plogFiltrar As Boolean,
        ...
        Try
            ...
            mdcProxyActualizar.Calificadoras.Clear()
            ...
            If plogFiltrar Then
                ...
                objRet = Await mdcProxyActualizar.Load(mdcProxyActualizar.FiltrarCalificadorasSyncQuery(pstrFiltro:=pstrFiltro, pstrUsuario:=Program.Usuario, pstrInfoConexion:=Program.HashConexion)).AsTask()
            Else
            ...
            If Not objRet Is Nothing Then
                If objRet.HasError Then
                    ...
                    objRet.MarkErrorAsHandled()
                Else
                    ListaEncabezado = mdcProxyActualizar.Calificadoras
