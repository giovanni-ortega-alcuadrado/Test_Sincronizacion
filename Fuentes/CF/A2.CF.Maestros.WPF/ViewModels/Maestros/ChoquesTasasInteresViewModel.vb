...
''' <summary>
''' ViewModel para la pantalla ChoquesTasasInteres perteneciente al proyecto de Cálculos Financieros.
''' </summary>
...
Public Class ChoquesTasasInteresViewModel
...
#Region "Variables - REQUERIDO"
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoPorDefecto As ChoquesTasasInteres
    ...
    '---------------------------------------------------------------------------------------------------------------------------------------------------
    Private mobjEncabezadoAnterior As ChoquesTasasInteres
#End Region
...
#Region "Propiedades del Encabezado - REQUERIDO"
    ...
    ''' <summary>
    ''' Lista de ChoquesTasasInteres que se encuentran cargadas en el grid del formulario
    ''' </summary>
    Private _ListaEncabezado As EntitySet(Of ChoquesTasasInteres)
    Public Property ListaEncabezado() As EntitySet(Of ChoquesTasasInteres)
        Get
            Return _ListaEncabezado
        End Get
        Set(ByVal value As EntitySet(Of ChoquesTasasInteres))
    ...
    ''' <summary>
    ''' Elemento de la lista de ChoquesTasasInteres que se encuentra seleccionado
    ''' </summary>
    Private WithEvents _EncabezadoSeleccionado As ChoquesTasasInteres
    Public Property EncabezadoSeleccionado() As ChoquesTasasInteres
        Get
            Return _EncabezadoSeleccionado
        End Get
        Set(ByVal value As ChoquesTasasInteres)
    ...
    ''' </summary>
    Private _cb As CamposBusquedaChoquesTasasInteres
    Public Property cb() As CamposBusquedaChoquesTasasInteres
        Get
            Return _cb
        End Get
        Set(ByVal value As CamposBusquedaChoquesTasasInteres)
            _cb = value
...
#Region "Métodos públicos del encabezado - REQUERIDO"
    ...
    Public Overrides Sub NuevoRegistro()
        ...
        Dim objNvoEncabezado As New ChoquesTasasInteres
        ...
        Try
            ...
            If Not mobjEncabezadoPorDefecto Is Nothing Then
                Program.CopiarObjeto(Of ChoquesTasasInteres)(mobjEncabezadoPorDefecto, objNvoEncabezado)
            Else
                objNvoEncabezado.intIDChoquesTasasInteres = -1
                objNvoEncabezado.intZona = 0
                objNvoEncabezado.intBanda = 0
                objNvoEncabezado.dblLimiteInferior = 0
                objNvoEncabezado.dblLimiteSuperior = 0
                objNvoEncabezado.strTipoMoneda = String.Empty
                objNvoEncabezado.intPBS = 0
            End If
    ...
    Public Overrides Async Sub ConfirmarBuscar()
        Try
            If Not IsNothing(cb.intZona) Or Not IsNothing(cb.intBanda) Or
                Not String.IsNullOrEmpty(cb.strTipoMoneda) Then 'Validar que ingresó algo en los campos de búsqueda
                Await ConsultarEncabezado(False, String.Empty, cb.intZona, cb.intBanda, cb.strTipoMoneda)
            End If
        Catch ex As Exception
            IsBusy = False
    ...
    Public Overrides Sub ActualizarRegistro()
        ...
        Try
            ...
            If ValidarRegistro() Then
                ...
                intNroOcurrencias = (From e In ListaEncabezado Where e.intIDChoquesTasasInteres = _EncabezadoSeleccionado.intIDChoquesTasasInteres Select e).Count
    ...
    Public Overrides Sub BorrarRegistro()
        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                ...
                A2Utilidades.Mensajes.mostrarMensajePregunta("Está opción borra el choque de tasas de interés seleccionado. ¿Confirma el borrado de este registro?", Program.TituloSistema, ValoresUserState.Borrar.ToString(), AddressOf BorrarRegistroConfirmado)
            End If
        Catch ex As Exception
            IsBusy = False
        ...
        Try
            If CType(sender, A2Utilidades.wppMensajePregunta).DialogResult Then
                If Not IsNothing(_EncabezadoSeleccionado) Then
                    ...
                    If mdcProxy.ChoquesTasasInteres.Where(Function(i) i.intIDChoquesTasasInteres = EncabezadoSeleccionado.intIDChoquesTasasInteres).Count > 0 Then
                        mdcProxy.ChoquesTasasInteres.Remove(mdcProxy.ChoquesTasasInteres.Where(Function(i) i.intIDChoquesTasasInteres = EncabezadoSeleccionado.intIDChoquesTasasInteres).First)
                    End If
...
#Region "Métodos privados del encabezado - REQUERIDOS"
    ...
    Private Sub PrepararNuevaBusqueda()
        Try
            Dim objCB As New CamposBusquedaChoquesTasasInteres
            objCB.intZona = 0
            objCB.intBanda = 0
            objCB.strTipoMoneda = String.Empty
            cb = objCB
        Catch ex As Exception
            IsBusy = False
    ...
    ''' </summary>
    ''' 
    Private Function ObtenerRegistroAnterior() As ChoquesTasasInteres
        Dim objEncabezado As ChoquesTasasInteres = New ChoquesTasasInteres

        Try
            If Not IsNothing(_EncabezadoSeleccionado) Then
                Program.CopiarObjeto(Of ChoquesTasasInteres)(_EncabezadoSeleccionado, objEncabezado)
                objEncabezado.intIDChoquesTasasInteres = _EncabezadoSeleccionado.intIDChoquesTasasInteres
            End If
        Catch ex As Exception
    ...
    Private Function ValidarRegistro() As Boolean
        ...
        Try
            ...
            If Not IsNothing(_EncabezadoSeleccionado) Then
                ...
                'Valida la banda
                If (_EncabezadoSeleccionado.intBanda) = 0 Then
                    strMsg = String.Format("{0}{1} + La banda es un campo requerido.", strMsg, vbCrLf)
                End If

                'Valida el tipo de moneda
                If String.IsNullOrEmpty(_EncabezadoSeleccionado.strTipoMoneda) Then
                    strMsg = String.Format("{0}{1} + El tipo de moneda es un campo requerido.", strMsg, vbCrLf)
                End If
                '20180905 HCM se pone validacion de los limites
                If _EncabezadoSeleccionado.dblLimiteInferior > _EncabezadoSeleccionado.dblLimiteSuperior Then
                    strMsg = String.Format("El limite Inferior no puede ser superior al limite superior", strMsg, vbCrLf)
                End If
                If _EncabezadoSeleccionado.dblLimiteSuperior < _EncabezadoSeleccionado.dblLimiteInferior Then

                    strMsg = String.Format("El limite superior no puede ser menor al limite inferior", strMsg, vbCrLf)
                End If
...
#Region "Métodos sincrónicos del encabezado - REQUERIDO"
    ...
    Private Async Sub consultarEncabezadoPorDefectoSync()
        Dim objRet As LoadOperation(Of ChoquesTasasInteres)
        Dim dcProxy As MaestrosCFDomainContext

        Try
            dcProxy = inicializarProxyMaestros()

            objRet = Await dcProxy.Load(dcProxy.ConsultarChoquesTasasInteresPorDefectoSyncQuery(Program.Usuario, Program.HashConexion)).AsTask
    ...
    ''' <summary>
    ''' Consultar de forma sincrónica los datos de ChoquesTasasInteres
    ''' </summary>
    ...
    Private Async Function ConsultarEncabezado(ByVal plogFiltrar As Boolean,
                                               ...
                                               Optional ByVal pintZona As Integer = 0,
                                               Optional ByVal pintBanda As Integer = 0,
                                               Optional ByVal pstrTipoMoneda As String = "") As Task(Of Boolean)
        ...
        Try
            ...
            mdcProxy.ChoquesTasasInteres.Clear()
            ...
            If plogFiltrar Then
                ...
                objRet = Await mdcProxy.Load(mdcProxy.FiltrarChoquesTasasInteresSyncQuery(pstrFiltro:=pstrFiltro, pstrUsuario:=Program.Usuario, pstrInfoConexion:=Program.HashConexion)).AsTask()
            Else
                objRet = Await mdcProxy.Load(mdcProxy.ConsultarChoquesTasasInteresSyncQuery(pintZona:=pintZona,
                                                                                            pintBanda:=pintBanda,
                                                                                            pstrTipoMoneda:=pstrTipoMoneda,
            ...
            If Not objRet Is Nothing Then
                If objRet.HasError Then
                    ...
                    objRet.MarkErrorAsHandled()
                Else
                    ListaEncabezado = mdcProxy.ChoquesTasasInteres
            ...
            logResultado = True
        Catch ex As Exception
            A2Utilidades.Mensajes.mostrarErrorAplicacion(Program.Usuario, "Se presentó un problema en la recepción de la lista de ChoquesTasasInteres ", Me.ToString(), "ConsultarEncabezado", Application.Current.ToString(), Program.Maquina, ex)
        Finally
            IsBusy = False
        End Try
...
''' Descripción:     Se crean las propiedades correctas para la búsqueda avanzada, antes al buscar por segunda vez arrojaba error
''' Fecha:           Agosto 25/2015
''' </history>
Public Class CamposBusquedaChoquesTasasInteres
    Implements INotifyPropertyChanged

    <Display(Name:="Zona")> _
    Public Property intZona As Integer

    <Display(Name:="Banda")> _
    Public Property intBanda As Integer

    <Display(Name:="Tipo moneda")> _
